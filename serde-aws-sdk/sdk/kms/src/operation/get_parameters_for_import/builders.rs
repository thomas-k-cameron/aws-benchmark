...
impl GetParametersForImportFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_parameters_for_import::builders::GetParametersForImportInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_parameters_for_import().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_parameters_for_import::builders::GetParametersForImportInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
