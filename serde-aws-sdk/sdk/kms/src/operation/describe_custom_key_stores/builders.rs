...
impl DescribeCustomKeyStoresFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_custom_key_stores::builders::DescribeCustomKeyStoresInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_custom_key_stores().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_custom_key_stores::builders::DescribeCustomKeyStoresInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
