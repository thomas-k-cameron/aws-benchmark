...
impl VerifyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::verify::builders::VerifyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.verify().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::verify::builders::VerifyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
