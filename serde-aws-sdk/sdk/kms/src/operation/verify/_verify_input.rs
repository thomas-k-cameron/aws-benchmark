...
#[allow(dead_code)]
pub type OutputShape = crate::operation::verify::VerifyInput;
...
impl VerifyInputBuilder {
    ...
    pub fn build(
        self,
    ) -> Result<crate::operation::verify::VerifyInput, aws_smithy_http::operation::error::BuildError>
    {
        Ok(crate::operation::verify::VerifyInput {
            key_id: self.key_id,
