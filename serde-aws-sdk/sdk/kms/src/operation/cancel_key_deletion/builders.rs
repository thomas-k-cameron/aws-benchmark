...
impl CancelKeyDeletionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::cancel_key_deletion::builders::CancelKeyDeletionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.cancel_key_deletion().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::cancel_key_deletion::builders::CancelKeyDeletionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
