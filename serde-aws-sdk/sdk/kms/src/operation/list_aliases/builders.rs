...
impl ListAliasesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_aliases::builders::ListAliasesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_aliases().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_aliases::builders::ListAliasesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
