...
impl CreateCustomKeyStoreFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_custom_key_store::builders::CreateCustomKeyStoreInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_custom_key_store().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_custom_key_store::builders::CreateCustomKeyStoreInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
