...
impl GetPublicKeyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_public_key::builders::GetPublicKeyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_public_key().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_public_key::builders::GetPublicKeyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
