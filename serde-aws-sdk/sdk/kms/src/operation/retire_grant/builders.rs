...
impl RetireGrantFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::retire_grant::builders::RetireGrantInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.retire_grant().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::retire_grant::builders::RetireGrantInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
