...
impl CreateGrantFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_grant::builders::CreateGrantInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_grant().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_grant::builders::CreateGrantInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
