...
impl GetKeyRotationStatusFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_key_rotation_status::builders::GetKeyRotationStatusInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_key_rotation_status().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_key_rotation_status::builders::GetKeyRotationStatusInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
