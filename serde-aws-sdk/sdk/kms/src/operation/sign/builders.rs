...
impl SignFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::sign::builders::SignInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.sign().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(mut self, data: crate::operation::sign::builders::SignInputBuilder) -> Self {
        self.inner = data;
        self
    }
