...
impl DescribeKeyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_key::builders::DescribeKeyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_key().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_key::builders::DescribeKeyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
