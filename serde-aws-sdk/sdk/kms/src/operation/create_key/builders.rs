...
impl CreateKeyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_key::builders::CreateKeyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_key().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_key::builders::CreateKeyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
