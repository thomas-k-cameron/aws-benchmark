...
impl PutKeyPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_key_policy::builders::PutKeyPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_key_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_key_policy::builders::PutKeyPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
