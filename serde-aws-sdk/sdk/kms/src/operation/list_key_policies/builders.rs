...
impl ListKeyPoliciesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_key_policies::builders::ListKeyPoliciesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_key_policies().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_key_policies::builders::ListKeyPoliciesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
