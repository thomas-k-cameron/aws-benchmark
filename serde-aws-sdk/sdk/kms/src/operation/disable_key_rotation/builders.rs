...
impl DisableKeyRotationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::disable_key_rotation::builders::DisableKeyRotationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.disable_key_rotation().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::disable_key_rotation::builders::DisableKeyRotationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
