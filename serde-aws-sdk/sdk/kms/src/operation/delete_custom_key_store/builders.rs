...
impl DeleteCustomKeyStoreFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_custom_key_store::builders::DeleteCustomKeyStoreInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_custom_key_store().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_custom_key_store::builders::DeleteCustomKeyStoreInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
