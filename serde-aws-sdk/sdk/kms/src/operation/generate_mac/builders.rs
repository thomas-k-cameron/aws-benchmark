...
impl GenerateMacFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::generate_mac::builders::GenerateMacInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.generate_mac().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::generate_mac::builders::GenerateMacInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
