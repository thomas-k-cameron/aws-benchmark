...
impl DisableKeyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::disable_key::builders::DisableKeyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.disable_key().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::disable_key::builders::DisableKeyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
