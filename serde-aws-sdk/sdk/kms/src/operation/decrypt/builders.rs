...
impl DecryptFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::decrypt::builders::DecryptInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.decrypt().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::decrypt::builders::DecryptInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
