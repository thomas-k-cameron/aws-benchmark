...
impl ScheduleKeyDeletionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::schedule_key_deletion::builders::ScheduleKeyDeletionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.schedule_key_deletion().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::schedule_key_deletion::builders::ScheduleKeyDeletionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
