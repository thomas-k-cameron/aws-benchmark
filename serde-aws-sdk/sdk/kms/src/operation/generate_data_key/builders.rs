...
impl GenerateDataKeyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::generate_data_key::builders::GenerateDataKeyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.generate_data_key().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::generate_data_key::builders::GenerateDataKeyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
