...
impl ReEncryptFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::re_encrypt::builders::ReEncryptInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.re_encrypt().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::re_encrypt::builders::ReEncryptInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
