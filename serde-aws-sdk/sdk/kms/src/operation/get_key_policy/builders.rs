...
impl GetKeyPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_key_policy::builders::GetKeyPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_key_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_key_policy::builders::GetKeyPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
