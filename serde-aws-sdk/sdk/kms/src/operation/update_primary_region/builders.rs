...
impl UpdatePrimaryRegionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_primary_region::builders::UpdatePrimaryRegionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_primary_region().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_primary_region::builders::UpdatePrimaryRegionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
