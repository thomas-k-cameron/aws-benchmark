...
impl ReplicateKeyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::replicate_key::builders::ReplicateKeyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.replicate_key().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::replicate_key::builders::ReplicateKeyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
