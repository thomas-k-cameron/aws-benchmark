...
impl UpdateCustomKeyStoreFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_custom_key_store::builders::UpdateCustomKeyStoreInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_custom_key_store().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_custom_key_store::builders::UpdateCustomKeyStoreInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
