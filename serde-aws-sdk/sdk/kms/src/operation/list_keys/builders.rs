...
impl ListKeysFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_keys::builders::ListKeysInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_keys().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_keys::builders::ListKeysInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
