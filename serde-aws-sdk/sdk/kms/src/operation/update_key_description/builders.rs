...
impl UpdateKeyDescriptionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_key_description::builders::UpdateKeyDescriptionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_key_description().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_key_description::builders::UpdateKeyDescriptionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
