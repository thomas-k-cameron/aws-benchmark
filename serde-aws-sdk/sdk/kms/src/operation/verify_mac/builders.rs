...
impl VerifyMacFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::verify_mac::builders::VerifyMacInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.verify_mac().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::verify_mac::builders::VerifyMacInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
