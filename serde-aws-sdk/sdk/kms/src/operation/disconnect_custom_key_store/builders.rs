...
impl DisconnectCustomKeyStoreFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::disconnect_custom_key_store::builders::DisconnectCustomKeyStoreInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.disconnect_custom_key_store().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::disconnect_custom_key_store::builders::DisconnectCustomKeyStoreInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
