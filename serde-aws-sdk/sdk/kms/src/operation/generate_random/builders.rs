...
impl GenerateRandomFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::generate_random::builders::GenerateRandomInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.generate_random().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::generate_random::builders::GenerateRandomInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
