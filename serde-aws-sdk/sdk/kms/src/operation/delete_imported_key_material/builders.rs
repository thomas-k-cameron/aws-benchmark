...
impl DeleteImportedKeyMaterialFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_imported_key_material::builders::DeleteImportedKeyMaterialInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_imported_key_material().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_imported_key_material::builders::DeleteImportedKeyMaterialInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
