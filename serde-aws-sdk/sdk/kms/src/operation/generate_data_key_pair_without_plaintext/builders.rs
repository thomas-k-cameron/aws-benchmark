...
impl GenerateDataKeyPairWithoutPlaintextFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::generate_data_key_pair_without_plaintext::builders::GenerateDataKeyPairWithoutPlaintextInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.generate_data_key_pair_without_plaintext().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::generate_data_key_pair_without_plaintext::builders::GenerateDataKeyPairWithoutPlaintextInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
