...
impl ConnectCustomKeyStoreFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::connect_custom_key_store::builders::ConnectCustomKeyStoreInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.connect_custom_key_store().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::connect_custom_key_store::builders::ConnectCustomKeyStoreInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
