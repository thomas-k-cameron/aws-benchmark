...
impl EncryptFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::encrypt::builders::EncryptInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.encrypt().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::encrypt::builders::EncryptInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
