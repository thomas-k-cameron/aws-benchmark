...
impl SendCommandFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::send_command::builders::SendCommandInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.send_command().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::send_command::builders::SendCommandInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
