...
pub struct ReplicationRule {
    ...
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/replication-between-outposts.html">Creating replication rules between Outposts</a> in the <i>Amazon S3 User Guide</i>.</p>
    #[doc(hidden)]
...
#[allow(dead_code)]
pub type OutputShape = crate::types::ReplicationRule;
