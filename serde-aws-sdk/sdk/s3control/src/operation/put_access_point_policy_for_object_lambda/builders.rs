...
impl PutAccessPointPolicyForObjectLambdaFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_access_point_policy_for_object_lambda::builders::PutAccessPointPolicyForObjectLambdaInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_access_point_policy_for_object_lambda().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_access_point_policy_for_object_lambda::builders::PutAccessPointPolicyForObjectLambdaInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
