...
impl CreateAccessPointForObjectLambdaFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_access_point_for_object_lambda::builders::CreateAccessPointForObjectLambdaInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_access_point_for_object_lambda().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_access_point_for_object_lambda::builders::CreateAccessPointForObjectLambdaInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
