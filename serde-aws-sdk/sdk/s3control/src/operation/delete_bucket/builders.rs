...
impl DeleteBucketFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_bucket::builders::DeleteBucketInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_bucket().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_bucket::builders::DeleteBucketInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
