...
impl GetAccessPointFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_access_point::builders::GetAccessPointInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_access_point().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_access_point::builders::GetAccessPointInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
