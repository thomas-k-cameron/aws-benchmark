...
impl CreateAccessPointFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_access_point::builders::CreateAccessPointInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_access_point().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_access_point::builders::CreateAccessPointInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
