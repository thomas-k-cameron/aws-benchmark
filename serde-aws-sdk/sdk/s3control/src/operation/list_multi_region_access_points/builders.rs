...
impl ListMultiRegionAccessPointsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_multi_region_access_points::builders::ListMultiRegionAccessPointsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_multi_region_access_points().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_multi_region_access_points::builders::ListMultiRegionAccessPointsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
