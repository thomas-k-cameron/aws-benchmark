...
impl DescribeJobFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_job::builders::DescribeJobInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_job().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_job::builders::DescribeJobInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
