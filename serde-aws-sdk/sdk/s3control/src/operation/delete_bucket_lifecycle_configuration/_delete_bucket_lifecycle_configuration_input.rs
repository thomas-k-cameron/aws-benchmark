...
#[allow(dead_code)]
pub type OutputShape = crate::operation::delete_bucket_lifecycle_configuration::DeleteBucketLifecycleConfigurationInput;
...
impl DeleteBucketLifecycleConfigurationInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::delete_bucket_lifecycle_configuration::DeleteBucketLifecycleConfigurationInput, aws_smithy_http::operation::error::BuildError>{
        Ok(
