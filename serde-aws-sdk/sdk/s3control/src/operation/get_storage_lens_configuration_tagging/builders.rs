...
impl GetStorageLensConfigurationTaggingFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_storage_lens_configuration_tagging::builders::GetStorageLensConfigurationTaggingInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_storage_lens_configuration_tagging().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_storage_lens_configuration_tagging::builders::GetStorageLensConfigurationTaggingInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
