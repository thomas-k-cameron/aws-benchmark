...
impl DeleteJobTaggingFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_job_tagging::builders::DeleteJobTaggingInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_job_tagging().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_job_tagging::builders::DeleteJobTaggingInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
