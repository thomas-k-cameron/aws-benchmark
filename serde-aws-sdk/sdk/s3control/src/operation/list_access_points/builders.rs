...
impl ListAccessPointsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_access_points::builders::ListAccessPointsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_access_points().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_access_points::builders::ListAccessPointsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
