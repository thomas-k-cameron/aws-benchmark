...
impl GetBucketReplicationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_bucket_replication::builders::GetBucketReplicationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_bucket_replication().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_bucket_replication::builders::GetBucketReplicationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
