...
impl DeletePublicAccessBlockFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_public_access_block::builders::DeletePublicAccessBlockInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_public_access_block().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_public_access_block::builders::DeletePublicAccessBlockInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
