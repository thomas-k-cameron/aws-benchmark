...
impl DeleteAccessPointPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_access_point_policy::builders::DeleteAccessPointPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_access_point_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_access_point_policy::builders::DeleteAccessPointPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
