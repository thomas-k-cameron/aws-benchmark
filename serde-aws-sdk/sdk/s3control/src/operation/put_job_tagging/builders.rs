...
impl PutJobTaggingFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_job_tagging::builders::PutJobTaggingInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_job_tagging().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_job_tagging::builders::PutJobTaggingInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
