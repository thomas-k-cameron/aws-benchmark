...
impl GetPublicAccessBlockFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_public_access_block::builders::GetPublicAccessBlockInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_public_access_block().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_public_access_block::builders::GetPublicAccessBlockInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
