...
impl DescribeMultiRegionAccessPointOperationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_multi_region_access_point_operation::builders::DescribeMultiRegionAccessPointOperationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_multi_region_access_point_operation().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_multi_region_access_point_operation::builders::DescribeMultiRegionAccessPointOperationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
