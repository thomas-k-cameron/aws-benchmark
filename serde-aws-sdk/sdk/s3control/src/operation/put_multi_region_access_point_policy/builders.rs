...
impl PutMultiRegionAccessPointPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_multi_region_access_point_policy::builders::PutMultiRegionAccessPointPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_multi_region_access_point_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_multi_region_access_point_policy::builders::PutMultiRegionAccessPointPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
