...
impl PutStorageLensConfigurationTaggingFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_storage_lens_configuration_tagging::builders::PutStorageLensConfigurationTaggingInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_storage_lens_configuration_tagging().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_storage_lens_configuration_tagging::builders::PutStorageLensConfigurationTaggingInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
