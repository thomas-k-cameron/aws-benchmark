...
impl GetAccessPointForObjectLambdaFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_access_point_for_object_lambda::builders::GetAccessPointForObjectLambdaInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_access_point_for_object_lambda().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_access_point_for_object_lambda::builders::GetAccessPointForObjectLambdaInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
