...
impl GetAccessPointPolicyStatusFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_access_point_policy_status::builders::GetAccessPointPolicyStatusInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_access_point_policy_status().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_access_point_policy_status::builders::GetAccessPointPolicyStatusInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
