...
impl GetBucketFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::CustomizableOperation<
            crate::operation::get_bucket::GetBucket,
    ...
    ///     let deserialized_parameters: crate::operation::get_bucket::builders::GetBucketInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_bucket().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_bucket::builders::GetBucketInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
