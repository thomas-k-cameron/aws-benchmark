...
impl GetMultiRegionAccessPointPolicyStatusFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_multi_region_access_point_policy_status::builders::GetMultiRegionAccessPointPolicyStatusInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_multi_region_access_point_policy_status().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_multi_region_access_point_policy_status::builders::GetMultiRegionAccessPointPolicyStatusInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
