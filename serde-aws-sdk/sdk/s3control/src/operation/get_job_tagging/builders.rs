...
impl GetJobTaggingFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_job_tagging::builders::GetJobTaggingInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_job_tagging().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_job_tagging::builders::GetJobTaggingInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
