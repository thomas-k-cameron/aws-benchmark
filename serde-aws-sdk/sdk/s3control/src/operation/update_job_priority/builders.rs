...
impl UpdateJobPriorityFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_job_priority::builders::UpdateJobPriorityInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_job_priority().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_job_priority::builders::UpdateJobPriorityInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
