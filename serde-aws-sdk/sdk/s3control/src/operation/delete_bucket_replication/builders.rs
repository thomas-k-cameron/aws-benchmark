...
/// <p>For information about S3 replication on Outposts configuration, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/S3OutpostsReplication.html">Replicating objects for Amazon Web Services Outposts</a> in the <i>Amazon S3 User Guide</i>.</p>
...
impl DeleteBucketReplicationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_bucket_replication::builders::DeleteBucketReplicationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_bucket_replication().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_bucket_replication::builders::DeleteBucketReplicationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
