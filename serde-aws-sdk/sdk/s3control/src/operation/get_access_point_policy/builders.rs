...
impl GetAccessPointPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_access_point_policy::builders::GetAccessPointPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_access_point_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_access_point_policy::builders::GetAccessPointPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
