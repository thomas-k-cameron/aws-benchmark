...
impl DeleteAccessPointPolicyForObjectLambdaFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_access_point_policy_for_object_lambda::builders::DeleteAccessPointPolicyForObjectLambdaInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_access_point_policy_for_object_lambda().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_access_point_policy_for_object_lambda::builders::DeleteAccessPointPolicyForObjectLambdaInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
