...
impl DeleteAccessPointFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_access_point::builders::DeleteAccessPointInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_access_point().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_access_point::builders::DeleteAccessPointInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
