...
impl PutBucketVersioningFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_bucket_versioning::builders::PutBucketVersioningInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_bucket_versioning().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_bucket_versioning::builders::PutBucketVersioningInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
