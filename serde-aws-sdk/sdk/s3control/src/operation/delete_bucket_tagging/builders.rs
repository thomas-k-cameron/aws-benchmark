...
impl DeleteBucketTaggingFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_bucket_tagging::builders::DeleteBucketTaggingInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_bucket_tagging().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_bucket_tagging::builders::DeleteBucketTaggingInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
