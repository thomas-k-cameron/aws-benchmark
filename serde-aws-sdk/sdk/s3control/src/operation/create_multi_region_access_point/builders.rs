...
impl CreateMultiRegionAccessPointFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::CustomizableOperation<
            crate::operation::create_multi_region_access_point::CreateMultiRegionAccessPoint,
    ...
    ///     let deserialized_parameters: crate::operation::create_multi_region_access_point::builders::CreateMultiRegionAccessPointInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_multi_region_access_point().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_multi_region_access_point::builders::CreateMultiRegionAccessPointInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
