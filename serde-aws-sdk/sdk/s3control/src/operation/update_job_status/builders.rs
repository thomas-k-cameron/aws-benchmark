...
impl UpdateJobStatusFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_job_status::builders::UpdateJobStatusInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_job_status().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_job_status::builders::UpdateJobStatusInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
