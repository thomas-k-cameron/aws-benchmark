...
impl ListRegionalBucketsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_regional_buckets::builders::ListRegionalBucketsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_regional_buckets().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_regional_buckets::builders::ListRegionalBucketsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
