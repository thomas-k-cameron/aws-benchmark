...
impl PutBucketMetricsConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_bucket_metrics_configuration::builders::PutBucketMetricsConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_bucket_metrics_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_bucket_metrics_configuration::builders::PutBucketMetricsConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
