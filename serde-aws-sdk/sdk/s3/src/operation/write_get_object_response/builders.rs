...
impl WriteGetObjectResponseFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::write_get_object_response::builders::WriteGetObjectResponseInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.write_get_object_response().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::write_get_object_response::builders::WriteGetObjectResponseInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
