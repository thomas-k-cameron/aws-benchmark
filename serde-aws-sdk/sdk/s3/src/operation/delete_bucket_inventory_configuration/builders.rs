...
impl DeleteBucketInventoryConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_bucket_inventory_configuration::builders::DeleteBucketInventoryConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_bucket_inventory_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_bucket_inventory_configuration::builders::DeleteBucketInventoryConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
