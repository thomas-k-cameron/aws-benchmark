...
impl PutBucketRequestPaymentFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_bucket_request_payment::builders::PutBucketRequestPaymentInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_bucket_request_payment().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_bucket_request_payment::builders::PutBucketRequestPaymentInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
