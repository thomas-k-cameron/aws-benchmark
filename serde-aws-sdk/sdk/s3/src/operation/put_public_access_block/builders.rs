...
impl PutPublicAccessBlockFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_public_access_block::builders::PutPublicAccessBlockInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_public_access_block().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_public_access_block::builders::PutPublicAccessBlockInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
