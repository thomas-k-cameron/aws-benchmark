...
impl GetBucketInventoryConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_bucket_inventory_configuration::builders::GetBucketInventoryConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_bucket_inventory_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_bucket_inventory_configuration::builders::GetBucketInventoryConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
