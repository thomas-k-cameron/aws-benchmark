...
impl GetBucketEncryptionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_bucket_encryption::builders::GetBucketEncryptionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_bucket_encryption().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_bucket_encryption::builders::GetBucketEncryptionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
