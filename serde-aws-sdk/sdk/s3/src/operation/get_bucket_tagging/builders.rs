...
impl GetBucketTaggingFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_bucket_tagging::builders::GetBucketTaggingInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_bucket_tagging().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_bucket_tagging::builders::GetBucketTaggingInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
