...
impl ListPartsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_parts::builders::ListPartsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_parts().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_parts::builders::ListPartsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
