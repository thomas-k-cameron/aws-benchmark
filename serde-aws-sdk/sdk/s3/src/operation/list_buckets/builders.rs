...
impl ListBucketsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_buckets::builders::ListBucketsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_buckets().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_buckets::builders::ListBucketsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
