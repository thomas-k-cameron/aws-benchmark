...
impl DeleteBucketEncryptionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_bucket_encryption::builders::DeleteBucketEncryptionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_bucket_encryption().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_bucket_encryption::builders::DeleteBucketEncryptionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
