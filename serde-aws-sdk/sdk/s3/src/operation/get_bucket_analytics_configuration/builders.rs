...
impl GetBucketAnalyticsConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_bucket_analytics_configuration::builders::GetBucketAnalyticsConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_bucket_analytics_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_bucket_analytics_configuration::builders::GetBucketAnalyticsConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
