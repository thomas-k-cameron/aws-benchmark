...
impl DeleteBucketWebsiteFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_bucket_website::builders::DeleteBucketWebsiteInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_bucket_website().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_bucket_website::builders::DeleteBucketWebsiteInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
