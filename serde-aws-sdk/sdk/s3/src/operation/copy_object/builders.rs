...
impl CopyObjectFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::copy_object::builders::CopyObjectInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.copy_object().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::copy_object::builders::CopyObjectInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
