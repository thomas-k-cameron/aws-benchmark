...
impl ListObjectsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_objects::builders::ListObjectsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_objects().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_objects::builders::ListObjectsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
