...
impl DeleteBucketCorsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_bucket_cors::builders::DeleteBucketCorsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_bucket_cors().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_bucket_cors::builders::DeleteBucketCorsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
