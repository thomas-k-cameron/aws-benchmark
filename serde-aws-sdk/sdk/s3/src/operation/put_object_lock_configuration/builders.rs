...
impl PutObjectLockConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_object_lock_configuration::builders::PutObjectLockConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_object_lock_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_object_lock_configuration::builders::PutObjectLockConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
