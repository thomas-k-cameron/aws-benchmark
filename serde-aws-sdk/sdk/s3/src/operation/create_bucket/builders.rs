...
impl CreateBucketFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_bucket::builders::CreateBucketInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_bucket().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_bucket::builders::CreateBucketInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
