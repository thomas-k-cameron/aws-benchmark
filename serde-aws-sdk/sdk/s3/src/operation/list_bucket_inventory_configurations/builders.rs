...
impl ListBucketInventoryConfigurationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_bucket_inventory_configurations::builders::ListBucketInventoryConfigurationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_bucket_inventory_configurations().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_bucket_inventory_configurations::builders::ListBucketInventoryConfigurationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
