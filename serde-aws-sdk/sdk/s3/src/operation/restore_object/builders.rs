...
impl RestoreObjectFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::restore_object::builders::RestoreObjectInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.restore_object().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::restore_object::builders::RestoreObjectInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
