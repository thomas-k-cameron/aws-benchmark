...
impl GetObjectRetentionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_object_retention::builders::GetObjectRetentionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_object_retention().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_object_retention::builders::GetObjectRetentionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
