...
impl GetObjectAclFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_object_acl::builders::GetObjectAclInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_object_acl().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_object_acl::builders::GetObjectAclInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
