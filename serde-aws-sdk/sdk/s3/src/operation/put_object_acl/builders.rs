...
impl PutObjectAclFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_object_acl::builders::PutObjectAclInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_object_acl().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_object_acl::builders::PutObjectAclInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
