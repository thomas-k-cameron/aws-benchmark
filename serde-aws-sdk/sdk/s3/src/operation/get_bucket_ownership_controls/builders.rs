...
impl GetBucketOwnershipControlsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_bucket_ownership_controls::builders::GetBucketOwnershipControlsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_bucket_ownership_controls().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_bucket_ownership_controls::builders::GetBucketOwnershipControlsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
