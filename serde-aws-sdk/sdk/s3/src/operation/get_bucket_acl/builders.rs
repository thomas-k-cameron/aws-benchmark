...
impl GetBucketAclFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_bucket_acl::builders::GetBucketAclInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_bucket_acl().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_bucket_acl::builders::GetBucketAclInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
