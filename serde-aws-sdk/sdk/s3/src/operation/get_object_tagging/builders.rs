...
impl GetObjectTaggingFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_object_tagging::builders::GetObjectTaggingInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_object_tagging().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_object_tagging::builders::GetObjectTaggingInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
