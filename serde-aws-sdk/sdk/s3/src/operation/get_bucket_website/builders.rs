...
impl GetBucketWebsiteFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_bucket_website::builders::GetBucketWebsiteInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_bucket_website().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_bucket_website::builders::GetBucketWebsiteInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
