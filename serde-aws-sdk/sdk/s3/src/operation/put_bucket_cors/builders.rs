...
impl PutBucketCorsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_bucket_cors::builders::PutBucketCorsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_bucket_cors().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_bucket_cors::builders::PutBucketCorsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
