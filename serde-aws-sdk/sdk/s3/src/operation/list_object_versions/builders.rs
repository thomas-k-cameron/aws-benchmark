...
impl ListObjectVersionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_object_versions::builders::ListObjectVersionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_object_versions().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_object_versions::builders::ListObjectVersionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
