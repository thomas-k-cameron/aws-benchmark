...
impl PutObjectLegalHoldFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_object_legal_hold::builders::PutObjectLegalHoldInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_object_legal_hold().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_object_legal_hold::builders::PutObjectLegalHoldInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
