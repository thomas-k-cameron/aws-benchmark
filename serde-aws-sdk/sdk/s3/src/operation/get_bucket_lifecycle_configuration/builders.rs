...
impl GetBucketLifecycleConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_bucket_lifecycle_configuration::builders::GetBucketLifecycleConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_bucket_lifecycle_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_bucket_lifecycle_configuration::builders::GetBucketLifecycleConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
