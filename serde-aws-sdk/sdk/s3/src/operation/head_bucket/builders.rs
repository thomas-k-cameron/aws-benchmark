...
impl HeadBucketFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::head_bucket::builders::HeadBucketInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.head_bucket().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::head_bucket::builders::HeadBucketInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
