...
impl PutBucketIntelligentTieringConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_bucket_intelligent_tiering_configuration::builders::PutBucketIntelligentTieringConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_bucket_intelligent_tiering_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_bucket_intelligent_tiering_configuration::builders::PutBucketIntelligentTieringConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
