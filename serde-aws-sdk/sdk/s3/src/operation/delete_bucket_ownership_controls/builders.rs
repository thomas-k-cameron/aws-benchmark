...
impl DeleteBucketOwnershipControlsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_bucket_ownership_controls::builders::DeleteBucketOwnershipControlsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_bucket_ownership_controls().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_bucket_ownership_controls::builders::DeleteBucketOwnershipControlsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
