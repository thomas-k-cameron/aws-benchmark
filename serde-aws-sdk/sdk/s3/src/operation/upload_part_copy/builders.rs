...
impl UploadPartCopyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::upload_part_copy::builders::UploadPartCopyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.upload_part_copy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::upload_part_copy::builders::UploadPartCopyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
