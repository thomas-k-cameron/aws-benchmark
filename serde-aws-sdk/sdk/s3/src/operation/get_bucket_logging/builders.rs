...
impl GetBucketLoggingFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_bucket_logging::builders::GetBucketLoggingInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_bucket_logging().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_bucket_logging::builders::GetBucketLoggingInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
