...
impl CreateMultipartUploadFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_multipart_upload::builders::CreateMultipartUploadInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_multipart_upload().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_multipart_upload::builders::CreateMultipartUploadInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
