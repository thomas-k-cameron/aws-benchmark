...
impl GetBucketVersioningFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_bucket_versioning::builders::GetBucketVersioningInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_bucket_versioning().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_bucket_versioning::builders::GetBucketVersioningInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
