...
impl PutObjectRetentionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_object_retention::builders::PutObjectRetentionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_object_retention().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_object_retention::builders::PutObjectRetentionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
