...
impl ListObjectsV2FluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_objects_v2::builders::ListObjectsV2InputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_objects_v2().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_objects_v2::builders::ListObjectsV2InputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
