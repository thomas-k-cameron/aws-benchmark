...
impl GetBucketLocationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_bucket_location::builders::GetBucketLocationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_bucket_location().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_bucket_location::builders::GetBucketLocationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
