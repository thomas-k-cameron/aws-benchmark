...
impl GetBucketPolicyStatusFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_bucket_policy_status::builders::GetBucketPolicyStatusInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_bucket_policy_status().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_bucket_policy_status::builders::GetBucketPolicyStatusInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
