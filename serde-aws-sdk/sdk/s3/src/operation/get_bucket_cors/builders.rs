...
impl GetBucketCorsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_bucket_cors::builders::GetBucketCorsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_bucket_cors().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_bucket_cors::builders::GetBucketCorsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
