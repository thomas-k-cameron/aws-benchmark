...
impl ListMultipartUploadsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_multipart_uploads::builders::ListMultipartUploadsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_multipart_uploads().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_multipart_uploads::builders::ListMultipartUploadsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
