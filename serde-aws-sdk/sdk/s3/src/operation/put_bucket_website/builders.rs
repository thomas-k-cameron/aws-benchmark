...
impl PutBucketWebsiteFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_bucket_website::builders::PutBucketWebsiteInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_bucket_website().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_bucket_website::builders::PutBucketWebsiteInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
