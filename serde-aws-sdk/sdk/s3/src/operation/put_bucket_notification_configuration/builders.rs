...
impl PutBucketNotificationConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_bucket_notification_configuration::builders::PutBucketNotificationConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_bucket_notification_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_bucket_notification_configuration::builders::PutBucketNotificationConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
