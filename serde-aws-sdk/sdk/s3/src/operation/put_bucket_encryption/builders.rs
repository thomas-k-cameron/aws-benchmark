...
impl PutBucketEncryptionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_bucket_encryption::builders::PutBucketEncryptionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_bucket_encryption().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_bucket_encryption::builders::PutBucketEncryptionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
