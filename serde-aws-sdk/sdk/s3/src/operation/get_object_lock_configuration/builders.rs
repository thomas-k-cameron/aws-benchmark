...
impl GetObjectLockConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_object_lock_configuration::builders::GetObjectLockConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_object_lock_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_object_lock_configuration::builders::GetObjectLockConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
