...
impl PutBucketLifecycleConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_bucket_lifecycle_configuration::builders::PutBucketLifecycleConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_bucket_lifecycle_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_bucket_lifecycle_configuration::builders::PutBucketLifecycleConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
