...
impl PutBucketAclFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::CustomizableOperation<
            crate::operation::put_bucket_acl::PutBucketAcl,
    ...
    ///     let deserialized_parameters: crate::operation::put_bucket_acl::builders::PutBucketAclInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_bucket_acl().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_bucket_acl::builders::PutBucketAclInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
