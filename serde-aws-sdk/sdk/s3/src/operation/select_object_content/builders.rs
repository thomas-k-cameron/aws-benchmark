...
impl SelectObjectContentFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::select_object_content::builders::SelectObjectContentInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.select_object_content().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::select_object_content::builders::SelectObjectContentInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
