...
impl HeadObjectFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::head_object::builders::HeadObjectInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.head_object().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::head_object::builders::HeadObjectInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
