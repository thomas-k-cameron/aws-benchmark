...
impl PutObjectTaggingFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_object_tagging::builders::PutObjectTaggingInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_object_tagging().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_object_tagging::builders::PutObjectTaggingInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
