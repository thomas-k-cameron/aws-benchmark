...
impl GetObjectLegalHoldFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_object_legal_hold::builders::GetObjectLegalHoldInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_object_legal_hold().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_object_legal_hold::builders::GetObjectLegalHoldInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
