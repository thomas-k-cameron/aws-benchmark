...
impl AbortMultipartUploadFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::abort_multipart_upload::builders::AbortMultipartUploadInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.abort_multipart_upload().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::abort_multipart_upload::builders::AbortMultipartUploadInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
