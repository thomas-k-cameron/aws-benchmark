...
impl SynthesizeSpeechFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::synthesize_speech::builders::SynthesizeSpeechInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.synthesize_speech().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::synthesize_speech::builders::SynthesizeSpeechInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
