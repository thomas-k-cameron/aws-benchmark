...
impl ListLexiconsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_lexicons::builders::ListLexiconsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_lexicons().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_lexicons::builders::ListLexiconsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
