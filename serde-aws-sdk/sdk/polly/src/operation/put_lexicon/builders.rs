...
impl PutLexiconFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_lexicon::builders::PutLexiconInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_lexicon().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_lexicon::builders::PutLexiconInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
