...
impl StartSpeechSynthesisTaskFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::start_speech_synthesis_task::builders::StartSpeechSynthesisTaskInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.start_speech_synthesis_task().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::start_speech_synthesis_task::builders::StartSpeechSynthesisTaskInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
