...
impl GetLexiconFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_lexicon::builders::GetLexiconInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_lexicon().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_lexicon::builders::GetLexiconInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
