...
impl DeleteFunctionEventInvokeConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_function_event_invoke_config::builders::DeleteFunctionEventInvokeConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_function_event_invoke_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_function_event_invoke_config::builders::DeleteFunctionEventInvokeConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
