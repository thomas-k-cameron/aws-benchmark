...
impl RemoveLayerVersionPermissionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::remove_layer_version_permission::builders::RemoveLayerVersionPermissionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.remove_layer_version_permission().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::remove_layer_version_permission::builders::RemoveLayerVersionPermissionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
