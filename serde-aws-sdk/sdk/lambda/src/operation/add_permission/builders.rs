...
impl AddPermissionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::add_permission::builders::AddPermissionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.add_permission().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::add_permission::builders::AddPermissionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
