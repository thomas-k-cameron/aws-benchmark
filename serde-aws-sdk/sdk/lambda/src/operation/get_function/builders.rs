...
impl GetFunctionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_function::builders::GetFunctionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_function().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_function::builders::GetFunctionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
