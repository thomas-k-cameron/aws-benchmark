...
impl AddLayerVersionPermissionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::add_layer_version_permission::builders::AddLayerVersionPermissionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.add_layer_version_permission().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::add_layer_version_permission::builders::AddLayerVersionPermissionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
