...
impl ListLayersFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_layers::builders::ListLayersInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_layers().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_layers::builders::ListLayersInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
