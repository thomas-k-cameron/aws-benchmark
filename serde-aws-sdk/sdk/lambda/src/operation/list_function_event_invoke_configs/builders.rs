...
impl ListFunctionEventInvokeConfigsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_function_event_invoke_configs::builders::ListFunctionEventInvokeConfigsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_function_event_invoke_configs().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_function_event_invoke_configs::builders::ListFunctionEventInvokeConfigsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
