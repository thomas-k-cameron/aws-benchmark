...
impl DeleteCodeSigningConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_code_signing_config::builders::DeleteCodeSigningConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_code_signing_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_code_signing_config::builders::DeleteCodeSigningConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
