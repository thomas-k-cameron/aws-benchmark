...
impl UpdateCodeSigningConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_code_signing_config::builders::UpdateCodeSigningConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_code_signing_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_code_signing_config::builders::UpdateCodeSigningConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
