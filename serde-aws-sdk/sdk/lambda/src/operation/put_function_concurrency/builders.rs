...
impl PutFunctionConcurrencyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_function_concurrency::builders::PutFunctionConcurrencyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_function_concurrency().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_function_concurrency::builders::PutFunctionConcurrencyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
