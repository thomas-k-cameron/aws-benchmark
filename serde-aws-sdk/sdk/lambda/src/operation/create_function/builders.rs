...
impl CreateFunctionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_function::builders::CreateFunctionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_function().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_function::builders::CreateFunctionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
