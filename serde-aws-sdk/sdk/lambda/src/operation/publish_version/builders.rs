...
impl PublishVersionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::publish_version::builders::PublishVersionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.publish_version().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::publish_version::builders::PublishVersionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
