...
impl RemovePermissionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::remove_permission::builders::RemovePermissionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.remove_permission().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::remove_permission::builders::RemovePermissionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
