...
impl PutFunctionCodeSigningConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_function_code_signing_config::builders::PutFunctionCodeSigningConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_function_code_signing_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_function_code_signing_config::builders::PutFunctionCodeSigningConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
