...
impl GetFunctionConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_function_configuration::builders::GetFunctionConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_function_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_function_configuration::builders::GetFunctionConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
