...
impl ListFunctionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_functions::builders::ListFunctionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_functions().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_functions::builders::ListFunctionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
