...
impl PutFunctionEventInvokeConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_function_event_invoke_config::builders::PutFunctionEventInvokeConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_function_event_invoke_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_function_event_invoke_config::builders::PutFunctionEventInvokeConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
