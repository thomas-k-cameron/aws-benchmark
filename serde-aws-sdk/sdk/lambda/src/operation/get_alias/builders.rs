...
impl GetAliasFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_alias::builders::GetAliasInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_alias().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_alias::builders::GetAliasInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
