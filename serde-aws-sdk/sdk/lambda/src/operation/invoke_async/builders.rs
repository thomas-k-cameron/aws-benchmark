...
impl InvokeAsyncFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::invoke_async::builders::InvokeAsyncInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.invoke_async().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::invoke_async::builders::InvokeAsyncInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
