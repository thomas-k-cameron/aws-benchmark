...
impl GetFunctionUrlConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_function_url_config::builders::GetFunctionUrlConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_function_url_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_function_url_config::builders::GetFunctionUrlConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
