...
impl GetFunctionEventInvokeConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_function_event_invoke_config::builders::GetFunctionEventInvokeConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_function_event_invoke_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_function_event_invoke_config::builders::GetFunctionEventInvokeConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
