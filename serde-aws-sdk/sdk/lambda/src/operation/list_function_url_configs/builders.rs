...
impl ListFunctionUrlConfigsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_function_url_configs::builders::ListFunctionUrlConfigsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_function_url_configs().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_function_url_configs::builders::ListFunctionUrlConfigsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
