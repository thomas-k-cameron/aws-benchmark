...
impl DeleteFunctionUrlConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_function_url_config::builders::DeleteFunctionUrlConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_function_url_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_function_url_config::builders::DeleteFunctionUrlConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
