...
impl GetLayerVersionPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_layer_version_policy::builders::GetLayerVersionPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_layer_version_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_layer_version_policy::builders::GetLayerVersionPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
