...
impl GetProvisionedConcurrencyConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_provisioned_concurrency_config::builders::GetProvisionedConcurrencyConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_provisioned_concurrency_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_provisioned_concurrency_config::builders::GetProvisionedConcurrencyConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
