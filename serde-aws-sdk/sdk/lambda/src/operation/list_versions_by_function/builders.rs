...
impl ListVersionsByFunctionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_versions_by_function::builders::ListVersionsByFunctionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_versions_by_function().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_versions_by_function::builders::ListVersionsByFunctionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
