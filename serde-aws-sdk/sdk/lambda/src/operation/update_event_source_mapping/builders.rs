...
impl UpdateEventSourceMappingFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_event_source_mapping::builders::UpdateEventSourceMappingInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_event_source_mapping().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_event_source_mapping::builders::UpdateEventSourceMappingInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
