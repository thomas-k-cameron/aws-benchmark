...
impl PutRuntimeManagementConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_runtime_management_config::builders::PutRuntimeManagementConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_runtime_management_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_runtime_management_config::builders::PutRuntimeManagementConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
