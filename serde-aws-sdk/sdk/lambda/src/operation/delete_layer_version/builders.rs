...
impl DeleteLayerVersionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_layer_version::builders::DeleteLayerVersionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_layer_version().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_layer_version::builders::DeleteLayerVersionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
