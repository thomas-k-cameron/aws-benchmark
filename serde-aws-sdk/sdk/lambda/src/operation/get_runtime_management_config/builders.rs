...
impl GetRuntimeManagementConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_runtime_management_config::builders::GetRuntimeManagementConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_runtime_management_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_runtime_management_config::builders::GetRuntimeManagementConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
