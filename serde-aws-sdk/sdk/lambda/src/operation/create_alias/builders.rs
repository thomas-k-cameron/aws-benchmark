...
impl CreateAliasFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_alias::builders::CreateAliasInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_alias().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_alias::builders::CreateAliasInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
