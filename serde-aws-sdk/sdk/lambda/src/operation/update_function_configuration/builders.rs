...
impl UpdateFunctionConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_function_configuration::builders::UpdateFunctionConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_function_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_function_configuration::builders::UpdateFunctionConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
