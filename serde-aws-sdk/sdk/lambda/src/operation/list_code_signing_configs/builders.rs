...
impl ListCodeSigningConfigsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_code_signing_configs::builders::ListCodeSigningConfigsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_code_signing_configs().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_code_signing_configs::builders::ListCodeSigningConfigsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
