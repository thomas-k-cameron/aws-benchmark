...
impl DeleteFunctionConcurrencyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_function_concurrency::builders::DeleteFunctionConcurrencyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_function_concurrency().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_function_concurrency::builders::DeleteFunctionConcurrencyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
