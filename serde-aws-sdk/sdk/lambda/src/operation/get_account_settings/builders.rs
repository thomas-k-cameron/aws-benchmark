...
impl GetAccountSettingsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_account_settings::builders::GetAccountSettingsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_account_settings().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_account_settings::builders::GetAccountSettingsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
