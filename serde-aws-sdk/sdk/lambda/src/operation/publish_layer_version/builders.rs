...
impl PublishLayerVersionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::publish_layer_version::builders::PublishLayerVersionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.publish_layer_version().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::publish_layer_version::builders::PublishLayerVersionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
