...
impl ListEventSourceMappingsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_event_source_mappings::builders::ListEventSourceMappingsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_event_source_mappings().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_event_source_mappings::builders::ListEventSourceMappingsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
