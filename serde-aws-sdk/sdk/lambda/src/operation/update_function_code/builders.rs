...
impl UpdateFunctionCodeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_function_code::builders::UpdateFunctionCodeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_function_code().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_function_code::builders::UpdateFunctionCodeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
