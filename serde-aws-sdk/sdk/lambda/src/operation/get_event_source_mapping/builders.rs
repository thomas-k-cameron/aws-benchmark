...
impl GetEventSourceMappingFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_event_source_mapping::builders::GetEventSourceMappingInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_event_source_mapping().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_event_source_mapping::builders::GetEventSourceMappingInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
