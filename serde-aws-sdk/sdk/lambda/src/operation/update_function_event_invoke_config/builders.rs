...
impl UpdateFunctionEventInvokeConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_function_event_invoke_config::builders::UpdateFunctionEventInvokeConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_function_event_invoke_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_function_event_invoke_config::builders::UpdateFunctionEventInvokeConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
