...
impl GetLayerVersionByArnFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_layer_version_by_arn::builders::GetLayerVersionByArnInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_layer_version_by_arn().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_layer_version_by_arn::builders::GetLayerVersionByArnInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
