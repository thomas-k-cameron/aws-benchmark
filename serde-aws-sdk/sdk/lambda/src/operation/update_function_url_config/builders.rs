...
impl UpdateFunctionUrlConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_function_url_config::builders::UpdateFunctionUrlConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_function_url_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_function_url_config::builders::UpdateFunctionUrlConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
