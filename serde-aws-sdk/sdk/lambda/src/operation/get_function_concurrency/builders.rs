...
impl GetFunctionConcurrencyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_function_concurrency::builders::GetFunctionConcurrencyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_function_concurrency().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_function_concurrency::builders::GetFunctionConcurrencyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
