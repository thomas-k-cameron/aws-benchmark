...
impl CreateFunctionUrlConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_function_url_config::builders::CreateFunctionUrlConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_function_url_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_function_url_config::builders::CreateFunctionUrlConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
