...
impl ListTagsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_tags::builders::ListTagsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_tags().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_tags::builders::ListTagsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
