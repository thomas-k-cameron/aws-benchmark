...
impl StartCallAnalyticsStreamTranscriptionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::start_call_analytics_stream_transcription::builders::StartCallAnalyticsStreamTranscriptionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.start_call_analytics_stream_transcription().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::start_call_analytics_stream_transcription::builders::StartCallAnalyticsStreamTranscriptionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
