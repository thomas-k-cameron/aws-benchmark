...
impl StartMedicalStreamTranscriptionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::start_medical_stream_transcription::builders::StartMedicalStreamTranscriptionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.start_medical_stream_transcription().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::start_medical_stream_transcription::builders::StartMedicalStreamTranscriptionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
