...
impl StartStreamTranscriptionFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::CustomizableOperation<
            crate::operation::start_stream_transcription::StartStreamTranscription,
    ...
    ///     let deserialized_parameters: crate::operation::start_stream_transcription::builders::StartStreamTranscriptionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.start_stream_transcription().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::start_stream_transcription::builders::StartStreamTranscriptionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
