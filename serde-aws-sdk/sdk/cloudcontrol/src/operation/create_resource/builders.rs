...
impl CreateResourceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_resource::builders::CreateResourceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_resource().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_resource::builders::CreateResourceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
