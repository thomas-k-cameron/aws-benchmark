...
impl UpdateResourceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_resource::builders::UpdateResourceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_resource().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_resource::builders::UpdateResourceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
