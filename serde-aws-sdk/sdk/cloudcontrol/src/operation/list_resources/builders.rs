...
impl ListResourcesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_resources::builders::ListResourcesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_resources().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_resources::builders::ListResourcesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
