...
impl ListResourceRequestsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_resource_requests::builders::ListResourceRequestsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_resource_requests().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_resource_requests::builders::ListResourceRequestsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
