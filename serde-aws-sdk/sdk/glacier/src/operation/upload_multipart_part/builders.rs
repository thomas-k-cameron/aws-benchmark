...
impl UploadMultipartPartFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::upload_multipart_part::builders::UploadMultipartPartInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.upload_multipart_part().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::upload_multipart_part::builders::UploadMultipartPartInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
