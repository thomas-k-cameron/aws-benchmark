...
impl InitiateJobFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::initiate_job::builders::InitiateJobInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.initiate_job().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::initiate_job::builders::InitiateJobInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
