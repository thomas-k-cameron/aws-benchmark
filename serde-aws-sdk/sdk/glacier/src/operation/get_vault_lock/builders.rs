...
impl GetVaultLockFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_vault_lock::builders::GetVaultLockInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_vault_lock().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_vault_lock::builders::GetVaultLockInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
