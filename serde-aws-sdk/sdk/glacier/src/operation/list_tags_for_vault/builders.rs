...
impl ListTagsForVaultFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_tags_for_vault::builders::ListTagsForVaultInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_tags_for_vault().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_tags_for_vault::builders::ListTagsForVaultInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
