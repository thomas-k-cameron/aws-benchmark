...
impl ListProvisionedCapacityFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_provisioned_capacity::builders::ListProvisionedCapacityInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_provisioned_capacity().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_provisioned_capacity::builders::ListProvisionedCapacityInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
