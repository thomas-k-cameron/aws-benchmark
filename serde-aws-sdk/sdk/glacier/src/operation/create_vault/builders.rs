...
impl CreateVaultFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_vault::builders::CreateVaultInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_vault().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_vault::builders::CreateVaultInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
