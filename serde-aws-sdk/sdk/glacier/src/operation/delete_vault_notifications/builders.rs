...
impl DeleteVaultNotificationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_vault_notifications::builders::DeleteVaultNotificationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_vault_notifications().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_vault_notifications::builders::DeleteVaultNotificationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
