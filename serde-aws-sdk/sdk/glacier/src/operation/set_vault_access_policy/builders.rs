...
impl SetVaultAccessPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::set_vault_access_policy::builders::SetVaultAccessPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.set_vault_access_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::set_vault_access_policy::builders::SetVaultAccessPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
