...
impl CompleteVaultLockFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::complete_vault_lock::builders::CompleteVaultLockInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.complete_vault_lock().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::complete_vault_lock::builders::CompleteVaultLockInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
