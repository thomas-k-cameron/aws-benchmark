...
impl UploadArchiveFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::upload_archive::builders::UploadArchiveInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.upload_archive().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::upload_archive::builders::UploadArchiveInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
