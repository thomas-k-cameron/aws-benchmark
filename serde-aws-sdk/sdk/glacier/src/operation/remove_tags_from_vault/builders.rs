...
impl RemoveTagsFromVaultFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::CustomizableOperation<
            crate::operation::remove_tags_from_vault::RemoveTagsFromVault,
    ...
    ///     let deserialized_parameters: crate::operation::remove_tags_from_vault::builders::RemoveTagsFromVaultInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.remove_tags_from_vault().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::remove_tags_from_vault::builders::RemoveTagsFromVaultInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
