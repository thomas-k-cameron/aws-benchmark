...
impl SetDataRetrievalPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::set_data_retrieval_policy::builders::SetDataRetrievalPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.set_data_retrieval_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::set_data_retrieval_policy::builders::SetDataRetrievalPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
