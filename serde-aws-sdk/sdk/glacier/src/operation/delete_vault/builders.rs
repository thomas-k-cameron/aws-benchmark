...
impl DeleteVaultFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_vault::builders::DeleteVaultInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_vault().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_vault::builders::DeleteVaultInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
