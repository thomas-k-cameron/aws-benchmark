...
impl CompleteMultipartUploadFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::complete_multipart_upload::builders::CompleteMultipartUploadInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.complete_multipart_upload().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::complete_multipart_upload::builders::CompleteMultipartUploadInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
