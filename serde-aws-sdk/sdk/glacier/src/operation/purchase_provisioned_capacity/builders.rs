...
impl PurchaseProvisionedCapacityFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::purchase_provisioned_capacity::builders::PurchaseProvisionedCapacityInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.purchase_provisioned_capacity().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::purchase_provisioned_capacity::builders::PurchaseProvisionedCapacityInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
