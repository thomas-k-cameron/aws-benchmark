...
impl GetJobOutputFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_job_output::builders::GetJobOutputInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_job_output().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_job_output::builders::GetJobOutputInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
