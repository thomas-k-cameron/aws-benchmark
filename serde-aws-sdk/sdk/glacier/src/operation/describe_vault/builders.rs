...
impl DescribeVaultFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_vault::builders::DescribeVaultInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_vault().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_vault::builders::DescribeVaultInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
