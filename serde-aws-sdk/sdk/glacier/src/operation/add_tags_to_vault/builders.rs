...
impl AddTagsToVaultFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::add_tags_to_vault::builders::AddTagsToVaultInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.add_tags_to_vault().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::add_tags_to_vault::builders::AddTagsToVaultInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
