...
impl ListJobsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_jobs::builders::ListJobsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_jobs().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_jobs::builders::ListJobsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
