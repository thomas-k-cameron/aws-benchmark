...
impl DeleteArchiveFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_archive::builders::DeleteArchiveInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_archive().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_archive::builders::DeleteArchiveInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
