...
impl SetVaultNotificationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::set_vault_notifications::builders::SetVaultNotificationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.set_vault_notifications().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::set_vault_notifications::builders::SetVaultNotificationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
