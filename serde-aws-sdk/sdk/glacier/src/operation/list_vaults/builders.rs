...
impl ListVaultsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_vaults::builders::ListVaultsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_vaults().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_vaults::builders::ListVaultsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
