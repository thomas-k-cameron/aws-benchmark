...
impl CreateRoleFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_role::builders::CreateRoleInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_role().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_role::builders::CreateRoleInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
