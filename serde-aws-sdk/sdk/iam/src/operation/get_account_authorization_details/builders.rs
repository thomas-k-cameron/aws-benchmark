...
impl GetAccountAuthorizationDetailsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_account_authorization_details::builders::GetAccountAuthorizationDetailsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_account_authorization_details().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_account_authorization_details::builders::GetAccountAuthorizationDetailsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
