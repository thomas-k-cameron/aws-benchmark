...
impl DeleteServiceLinkedRoleFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_service_linked_role::builders::DeleteServiceLinkedRoleInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_service_linked_role().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_service_linked_role::builders::DeleteServiceLinkedRoleInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
