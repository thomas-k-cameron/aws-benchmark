...
impl UploadSSHPublicKeyFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::CustomizableOperation<
            crate::operation::upload_ssh_public_key::UploadSSHPublicKey,
    ...
    ///     let deserialized_parameters: crate::operation::upload_ssh_public_key::builders::UploadSshPublicKeyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.upload_ssh_public_key().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::upload_ssh_public_key::builders::UploadSshPublicKeyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
