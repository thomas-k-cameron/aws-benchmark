...
impl ListEntitiesForPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_entities_for_policy::builders::ListEntitiesForPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_entities_for_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_entities_for_policy::builders::ListEntitiesForPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
