...
impl DeletePolicyVersionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_policy_version::builders::DeletePolicyVersionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_policy_version().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_policy_version::builders::DeletePolicyVersionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
