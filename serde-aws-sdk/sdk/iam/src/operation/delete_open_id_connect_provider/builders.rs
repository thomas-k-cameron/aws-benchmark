...
impl DeleteOpenIDConnectProviderFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_open_id_connect_provider::builders::DeleteOpenIdConnectProviderInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_open_id_connect_provider().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_open_id_connect_provider::builders::DeleteOpenIdConnectProviderInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
