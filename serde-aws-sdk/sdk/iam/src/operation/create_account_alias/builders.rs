...
impl CreateAccountAliasFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_account_alias::builders::CreateAccountAliasInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_account_alias().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_account_alias::builders::CreateAccountAliasInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
