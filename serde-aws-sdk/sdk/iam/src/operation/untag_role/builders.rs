...
impl UntagRoleFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::untag_role::builders::UntagRoleInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.untag_role().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::untag_role::builders::UntagRoleInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
