...
impl SetDefaultPolicyVersionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::set_default_policy_version::builders::SetDefaultPolicyVersionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.set_default_policy_version().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::set_default_policy_version::builders::SetDefaultPolicyVersionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
