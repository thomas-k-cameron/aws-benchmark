...
impl CreateUserFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_user::builders::CreateUserInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_user().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_user::builders::CreateUserInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
