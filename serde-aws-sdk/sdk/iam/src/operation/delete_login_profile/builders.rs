...
impl DeleteLoginProfileFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_login_profile::builders::DeleteLoginProfileInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_login_profile().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_login_profile::builders::DeleteLoginProfileInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
