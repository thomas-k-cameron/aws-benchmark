...
impl GetAccountSummaryFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_account_summary::builders::GetAccountSummaryInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_account_summary().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_account_summary::builders::GetAccountSummaryInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
