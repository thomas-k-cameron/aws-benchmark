...
impl UntagSAMLProviderFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::untag_saml_provider::builders::UntagSamlProviderInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.untag_saml_provider().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::untag_saml_provider::builders::UntagSamlProviderInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
