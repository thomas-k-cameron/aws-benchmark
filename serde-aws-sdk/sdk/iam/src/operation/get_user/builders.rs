...
impl GetUserFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_user::builders::GetUserInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_user().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_user::builders::GetUserInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
