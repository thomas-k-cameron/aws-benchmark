...
impl UntagOpenIDConnectProviderFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::untag_open_id_connect_provider::builders::UntagOpenIdConnectProviderInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.untag_open_id_connect_provider().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::untag_open_id_connect_provider::builders::UntagOpenIdConnectProviderInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
