...
impl ListRolePoliciesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_role_policies::builders::ListRolePoliciesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_role_policies().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_role_policies::builders::ListRolePoliciesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
