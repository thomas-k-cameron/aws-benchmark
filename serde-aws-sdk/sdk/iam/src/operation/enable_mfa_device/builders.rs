...
impl EnableMFADeviceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::enable_mfa_device::builders::EnableMfaDeviceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.enable_mfa_device().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::enable_mfa_device::builders::EnableMfaDeviceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
