...
impl TagMFADeviceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::tag_mfa_device::builders::TagMfaDeviceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.tag_mfa_device().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::tag_mfa_device::builders::TagMfaDeviceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
