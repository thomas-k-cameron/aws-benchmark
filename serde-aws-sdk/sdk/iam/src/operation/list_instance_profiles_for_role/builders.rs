...
impl ListInstanceProfilesForRoleFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_instance_profiles_for_role::builders::ListInstanceProfilesForRoleInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_instance_profiles_for_role().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_instance_profiles_for_role::builders::ListInstanceProfilesForRoleInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
