...
impl CreateSAMLProviderFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_saml_provider::builders::CreateSamlProviderInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_saml_provider().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_saml_provider::builders::CreateSamlProviderInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
