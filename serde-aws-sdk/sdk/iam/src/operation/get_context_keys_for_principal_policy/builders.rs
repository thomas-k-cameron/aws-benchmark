...
impl GetContextKeysForPrincipalPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_context_keys_for_principal_policy::builders::GetContextKeysForPrincipalPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_context_keys_for_principal_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_context_keys_for_principal_policy::builders::GetContextKeysForPrincipalPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
