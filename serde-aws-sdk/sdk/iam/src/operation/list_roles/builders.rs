...
impl ListRolesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_roles::builders::ListRolesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_roles().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_roles::builders::ListRolesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
