...
impl ListSigningCertificatesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_signing_certificates::builders::ListSigningCertificatesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_signing_certificates().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_signing_certificates::builders::ListSigningCertificatesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
