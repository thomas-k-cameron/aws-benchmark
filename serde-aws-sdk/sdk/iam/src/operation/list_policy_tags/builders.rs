...
impl ListPolicyTagsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_policy_tags::builders::ListPolicyTagsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_policy_tags().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_policy_tags::builders::ListPolicyTagsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
