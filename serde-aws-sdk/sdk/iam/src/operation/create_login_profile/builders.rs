...
impl CreateLoginProfileFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_login_profile::builders::CreateLoginProfileInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_login_profile().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_login_profile::builders::CreateLoginProfileInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
