...
impl TagOpenIDConnectProviderFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::tag_open_id_connect_provider::builders::TagOpenIdConnectProviderInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.tag_open_id_connect_provider().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::tag_open_id_connect_provider::builders::TagOpenIdConnectProviderInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
