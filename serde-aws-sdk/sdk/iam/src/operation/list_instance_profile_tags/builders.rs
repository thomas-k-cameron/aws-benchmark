...
impl ListInstanceProfileTagsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_instance_profile_tags::builders::ListInstanceProfileTagsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_instance_profile_tags().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_instance_profile_tags::builders::ListInstanceProfileTagsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
