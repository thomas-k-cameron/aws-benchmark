...
impl ListMFADeviceTagsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_mfa_device_tags::builders::ListMfaDeviceTagsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_mfa_device_tags().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_mfa_device_tags::builders::ListMfaDeviceTagsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
