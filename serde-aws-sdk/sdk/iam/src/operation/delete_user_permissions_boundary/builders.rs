...
impl DeleteUserPermissionsBoundaryFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_user_permissions_boundary::builders::DeleteUserPermissionsBoundaryInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_user_permissions_boundary().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_user_permissions_boundary::builders::DeleteUserPermissionsBoundaryInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
