...
impl DeleteUserPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_user_policy::builders::DeleteUserPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_user_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_user_policy::builders::DeleteUserPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
