...
impl UpdateSigningCertificateFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_signing_certificate::builders::UpdateSigningCertificateInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_signing_certificate().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_signing_certificate::builders::UpdateSigningCertificateInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
