...
impl GetSSHPublicKeyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_ssh_public_key::builders::GetSshPublicKeyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_ssh_public_key().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_ssh_public_key::builders::GetSshPublicKeyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
