...
impl GetAccountPasswordPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_account_password_policy::builders::GetAccountPasswordPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_account_password_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_account_password_policy::builders::GetAccountPasswordPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
