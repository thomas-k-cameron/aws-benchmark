...
impl UntagUserFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::untag_user::builders::UntagUserInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.untag_user().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::untag_user::builders::UntagUserInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
