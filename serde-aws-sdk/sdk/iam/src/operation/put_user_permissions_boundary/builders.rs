...
impl PutUserPermissionsBoundaryFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_user_permissions_boundary::builders::PutUserPermissionsBoundaryInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_user_permissions_boundary().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_user_permissions_boundary::builders::PutUserPermissionsBoundaryInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
