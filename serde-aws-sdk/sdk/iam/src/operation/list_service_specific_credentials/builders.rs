...
impl ListServiceSpecificCredentialsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_service_specific_credentials::builders::ListServiceSpecificCredentialsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_service_specific_credentials().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_service_specific_credentials::builders::ListServiceSpecificCredentialsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
