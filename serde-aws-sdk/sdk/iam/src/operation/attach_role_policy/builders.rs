...
impl AttachRolePolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::attach_role_policy::builders::AttachRolePolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.attach_role_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::attach_role_policy::builders::AttachRolePolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
