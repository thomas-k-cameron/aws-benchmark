...
impl PutRolePermissionsBoundaryFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_role_permissions_boundary::builders::PutRolePermissionsBoundaryInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_role_permissions_boundary().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_role_permissions_boundary::builders::PutRolePermissionsBoundaryInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
