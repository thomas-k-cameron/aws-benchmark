...
impl ListSSHPublicKeysFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_ssh_public_keys::builders::ListSshPublicKeysInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_ssh_public_keys().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_ssh_public_keys::builders::ListSshPublicKeysInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
