...
impl UploadSigningCertificateFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::upload_signing_certificate::builders::UploadSigningCertificateInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.upload_signing_certificate().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::upload_signing_certificate::builders::UploadSigningCertificateInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
