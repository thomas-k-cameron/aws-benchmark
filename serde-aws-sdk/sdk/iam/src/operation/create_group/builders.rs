...
impl CreateGroupFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_group::builders::CreateGroupInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_group().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_group::builders::CreateGroupInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
