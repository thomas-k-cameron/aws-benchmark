...
impl UpdateSAMLProviderFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_saml_provider::builders::UpdateSamlProviderInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_saml_provider().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_saml_provider::builders::UpdateSamlProviderInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
