...
impl GetGroupFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_group::builders::GetGroupInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_group().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_group::builders::GetGroupInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
