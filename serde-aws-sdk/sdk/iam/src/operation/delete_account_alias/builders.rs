...
impl DeleteAccountAliasFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_account_alias::builders::DeleteAccountAliasInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_account_alias().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_account_alias::builders::DeleteAccountAliasInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
