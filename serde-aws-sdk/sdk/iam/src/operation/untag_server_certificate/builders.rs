...
impl UntagServerCertificateFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::untag_server_certificate::builders::UntagServerCertificateInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.untag_server_certificate().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::untag_server_certificate::builders::UntagServerCertificateInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
