...
impl ListAttachedUserPoliciesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_attached_user_policies::builders::ListAttachedUserPoliciesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_attached_user_policies().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_attached_user_policies::builders::ListAttachedUserPoliciesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
