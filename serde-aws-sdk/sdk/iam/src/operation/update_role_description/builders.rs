...
impl UpdateRoleDescriptionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_role_description::builders::UpdateRoleDescriptionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_role_description().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_role_description::builders::UpdateRoleDescriptionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
