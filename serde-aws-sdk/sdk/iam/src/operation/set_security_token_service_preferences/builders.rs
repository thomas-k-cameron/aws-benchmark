...
impl SetSecurityTokenServicePreferencesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::set_security_token_service_preferences::builders::SetSecurityTokenServicePreferencesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.set_security_token_service_preferences().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::set_security_token_service_preferences::builders::SetSecurityTokenServicePreferencesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
