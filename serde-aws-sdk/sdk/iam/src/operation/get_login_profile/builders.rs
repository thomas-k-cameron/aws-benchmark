...
impl GetLoginProfileFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_login_profile::builders::GetLoginProfileInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_login_profile().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_login_profile::builders::GetLoginProfileInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
