...
impl DetachRolePolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::detach_role_policy::builders::DetachRolePolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.detach_role_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::detach_role_policy::builders::DetachRolePolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
