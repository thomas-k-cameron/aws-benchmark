...
impl UpdateUserFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_user::builders::UpdateUserInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_user().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_user::builders::UpdateUserInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
