...
impl ListPoliciesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_policies::builders::ListPoliciesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_policies().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_policies::builders::ListPoliciesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
