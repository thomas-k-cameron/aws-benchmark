...
impl ListSAMLProviderTagsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_saml_provider_tags::builders::ListSamlProviderTagsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_saml_provider_tags().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_saml_provider_tags::builders::ListSamlProviderTagsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
