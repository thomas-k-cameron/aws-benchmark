...
impl UpdateLoginProfileFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_login_profile::builders::UpdateLoginProfileInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_login_profile().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_login_profile::builders::UpdateLoginProfileInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
