...
impl GetSAMLProviderFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_saml_provider::builders::GetSamlProviderInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_saml_provider().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_saml_provider::builders::GetSamlProviderInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
