...
impl AttachGroupPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::attach_group_policy::builders::AttachGroupPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.attach_group_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::attach_group_policy::builders::AttachGroupPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
