...
impl ListRoleTagsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_role_tags::builders::ListRoleTagsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_role_tags().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_role_tags::builders::ListRoleTagsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
