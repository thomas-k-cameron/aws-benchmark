...
impl DeleteSigningCertificateFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_signing_certificate::builders::DeleteSigningCertificateInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_signing_certificate().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_signing_certificate::builders::DeleteSigningCertificateInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
