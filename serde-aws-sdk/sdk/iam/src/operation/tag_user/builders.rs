...
impl TagUserFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::tag_user::builders::TagUserInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.tag_user().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::tag_user::builders::TagUserInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
