...
impl CreateOpenIDConnectProviderFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_open_id_connect_provider::builders::CreateOpenIdConnectProviderInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_open_id_connect_provider().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_open_id_connect_provider::builders::CreateOpenIdConnectProviderInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
