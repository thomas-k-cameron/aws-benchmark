...
impl DeleteSSHPublicKeyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_ssh_public_key::builders::DeleteSshPublicKeyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_ssh_public_key().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_ssh_public_key::builders::DeleteSshPublicKeyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
