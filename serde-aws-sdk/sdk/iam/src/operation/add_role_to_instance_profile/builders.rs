...
impl AddRoleToInstanceProfileFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::add_role_to_instance_profile::builders::AddRoleToInstanceProfileInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.add_role_to_instance_profile().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::add_role_to_instance_profile::builders::AddRoleToInstanceProfileInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
