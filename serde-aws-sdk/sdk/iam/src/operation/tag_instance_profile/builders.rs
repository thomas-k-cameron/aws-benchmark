...
impl TagInstanceProfileFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::tag_instance_profile::builders::TagInstanceProfileInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.tag_instance_profile().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::tag_instance_profile::builders::TagInstanceProfileInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
