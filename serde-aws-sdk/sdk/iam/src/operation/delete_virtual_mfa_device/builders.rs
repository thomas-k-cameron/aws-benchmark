...
impl DeleteVirtualMFADeviceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_virtual_mfa_device::builders::DeleteVirtualMfaDeviceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_virtual_mfa_device().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_virtual_mfa_device::builders::DeleteVirtualMfaDeviceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
