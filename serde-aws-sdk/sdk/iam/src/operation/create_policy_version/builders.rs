...
impl CreatePolicyVersionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_policy_version::builders::CreatePolicyVersionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_policy_version().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_policy_version::builders::CreatePolicyVersionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
