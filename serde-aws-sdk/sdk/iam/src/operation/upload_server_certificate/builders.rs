...
impl UploadServerCertificateFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::upload_server_certificate::builders::UploadServerCertificateInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.upload_server_certificate().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::upload_server_certificate::builders::UploadServerCertificateInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
