...
impl ListVirtualMFADevicesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_virtual_mfa_devices::builders::ListVirtualMfaDevicesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_virtual_mfa_devices().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_virtual_mfa_devices::builders::ListVirtualMfaDevicesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
