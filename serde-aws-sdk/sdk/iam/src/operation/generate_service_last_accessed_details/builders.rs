...
impl GenerateServiceLastAccessedDetailsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::generate_service_last_accessed_details::builders::GenerateServiceLastAccessedDetailsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.generate_service_last_accessed_details().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::generate_service_last_accessed_details::builders::GenerateServiceLastAccessedDetailsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
