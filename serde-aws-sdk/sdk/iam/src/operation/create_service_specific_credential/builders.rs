...
impl CreateServiceSpecificCredentialFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_service_specific_credential::builders::CreateServiceSpecificCredentialInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_service_specific_credential().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_service_specific_credential::builders::CreateServiceSpecificCredentialInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
