...
impl CreatePolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_policy::builders::CreatePolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_policy::builders::CreatePolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
