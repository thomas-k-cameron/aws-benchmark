...
impl TagServerCertificateFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::tag_server_certificate::builders::TagServerCertificateInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.tag_server_certificate().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::tag_server_certificate::builders::TagServerCertificateInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
