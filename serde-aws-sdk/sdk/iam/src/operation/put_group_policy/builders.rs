...
impl PutGroupPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_group_policy::builders::PutGroupPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_group_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_group_policy::builders::PutGroupPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
