...
impl UpdateAssumeRolePolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_assume_role_policy::builders::UpdateAssumeRolePolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_assume_role_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_assume_role_policy::builders::UpdateAssumeRolePolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
