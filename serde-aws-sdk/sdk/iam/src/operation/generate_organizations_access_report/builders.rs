...
impl GenerateOrganizationsAccessReportFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::generate_organizations_access_report::builders::GenerateOrganizationsAccessReportInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.generate_organizations_access_report().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::generate_organizations_access_report::builders::GenerateOrganizationsAccessReportInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
