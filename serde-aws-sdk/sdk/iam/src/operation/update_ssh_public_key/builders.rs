...
impl UpdateSSHPublicKeyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_ssh_public_key::builders::UpdateSshPublicKeyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_ssh_public_key().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_ssh_public_key::builders::UpdateSshPublicKeyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
