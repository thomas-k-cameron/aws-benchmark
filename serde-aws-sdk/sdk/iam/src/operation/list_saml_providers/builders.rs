...
impl ListSAMLProvidersFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_saml_providers::builders::ListSamlProvidersInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_saml_providers().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_saml_providers::builders::ListSamlProvidersInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
