...
impl DeleteGroupFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_group::builders::DeleteGroupInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_group().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_group::builders::DeleteGroupInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
