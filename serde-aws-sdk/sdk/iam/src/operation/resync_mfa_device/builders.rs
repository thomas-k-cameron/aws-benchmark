...
impl ResyncMFADeviceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::resync_mfa_device::builders::ResyncMfaDeviceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.resync_mfa_device().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::resync_mfa_device::builders::ResyncMfaDeviceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
