...
impl ListOpenIDConnectProviderTagsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_open_id_connect_provider_tags::builders::ListOpenIdConnectProviderTagsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_open_id_connect_provider_tags().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_open_id_connect_provider_tags::builders::ListOpenIdConnectProviderTagsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
