...
impl AddClientIDToOpenIDConnectProviderFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::add_client_id_to_open_id_connect_provider::builders::AddClientIdToOpenIdConnectProviderInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.add_client_id_to_open_id_connect_provider().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::add_client_id_to_open_id_connect_provider::builders::AddClientIdToOpenIdConnectProviderInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
