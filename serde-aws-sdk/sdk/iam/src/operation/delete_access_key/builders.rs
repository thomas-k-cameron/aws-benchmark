...
impl DeleteAccessKeyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_access_key::builders::DeleteAccessKeyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_access_key().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_access_key::builders::DeleteAccessKeyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
