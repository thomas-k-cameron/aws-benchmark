...
impl UpdateServiceSpecificCredentialFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_service_specific_credential::builders::UpdateServiceSpecificCredentialInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_service_specific_credential().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_service_specific_credential::builders::UpdateServiceSpecificCredentialInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
