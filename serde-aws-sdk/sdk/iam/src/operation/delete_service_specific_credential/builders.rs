...
impl DeleteServiceSpecificCredentialFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_service_specific_credential::builders::DeleteServiceSpecificCredentialInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_service_specific_credential().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_service_specific_credential::builders::DeleteServiceSpecificCredentialInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
