...
impl GetCredentialReportFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::CustomizableOperation<
            crate::operation::get_credential_report::GetCredentialReport,
    ...
    ///     let deserialized_parameters: crate::operation::get_credential_report::builders::GetCredentialReportInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_credential_report().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_credential_report::builders::GetCredentialReportInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
