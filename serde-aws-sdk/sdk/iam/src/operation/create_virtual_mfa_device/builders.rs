...
impl CreateVirtualMFADeviceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_virtual_mfa_device::builders::CreateVirtualMfaDeviceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_virtual_mfa_device().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_virtual_mfa_device::builders::CreateVirtualMfaDeviceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
