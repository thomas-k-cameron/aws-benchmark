...
impl UpdateAccountPasswordPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_account_password_policy::builders::UpdateAccountPasswordPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_account_password_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_account_password_policy::builders::UpdateAccountPasswordPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
