...
impl DeactivateMFADeviceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::deactivate_mfa_device::builders::DeactivateMfaDeviceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.deactivate_mfa_device().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::deactivate_mfa_device::builders::DeactivateMfaDeviceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
