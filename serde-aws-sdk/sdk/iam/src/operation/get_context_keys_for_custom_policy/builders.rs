...
impl GetContextKeysForCustomPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_context_keys_for_custom_policy::builders::GetContextKeysForCustomPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_context_keys_for_custom_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_context_keys_for_custom_policy::builders::GetContextKeysForCustomPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
