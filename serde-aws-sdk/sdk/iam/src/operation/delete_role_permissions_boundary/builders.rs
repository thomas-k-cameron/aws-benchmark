...
impl DeleteRolePermissionsBoundaryFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_role_permissions_boundary::builders::DeleteRolePermissionsBoundaryInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_role_permissions_boundary().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_role_permissions_boundary::builders::DeleteRolePermissionsBoundaryInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
