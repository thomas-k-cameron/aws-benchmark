...
impl DeleteSAMLProviderFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_saml_provider::builders::DeleteSamlProviderInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_saml_provider().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_saml_provider::builders::DeleteSamlProviderInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
