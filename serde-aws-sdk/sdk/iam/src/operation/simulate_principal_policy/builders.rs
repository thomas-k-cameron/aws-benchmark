...
impl SimulatePrincipalPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::simulate_principal_policy::builders::SimulatePrincipalPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.simulate_principal_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::simulate_principal_policy::builders::SimulatePrincipalPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
