...
impl ChangePasswordFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::change_password::builders::ChangePasswordInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.change_password().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::change_password::builders::ChangePasswordInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
