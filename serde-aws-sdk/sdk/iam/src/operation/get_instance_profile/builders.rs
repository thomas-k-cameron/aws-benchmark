...
impl GetInstanceProfileFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_instance_profile::builders::GetInstanceProfileInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_instance_profile().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_instance_profile::builders::GetInstanceProfileInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
