...
impl UntagMFADeviceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::untag_mfa_device::builders::UntagMfaDeviceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.untag_mfa_device().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::untag_mfa_device::builders::UntagMfaDeviceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
