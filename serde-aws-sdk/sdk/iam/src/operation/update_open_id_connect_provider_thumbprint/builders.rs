...
impl UpdateOpenIDConnectProviderThumbprintFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_open_id_connect_provider_thumbprint::builders::UpdateOpenIdConnectProviderThumbprintInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_open_id_connect_provider_thumbprint().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_open_id_connect_provider_thumbprint::builders::UpdateOpenIdConnectProviderThumbprintInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
