...
impl ResetServiceSpecificCredentialFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::reset_service_specific_credential::builders::ResetServiceSpecificCredentialInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.reset_service_specific_credential().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::reset_service_specific_credential::builders::ResetServiceSpecificCredentialInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
