...
impl DetachUserPolicyFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::CustomizableOperation<
            crate::operation::detach_user_policy::DetachUserPolicy,
    ...
    ///     let deserialized_parameters: crate::operation::detach_user_policy::builders::DetachUserPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.detach_user_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::detach_user_policy::builders::DetachUserPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
