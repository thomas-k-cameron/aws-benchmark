...
impl DeleteAccountPasswordPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_account_password_policy::builders::DeleteAccountPasswordPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_account_password_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_account_password_policy::builders::DeleteAccountPasswordPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
