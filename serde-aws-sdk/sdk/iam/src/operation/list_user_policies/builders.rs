...
impl ListUserPoliciesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_user_policies::builders::ListUserPoliciesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_user_policies().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_user_policies::builders::ListUserPoliciesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
