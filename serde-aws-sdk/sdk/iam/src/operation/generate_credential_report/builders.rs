...
impl GenerateCredentialReportFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::CustomizableOperation<
            crate::operation::generate_credential_report::GenerateCredentialReport,
    ...
    ///     let deserialized_parameters: crate::operation::generate_credential_report::builders::GenerateCredentialReportInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.generate_credential_report().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::generate_credential_report::builders::GenerateCredentialReportInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
