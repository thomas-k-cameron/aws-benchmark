...
impl UpdateAccessKeyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_access_key::builders::UpdateAccessKeyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_access_key().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_access_key::builders::UpdateAccessKeyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
