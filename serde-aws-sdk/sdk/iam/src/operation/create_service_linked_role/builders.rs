...
impl CreateServiceLinkedRoleFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_service_linked_role::builders::CreateServiceLinkedRoleInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_service_linked_role().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_service_linked_role::builders::CreateServiceLinkedRoleInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
