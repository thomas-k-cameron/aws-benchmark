...
impl GetServiceLastAccessedDetailsWithEntitiesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_service_last_accessed_details_with_entities::builders::GetServiceLastAccessedDetailsWithEntitiesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_service_last_accessed_details_with_entities().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_service_last_accessed_details_with_entities::builders::GetServiceLastAccessedDetailsWithEntitiesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
