...
impl ListInstanceProfilesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_instance_profiles::builders::ListInstanceProfilesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_instance_profiles().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_instance_profiles::builders::ListInstanceProfilesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
