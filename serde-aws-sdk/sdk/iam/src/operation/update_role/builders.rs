...
impl UpdateRoleFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_role::builders::UpdateRoleInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_role().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_role::builders::UpdateRoleInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
