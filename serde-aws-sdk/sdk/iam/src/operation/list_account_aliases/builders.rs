...
impl ListAccountAliasesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_account_aliases::builders::ListAccountAliasesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_account_aliases().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_account_aliases::builders::ListAccountAliasesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
