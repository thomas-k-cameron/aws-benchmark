...
impl GetOpenIDConnectProviderFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_open_id_connect_provider::builders::GetOpenIdConnectProviderInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_open_id_connect_provider().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_open_id_connect_provider::builders::GetOpenIdConnectProviderInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
