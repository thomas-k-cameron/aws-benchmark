...
impl GetPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_policy::builders::GetPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_policy::builders::GetPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
