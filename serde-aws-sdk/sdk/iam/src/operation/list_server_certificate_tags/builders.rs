...
impl ListServerCertificateTagsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_server_certificate_tags::builders::ListServerCertificateTagsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_server_certificate_tags().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_server_certificate_tags::builders::ListServerCertificateTagsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
