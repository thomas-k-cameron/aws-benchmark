...
impl GetServiceLinkedRoleDeletionStatusFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_service_linked_role_deletion_status::builders::GetServiceLinkedRoleDeletionStatusInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_service_linked_role_deletion_status().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_service_linked_role_deletion_status::builders::GetServiceLinkedRoleDeletionStatusInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
