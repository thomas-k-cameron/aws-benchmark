...
impl CreateInstanceProfileFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_instance_profile::builders::CreateInstanceProfileInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_instance_profile().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_instance_profile::builders::CreateInstanceProfileInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
