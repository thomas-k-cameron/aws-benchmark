...
impl ListGroupsForUserFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_groups_for_user::builders::ListGroupsForUserInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_groups_for_user().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_groups_for_user::builders::ListGroupsForUserInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
