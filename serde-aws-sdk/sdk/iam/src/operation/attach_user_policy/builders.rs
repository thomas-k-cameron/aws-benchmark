...
impl AttachUserPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::attach_user_policy::builders::AttachUserPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.attach_user_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::attach_user_policy::builders::AttachUserPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
