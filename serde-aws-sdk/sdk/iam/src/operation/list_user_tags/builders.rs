...
impl ListUserTagsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_user_tags::builders::ListUserTagsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_user_tags().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_user_tags::builders::ListUserTagsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
