...
impl DeleteUserFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_user::builders::DeleteUserInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_user().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_user::builders::DeleteUserInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
