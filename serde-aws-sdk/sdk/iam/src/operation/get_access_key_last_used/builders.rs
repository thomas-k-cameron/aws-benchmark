...
impl GetAccessKeyLastUsedFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_access_key_last_used::builders::GetAccessKeyLastUsedInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_access_key_last_used().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_access_key_last_used::builders::GetAccessKeyLastUsedInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
