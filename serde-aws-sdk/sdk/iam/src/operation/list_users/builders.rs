...
impl ListUsersFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_users::builders::ListUsersInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_users().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_users::builders::ListUsersInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
