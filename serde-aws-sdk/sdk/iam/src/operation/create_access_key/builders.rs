...
impl CreateAccessKeyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_access_key::builders::CreateAccessKeyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_access_key().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_access_key::builders::CreateAccessKeyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
