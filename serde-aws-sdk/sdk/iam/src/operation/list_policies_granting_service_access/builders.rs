...
impl ListPoliciesGrantingServiceAccessFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_policies_granting_service_access::builders::ListPoliciesGrantingServiceAccessInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_policies_granting_service_access().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_policies_granting_service_access::builders::ListPoliciesGrantingServiceAccessInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
