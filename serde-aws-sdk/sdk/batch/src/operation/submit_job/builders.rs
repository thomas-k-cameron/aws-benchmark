...
impl SubmitJobFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::submit_job::builders::SubmitJobInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.submit_job().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::submit_job::builders::SubmitJobInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
