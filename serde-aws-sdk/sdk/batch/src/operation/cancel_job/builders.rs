...
impl CancelJobFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::cancel_job::builders::CancelJobInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.cancel_job().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::cancel_job::builders::CancelJobInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
