...
impl DeregisterJobDefinitionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::deregister_job_definition::builders::DeregisterJobDefinitionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.deregister_job_definition().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::deregister_job_definition::builders::DeregisterJobDefinitionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
