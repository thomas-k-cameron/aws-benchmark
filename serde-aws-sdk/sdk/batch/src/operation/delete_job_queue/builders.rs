...
impl DeleteJobQueueFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_job_queue::builders::DeleteJobQueueInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_job_queue().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_job_queue::builders::DeleteJobQueueInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
