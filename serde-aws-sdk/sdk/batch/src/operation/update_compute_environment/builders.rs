...
impl UpdateComputeEnvironmentFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_compute_environment::builders::UpdateComputeEnvironmentInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_compute_environment().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_compute_environment::builders::UpdateComputeEnvironmentInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
