...
impl DescribeJobDefinitionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_job_definitions::builders::DescribeJobDefinitionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_job_definitions().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_job_definitions::builders::DescribeJobDefinitionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
