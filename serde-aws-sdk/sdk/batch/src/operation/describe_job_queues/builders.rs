...
impl DescribeJobQueuesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_job_queues::builders::DescribeJobQueuesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_job_queues().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_job_queues::builders::DescribeJobQueuesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
