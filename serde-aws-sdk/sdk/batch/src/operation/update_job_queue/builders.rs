...
impl UpdateJobQueueFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_job_queue::builders::UpdateJobQueueInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_job_queue().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_job_queue::builders::UpdateJobQueueInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
