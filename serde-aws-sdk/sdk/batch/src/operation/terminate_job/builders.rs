...
impl TerminateJobFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::terminate_job::builders::TerminateJobInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.terminate_job().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::terminate_job::builders::TerminateJobInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
