...
impl DescribeComputeEnvironmentsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_compute_environments::builders::DescribeComputeEnvironmentsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_compute_environments().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_compute_environments::builders::DescribeComputeEnvironmentsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
