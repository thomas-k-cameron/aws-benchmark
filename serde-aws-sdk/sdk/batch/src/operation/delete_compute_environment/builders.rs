...
impl DeleteComputeEnvironmentFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_compute_environment::builders::DeleteComputeEnvironmentInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_compute_environment().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_compute_environment::builders::DeleteComputeEnvironmentInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
