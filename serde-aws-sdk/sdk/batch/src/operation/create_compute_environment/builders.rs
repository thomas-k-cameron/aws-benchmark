...
impl CreateComputeEnvironmentFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_compute_environment::builders::CreateComputeEnvironmentInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_compute_environment().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_compute_environment::builders::CreateComputeEnvironmentInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
