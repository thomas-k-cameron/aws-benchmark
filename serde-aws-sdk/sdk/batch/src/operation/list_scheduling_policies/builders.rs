...
impl ListSchedulingPoliciesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_scheduling_policies::builders::ListSchedulingPoliciesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_scheduling_policies().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_scheduling_policies::builders::ListSchedulingPoliciesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
