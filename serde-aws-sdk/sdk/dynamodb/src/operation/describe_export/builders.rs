...
impl DescribeExportFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_export::builders::DescribeExportInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_export().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_export::builders::DescribeExportInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
