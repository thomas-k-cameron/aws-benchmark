...
impl BatchGetItemFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::batch_get_item::builders::BatchGetItemInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.batch_get_item().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::batch_get_item::builders::BatchGetItemInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
