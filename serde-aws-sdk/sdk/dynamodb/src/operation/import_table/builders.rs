...
impl ImportTableFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::import_table::builders::ImportTableInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.import_table().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::import_table::builders::ImportTableInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
