...
impl DeleteTableFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_table::builders::DeleteTableInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_table().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_table::builders::DeleteTableInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
