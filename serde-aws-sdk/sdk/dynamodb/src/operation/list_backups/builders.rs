...
impl ListBackupsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_backups::builders::ListBackupsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_backups().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_backups::builders::ListBackupsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
