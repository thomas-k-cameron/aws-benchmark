...
impl ExecuteStatementFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::execute_statement::builders::ExecuteStatementInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.execute_statement().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::execute_statement::builders::ExecuteStatementInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
