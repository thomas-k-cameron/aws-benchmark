...
impl DescribeTimeToLiveFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_time_to_live::builders::DescribeTimeToLiveInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_time_to_live().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_time_to_live::builders::DescribeTimeToLiveInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
