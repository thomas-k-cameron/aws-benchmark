...
impl UntagResourceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::untag_resource::builders::UntagResourceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.untag_resource().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::untag_resource::builders::UntagResourceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
