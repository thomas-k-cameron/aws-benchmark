...
impl ExportTableToPointInTimeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::export_table_to_point_in_time::builders::ExportTableToPointInTimeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.export_table_to_point_in_time().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::export_table_to_point_in_time::builders::ExportTableToPointInTimeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
