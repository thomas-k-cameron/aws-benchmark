...
impl PutItemFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_item::builders::PutItemInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_item().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_item::builders::PutItemInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
