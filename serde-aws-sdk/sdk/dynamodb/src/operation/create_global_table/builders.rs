...
impl CreateGlobalTableFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_global_table::builders::CreateGlobalTableInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_global_table().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_global_table::builders::CreateGlobalTableInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
