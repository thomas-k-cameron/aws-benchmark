...
impl GetItemFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_item::builders::GetItemInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_item().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_item::builders::GetItemInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
