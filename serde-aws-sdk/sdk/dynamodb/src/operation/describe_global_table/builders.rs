...
impl DescribeGlobalTableFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_global_table::builders::DescribeGlobalTableInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_global_table().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_global_table::builders::DescribeGlobalTableInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
