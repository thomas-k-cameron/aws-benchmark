...
impl RestoreTableToPointInTimeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::restore_table_to_point_in_time::builders::RestoreTableToPointInTimeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.restore_table_to_point_in_time().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::restore_table_to_point_in_time::builders::RestoreTableToPointInTimeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
