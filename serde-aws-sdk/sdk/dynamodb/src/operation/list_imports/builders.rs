...
impl ListImportsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_imports::builders::ListImportsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_imports().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_imports::builders::ListImportsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
