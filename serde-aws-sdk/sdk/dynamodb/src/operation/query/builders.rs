...
impl QueryFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::query::builders::QueryInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.query().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::query::builders::QueryInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
