...
impl DescribeEndpointsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_endpoints::builders::DescribeEndpointsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_endpoints().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_endpoints::builders::DescribeEndpointsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
