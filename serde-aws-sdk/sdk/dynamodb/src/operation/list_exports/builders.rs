...
impl ListExportsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_exports::builders::ListExportsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_exports().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_exports::builders::ListExportsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
