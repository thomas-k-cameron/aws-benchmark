...
impl UpdateTableFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_table::builders::UpdateTableInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_table().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_table::builders::UpdateTableInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
