...
impl CreateTableFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_table::builders::CreateTableInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_table().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_table::builders::CreateTableInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
