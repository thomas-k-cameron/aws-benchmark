...
impl ListTagsOfResourceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_tags_of_resource::builders::ListTagsOfResourceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_tags_of_resource().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_tags_of_resource::builders::ListTagsOfResourceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
