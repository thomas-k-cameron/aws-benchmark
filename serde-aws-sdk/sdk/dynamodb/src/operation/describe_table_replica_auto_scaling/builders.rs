...
impl DescribeTableReplicaAutoScalingFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_table_replica_auto_scaling::builders::DescribeTableReplicaAutoScalingInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_table_replica_auto_scaling().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_table_replica_auto_scaling::builders::DescribeTableReplicaAutoScalingInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
