...
impl DescribeContinuousBackupsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_continuous_backups::builders::DescribeContinuousBackupsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_continuous_backups().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_continuous_backups::builders::DescribeContinuousBackupsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
