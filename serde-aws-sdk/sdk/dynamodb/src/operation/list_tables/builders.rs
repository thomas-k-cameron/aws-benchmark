...
impl ListTablesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_tables::builders::ListTablesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_tables().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_tables::builders::ListTablesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
