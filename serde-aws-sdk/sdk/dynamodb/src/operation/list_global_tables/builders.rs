...
impl ListGlobalTablesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_global_tables::builders::ListGlobalTablesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_global_tables().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_global_tables::builders::ListGlobalTablesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
