...
impl UpdateTimeToLiveFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_time_to_live::builders::UpdateTimeToLiveInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_time_to_live().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_time_to_live::builders::UpdateTimeToLiveInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
