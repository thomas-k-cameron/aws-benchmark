...
impl DescribeTableFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_table::builders::DescribeTableInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_table().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_table::builders::DescribeTableInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
