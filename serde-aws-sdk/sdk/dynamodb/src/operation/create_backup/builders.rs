...
impl CreateBackupFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_backup::builders::CreateBackupInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_backup().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_backup::builders::CreateBackupInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
