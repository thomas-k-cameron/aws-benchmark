...
impl DeleteItemFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_item::builders::DeleteItemInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_item().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_item::builders::DeleteItemInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
