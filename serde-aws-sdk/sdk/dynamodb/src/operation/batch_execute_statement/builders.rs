...
impl BatchExecuteStatementFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::batch_execute_statement::builders::BatchExecuteStatementInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.batch_execute_statement().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::batch_execute_statement::builders::BatchExecuteStatementInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
