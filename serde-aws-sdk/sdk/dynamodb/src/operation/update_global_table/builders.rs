...
impl UpdateGlobalTableFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_global_table::builders::UpdateGlobalTableInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_global_table().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_global_table::builders::UpdateGlobalTableInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
