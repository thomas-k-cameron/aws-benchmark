...
impl TransactGetItemsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::transact_get_items::builders::TransactGetItemsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.transact_get_items().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::transact_get_items::builders::TransactGetItemsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
