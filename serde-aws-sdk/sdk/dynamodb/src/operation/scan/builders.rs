...
impl ScanFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::scan::builders::ScanInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.scan().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(mut self, data: crate::operation::scan::builders::ScanInputBuilder) -> Self {
        self.inner = data;
        self
    }
