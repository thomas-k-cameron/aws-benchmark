...
impl TransactWriteItemsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::transact_write_items::builders::TransactWriteItemsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.transact_write_items().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::transact_write_items::builders::TransactWriteItemsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
