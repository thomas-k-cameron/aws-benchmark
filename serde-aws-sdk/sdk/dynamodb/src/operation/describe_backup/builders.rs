...
impl DescribeBackupFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_backup::builders::DescribeBackupInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_backup().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_backup::builders::DescribeBackupInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
