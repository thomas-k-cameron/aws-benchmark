...
impl DescribeLimitsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_limits::builders::DescribeLimitsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_limits().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_limits::builders::DescribeLimitsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
