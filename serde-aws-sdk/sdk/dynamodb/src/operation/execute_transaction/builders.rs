...
impl ExecuteTransactionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::execute_transaction::builders::ExecuteTransactionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.execute_transaction().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::execute_transaction::builders::ExecuteTransactionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
