...
impl UpdateTableReplicaAutoScalingFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_table_replica_auto_scaling::builders::UpdateTableReplicaAutoScalingInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_table_replica_auto_scaling().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_table_replica_auto_scaling::builders::UpdateTableReplicaAutoScalingInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
