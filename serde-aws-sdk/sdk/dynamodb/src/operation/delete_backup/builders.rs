...
impl DeleteBackupFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_backup::builders::DeleteBackupInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_backup().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_backup::builders::DeleteBackupInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
