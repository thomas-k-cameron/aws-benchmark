...
impl DescribeGlobalTableSettingsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_global_table_settings::builders::DescribeGlobalTableSettingsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_global_table_settings().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_global_table_settings::builders::DescribeGlobalTableSettingsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
