...
impl DescribeKinesisStreamingDestinationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_kinesis_streaming_destination::builders::DescribeKinesisStreamingDestinationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_kinesis_streaming_destination().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_kinesis_streaming_destination::builders::DescribeKinesisStreamingDestinationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
