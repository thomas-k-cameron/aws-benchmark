...
impl ListContributorInsightsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_contributor_insights::builders::ListContributorInsightsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_contributor_insights().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_contributor_insights::builders::ListContributorInsightsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
