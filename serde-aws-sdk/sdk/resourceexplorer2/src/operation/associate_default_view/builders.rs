...
impl AssociateDefaultViewFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::associate_default_view::builders::AssociateDefaultViewInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.associate_default_view().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::associate_default_view::builders::AssociateDefaultViewInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
