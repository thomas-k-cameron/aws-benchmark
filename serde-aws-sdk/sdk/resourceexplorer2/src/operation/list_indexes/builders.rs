...
impl ListIndexesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_indexes::builders::ListIndexesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_indexes().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_indexes::builders::ListIndexesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
