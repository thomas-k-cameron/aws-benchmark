...
impl GetViewFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_view::builders::GetViewInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_view().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_view::builders::GetViewInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
