...
impl CreateIndexFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_index::builders::CreateIndexInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_index().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_index::builders::CreateIndexInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
