...
impl UpdateIndexTypeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_index_type::builders::UpdateIndexTypeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_index_type().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_index_type::builders::UpdateIndexTypeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
