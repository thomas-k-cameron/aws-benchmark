...
impl SearchFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::search::builders::SearchInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.search().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::search::builders::SearchInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
