...
impl GetIndexFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_index::builders::GetIndexInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_index().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_index::builders::GetIndexInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
