...
impl ListViewsFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::CustomizableOperation<
            crate::operation::list_views::ListViews,
    ...
    ///     let deserialized_parameters: crate::operation::list_views::builders::ListViewsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_views().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_views::builders::ListViewsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
