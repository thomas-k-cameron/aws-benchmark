...
impl CreateViewFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_view::builders::CreateViewInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_view().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_view::builders::CreateViewInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
