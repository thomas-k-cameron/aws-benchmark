...
impl DeleteViewFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_view::builders::DeleteViewInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_view().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_view::builders::DeleteViewInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
