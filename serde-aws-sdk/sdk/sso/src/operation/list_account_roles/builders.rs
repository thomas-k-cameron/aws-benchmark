...
impl ListAccountRolesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_account_roles::builders::ListAccountRolesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_account_roles().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_account_roles::builders::ListAccountRolesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
