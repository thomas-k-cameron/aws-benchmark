...
impl GetRoleCredentialsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_role_credentials::builders::GetRoleCredentialsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_role_credentials().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_role_credentials::builders::GetRoleCredentialsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
