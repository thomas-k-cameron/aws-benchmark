...
impl ListReusableDelegationSetsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_reusable_delegation_sets::builders::ListReusableDelegationSetsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_reusable_delegation_sets().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_reusable_delegation_sets::builders::ListReusableDelegationSetsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
