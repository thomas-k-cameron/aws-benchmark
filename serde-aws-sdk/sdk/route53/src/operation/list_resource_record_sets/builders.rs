...
impl ListResourceRecordSetsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_resource_record_sets::builders::ListResourceRecordSetsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_resource_record_sets().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_resource_record_sets::builders::ListResourceRecordSetsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
