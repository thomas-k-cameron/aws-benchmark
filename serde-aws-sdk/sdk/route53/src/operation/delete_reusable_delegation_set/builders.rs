...
impl DeleteReusableDelegationSetFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_reusable_delegation_set::builders::DeleteReusableDelegationSetInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_reusable_delegation_set().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_reusable_delegation_set::builders::DeleteReusableDelegationSetInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
