...
impl ListVPCAssociationAuthorizationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_vpc_association_authorizations::builders::ListVpcAssociationAuthorizationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_vpc_association_authorizations().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_vpc_association_authorizations::builders::ListVpcAssociationAuthorizationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
