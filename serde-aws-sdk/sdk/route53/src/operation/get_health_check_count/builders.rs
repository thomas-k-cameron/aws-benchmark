...
impl GetHealthCheckCountFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_health_check_count::builders::GetHealthCheckCountInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_health_check_count().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_health_check_count::builders::GetHealthCheckCountInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
