...
impl ChangeResourceRecordSetsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::change_resource_record_sets::builders::ChangeResourceRecordSetsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.change_resource_record_sets().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::change_resource_record_sets::builders::ChangeResourceRecordSetsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
