...
impl GetReusableDelegationSetLimitFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_reusable_delegation_set_limit::builders::GetReusableDelegationSetLimitInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_reusable_delegation_set_limit().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_reusable_delegation_set_limit::builders::GetReusableDelegationSetLimitInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
