...
impl ListHostedZonesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_hosted_zones::builders::ListHostedZonesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_hosted_zones().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_hosted_zones::builders::ListHostedZonesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
