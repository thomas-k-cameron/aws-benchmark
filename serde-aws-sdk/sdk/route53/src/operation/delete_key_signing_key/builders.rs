...
impl DeleteKeySigningKeyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_key_signing_key::builders::DeleteKeySigningKeyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_key_signing_key().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_key_signing_key::builders::DeleteKeySigningKeyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
