...
impl ActivateKeySigningKeyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::activate_key_signing_key::builders::ActivateKeySigningKeyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.activate_key_signing_key().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::activate_key_signing_key::builders::ActivateKeySigningKeyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
