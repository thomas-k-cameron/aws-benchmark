...
impl UpdateTrafficPolicyCommentFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_traffic_policy_comment::builders::UpdateTrafficPolicyCommentInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_traffic_policy_comment().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_traffic_policy_comment::builders::UpdateTrafficPolicyCommentInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
