...
impl ChangeCidrCollectionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::change_cidr_collection::builders::ChangeCidrCollectionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.change_cidr_collection().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::change_cidr_collection::builders::ChangeCidrCollectionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
