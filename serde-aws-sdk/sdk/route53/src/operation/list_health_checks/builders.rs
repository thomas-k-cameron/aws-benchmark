...
impl ListHealthChecksFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_health_checks::builders::ListHealthChecksInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_health_checks().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_health_checks::builders::ListHealthChecksInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
