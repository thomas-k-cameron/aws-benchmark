...
impl CreateCidrCollectionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_cidr_collection::builders::CreateCidrCollectionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_cidr_collection().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_cidr_collection::builders::CreateCidrCollectionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
