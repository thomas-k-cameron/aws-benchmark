...
impl ChangeTagsForResourceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::change_tags_for_resource::builders::ChangeTagsForResourceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.change_tags_for_resource().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::change_tags_for_resource::builders::ChangeTagsForResourceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
