...
impl DeactivateKeySigningKeyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::deactivate_key_signing_key::builders::DeactivateKeySigningKeyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.deactivate_key_signing_key().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::deactivate_key_signing_key::builders::DeactivateKeySigningKeyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
