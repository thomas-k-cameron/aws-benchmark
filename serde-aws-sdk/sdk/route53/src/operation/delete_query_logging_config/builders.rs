...
impl DeleteQueryLoggingConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_query_logging_config::builders::DeleteQueryLoggingConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_query_logging_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_query_logging_config::builders::DeleteQueryLoggingConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
