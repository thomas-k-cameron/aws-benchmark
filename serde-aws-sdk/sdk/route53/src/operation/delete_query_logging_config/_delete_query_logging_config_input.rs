...
impl DeleteQueryLoggingConfigInput {
    ...
    pub fn builder(
    ) -> crate::operation::delete_query_logging_config::builders::DeleteQueryLoggingConfigInputBuilder
    {
...
#[allow(dead_code)]
pub type OutputShape = crate::operation::delete_query_logging_config::DeleteQueryLoggingConfigInput;
