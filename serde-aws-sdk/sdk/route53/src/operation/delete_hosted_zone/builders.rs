...
impl DeleteHostedZoneFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_hosted_zone::builders::DeleteHostedZoneInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_hosted_zone().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_hosted_zone::builders::DeleteHostedZoneInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
