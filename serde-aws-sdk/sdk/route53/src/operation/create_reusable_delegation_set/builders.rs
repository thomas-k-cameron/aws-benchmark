...
impl CreateReusableDelegationSetFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_reusable_delegation_set::builders::CreateReusableDelegationSetInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_reusable_delegation_set().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_reusable_delegation_set::builders::CreateReusableDelegationSetInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
