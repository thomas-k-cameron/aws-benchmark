...
impl CreateTrafficPolicyInstanceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_traffic_policy_instance::builders::CreateTrafficPolicyInstanceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_traffic_policy_instance().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_traffic_policy_instance::builders::CreateTrafficPolicyInstanceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
