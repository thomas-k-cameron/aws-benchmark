...
impl ListCidrCollectionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_cidr_collections::builders::ListCidrCollectionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_cidr_collections().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_cidr_collections::builders::ListCidrCollectionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
