...
impl ListTrafficPolicyInstancesByPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_traffic_policy_instances_by_policy::builders::ListTrafficPolicyInstancesByPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_traffic_policy_instances_by_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_traffic_policy_instances_by_policy::builders::ListTrafficPolicyInstancesByPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
