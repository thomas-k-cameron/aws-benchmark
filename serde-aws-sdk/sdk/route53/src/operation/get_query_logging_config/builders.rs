...
impl GetQueryLoggingConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_query_logging_config::builders::GetQueryLoggingConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_query_logging_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_query_logging_config::builders::GetQueryLoggingConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
