...
impl GetHostedZoneCountFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_hosted_zone_count::builders::GetHostedZoneCountInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_hosted_zone_count().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_hosted_zone_count::builders::GetHostedZoneCountInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
