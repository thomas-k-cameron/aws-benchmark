...
impl DisassociateVPCFromHostedZoneFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::disassociate_vpc_from_hosted_zone::builders::DisassociateVpcFromHostedZoneInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.disassociate_vpc_from_hosted_zone().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::disassociate_vpc_from_hosted_zone::builders::DisassociateVpcFromHostedZoneInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
