...
impl ListTrafficPoliciesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_traffic_policies::builders::ListTrafficPoliciesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_traffic_policies().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_traffic_policies::builders::ListTrafficPoliciesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
