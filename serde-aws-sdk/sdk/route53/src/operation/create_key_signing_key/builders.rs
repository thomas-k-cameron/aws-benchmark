...
impl CreateKeySigningKeyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_key_signing_key::builders::CreateKeySigningKeyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_key_signing_key().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_key_signing_key::builders::CreateKeySigningKeyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
