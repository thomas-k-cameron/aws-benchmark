...
impl GetReusableDelegationSetFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::CustomizableOperation<
            crate::operation::get_reusable_delegation_set::GetReusableDelegationSet,
    ...
    ///     let deserialized_parameters: crate::operation::get_reusable_delegation_set::builders::GetReusableDelegationSetInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_reusable_delegation_set().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_reusable_delegation_set::builders::GetReusableDelegationSetInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
