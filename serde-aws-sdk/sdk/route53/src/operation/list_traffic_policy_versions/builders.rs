...
impl ListTrafficPolicyVersionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_traffic_policy_versions::builders::ListTrafficPolicyVersionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_traffic_policy_versions().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_traffic_policy_versions::builders::ListTrafficPolicyVersionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
