...
impl ListQueryLoggingConfigsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_query_logging_configs::builders::ListQueryLoggingConfigsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_query_logging_configs().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_query_logging_configs::builders::ListQueryLoggingConfigsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
