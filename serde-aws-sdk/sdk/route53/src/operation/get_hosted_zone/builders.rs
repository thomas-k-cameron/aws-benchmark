...
impl GetHostedZoneFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_hosted_zone::builders::GetHostedZoneInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_hosted_zone().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_hosted_zone::builders::GetHostedZoneInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
