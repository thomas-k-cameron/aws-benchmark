...
impl GetHealthCheckFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_health_check::builders::GetHealthCheckInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_health_check().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_health_check::builders::GetHealthCheckInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
