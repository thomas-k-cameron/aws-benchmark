...
impl GetHostedZoneLimitFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_hosted_zone_limit::builders::GetHostedZoneLimitInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_hosted_zone_limit().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_hosted_zone_limit::builders::GetHostedZoneLimitInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
