...
impl UpdateHealthCheckFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_health_check::builders::UpdateHealthCheckInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_health_check().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_health_check::builders::UpdateHealthCheckInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
