...
impl CreateHealthCheckFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_health_check::builders::CreateHealthCheckInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_health_check().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_health_check::builders::CreateHealthCheckInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
