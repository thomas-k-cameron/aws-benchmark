...
impl DeleteCidrCollectionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_cidr_collection::builders::DeleteCidrCollectionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_cidr_collection().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_cidr_collection::builders::DeleteCidrCollectionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
