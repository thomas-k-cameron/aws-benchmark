...
impl GetChangeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_change::builders::GetChangeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_change().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_change::builders::GetChangeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
