...
impl GetAccountLimitFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_account_limit::builders::GetAccountLimitInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_account_limit().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_account_limit::builders::GetAccountLimitInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
