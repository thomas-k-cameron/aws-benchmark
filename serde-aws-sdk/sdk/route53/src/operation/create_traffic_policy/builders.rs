...
impl CreateTrafficPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_traffic_policy::builders::CreateTrafficPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_traffic_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_traffic_policy::builders::CreateTrafficPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
