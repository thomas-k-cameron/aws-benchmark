...
impl DeleteVPCAssociationAuthorizationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_vpc_association_authorization::builders::DeleteVpcAssociationAuthorizationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_vpc_association_authorization().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_vpc_association_authorization::builders::DeleteVpcAssociationAuthorizationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
