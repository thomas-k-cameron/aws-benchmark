...
impl EnableHostedZoneDNSSECFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::enable_hosted_zone_dnssec::builders::EnableHostedZoneDnssecInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.enable_hosted_zone_dnssec().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::enable_hosted_zone_dnssec::builders::EnableHostedZoneDnssecInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
