...
impl ListCidrLocationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_cidr_locations::builders::ListCidrLocationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_cidr_locations().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_cidr_locations::builders::ListCidrLocationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
