...
impl DeleteOrganizationConfigRuleFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_organization_config_rule::builders::DeleteOrganizationConfigRuleInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_organization_config_rule().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_organization_config_rule::builders::DeleteOrganizationConfigRuleInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
