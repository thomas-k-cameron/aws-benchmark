...
impl PutEvaluationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_evaluations::builders::PutEvaluationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_evaluations().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_evaluations::builders::PutEvaluationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
