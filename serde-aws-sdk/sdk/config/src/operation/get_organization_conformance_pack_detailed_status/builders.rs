...
impl GetOrganizationConformancePackDetailedStatusFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_organization_conformance_pack_detailed_status::builders::GetOrganizationConformancePackDetailedStatusInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_organization_conformance_pack_detailed_status().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_organization_conformance_pack_detailed_status::builders::GetOrganizationConformancePackDetailedStatusInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
