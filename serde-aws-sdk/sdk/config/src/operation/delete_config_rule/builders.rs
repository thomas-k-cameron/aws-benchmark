...
impl DeleteConfigRuleFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_config_rule::builders::DeleteConfigRuleInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_config_rule().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_config_rule::builders::DeleteConfigRuleInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
