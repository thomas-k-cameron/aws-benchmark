...
impl StartRemediationExecutionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::start_remediation_execution::builders::StartRemediationExecutionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.start_remediation_execution().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::start_remediation_execution::builders::StartRemediationExecutionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
