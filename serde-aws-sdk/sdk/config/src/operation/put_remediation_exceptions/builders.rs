...
impl PutRemediationExceptionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_remediation_exceptions::builders::PutRemediationExceptionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_remediation_exceptions().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_remediation_exceptions::builders::PutRemediationExceptionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
