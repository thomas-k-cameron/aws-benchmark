...
impl StartResourceEvaluationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::start_resource_evaluation::builders::StartResourceEvaluationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.start_resource_evaluation().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::start_resource_evaluation::builders::StartResourceEvaluationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
