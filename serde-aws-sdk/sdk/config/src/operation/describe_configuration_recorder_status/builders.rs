...
impl DescribeConfigurationRecorderStatusFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_configuration_recorder_status::builders::DescribeConfigurationRecorderStatusInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_configuration_recorder_status().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_configuration_recorder_status::builders::DescribeConfigurationRecorderStatusInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
