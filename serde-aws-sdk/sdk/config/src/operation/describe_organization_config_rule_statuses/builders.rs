...
impl DescribeOrganizationConfigRuleStatusesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_organization_config_rule_statuses::builders::DescribeOrganizationConfigRuleStatusesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_organization_config_rule_statuses().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_organization_config_rule_statuses::builders::DescribeOrganizationConfigRuleStatusesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
