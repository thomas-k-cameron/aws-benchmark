...
impl DescribeConfigurationRecordersFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_configuration_recorders::builders::DescribeConfigurationRecordersInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_configuration_recorders().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_configuration_recorders::builders::DescribeConfigurationRecordersInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
