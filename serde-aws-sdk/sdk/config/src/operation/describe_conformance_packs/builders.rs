...
impl DescribeConformancePacksFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_conformance_packs::builders::DescribeConformancePacksInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_conformance_packs().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_conformance_packs::builders::DescribeConformancePacksInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
