...
impl DescribeAggregateComplianceByConfigRulesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_aggregate_compliance_by_config_rules::builders::DescribeAggregateComplianceByConfigRulesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_aggregate_compliance_by_config_rules().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_aggregate_compliance_by_config_rules::builders::DescribeAggregateComplianceByConfigRulesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
