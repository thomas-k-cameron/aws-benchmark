...
impl StartConfigRulesEvaluationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::start_config_rules_evaluation::builders::StartConfigRulesEvaluationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.start_config_rules_evaluation().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::start_config_rules_evaluation::builders::StartConfigRulesEvaluationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
