...
impl DescribeAggregationAuthorizationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_aggregation_authorizations::builders::DescribeAggregationAuthorizationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_aggregation_authorizations().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_aggregation_authorizations::builders::DescribeAggregationAuthorizationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
