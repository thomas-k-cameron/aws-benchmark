...
impl PutConfigRuleFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_config_rule::builders::PutConfigRuleInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_config_rule().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_config_rule::builders::PutConfigRuleInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
