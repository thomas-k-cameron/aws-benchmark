...
impl DescribeComplianceByResourceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_compliance_by_resource::builders::DescribeComplianceByResourceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_compliance_by_resource().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_compliance_by_resource::builders::DescribeComplianceByResourceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
