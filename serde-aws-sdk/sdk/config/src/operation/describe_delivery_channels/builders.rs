...
impl DescribeDeliveryChannelsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_delivery_channels::builders::DescribeDeliveryChannelsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_delivery_channels().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_delivery_channels::builders::DescribeDeliveryChannelsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
