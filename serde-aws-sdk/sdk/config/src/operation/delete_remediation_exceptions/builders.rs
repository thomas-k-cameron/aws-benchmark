...
impl DeleteRemediationExceptionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_remediation_exceptions::builders::DeleteRemediationExceptionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_remediation_exceptions().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_remediation_exceptions::builders::DeleteRemediationExceptionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
