...
impl GetAggregateConformancePackComplianceSummaryFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_aggregate_conformance_pack_compliance_summary::builders::GetAggregateConformancePackComplianceSummaryInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_aggregate_conformance_pack_compliance_summary().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_aggregate_conformance_pack_compliance_summary::builders::GetAggregateConformancePackComplianceSummaryInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
