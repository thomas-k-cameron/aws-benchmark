...
impl GetAggregateDiscoveredResourceCountsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_aggregate_discovered_resource_counts::builders::GetAggregateDiscoveredResourceCountsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_aggregate_discovered_resource_counts().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_aggregate_discovered_resource_counts::builders::GetAggregateDiscoveredResourceCountsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
