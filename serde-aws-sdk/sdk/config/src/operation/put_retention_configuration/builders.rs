...
impl PutRetentionConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_retention_configuration::builders::PutRetentionConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_retention_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_retention_configuration::builders::PutRetentionConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
