...
impl DescribeComplianceByConfigRuleFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_compliance_by_config_rule::builders::DescribeComplianceByConfigRuleInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_compliance_by_config_rule().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_compliance_by_config_rule::builders::DescribeComplianceByConfigRuleInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
