...
impl ListConformancePackComplianceScoresFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_conformance_pack_compliance_scores::builders::ListConformancePackComplianceScoresInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_conformance_pack_compliance_scores().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_conformance_pack_compliance_scores::builders::ListConformancePackComplianceScoresInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
