...
impl GetResourceEvaluationSummaryFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_resource_evaluation_summary::builders::GetResourceEvaluationSummaryInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_resource_evaluation_summary().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_resource_evaluation_summary::builders::GetResourceEvaluationSummaryInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
