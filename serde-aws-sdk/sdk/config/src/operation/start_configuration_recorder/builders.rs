...
impl StartConfigurationRecorderFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::start_configuration_recorder::builders::StartConfigurationRecorderInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.start_configuration_recorder().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::start_configuration_recorder::builders::StartConfigurationRecorderInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
