...
impl DescribeAggregateComplianceByConformancePacksFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_aggregate_compliance_by_conformance_packs::builders::DescribeAggregateComplianceByConformancePacksInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_aggregate_compliance_by_conformance_packs().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_aggregate_compliance_by_conformance_packs::builders::DescribeAggregateComplianceByConformancePacksInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
