...
impl DeleteResourceConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_resource_config::builders::DeleteResourceConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_resource_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_resource_config::builders::DeleteResourceConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
