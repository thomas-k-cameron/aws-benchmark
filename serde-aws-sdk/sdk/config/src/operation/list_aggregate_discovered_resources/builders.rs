...
impl ListAggregateDiscoveredResourcesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_aggregate_discovered_resources::builders::ListAggregateDiscoveredResourcesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_aggregate_discovered_resources().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_aggregate_discovered_resources::builders::ListAggregateDiscoveredResourcesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
