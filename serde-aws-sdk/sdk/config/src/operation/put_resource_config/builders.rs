...
impl PutResourceConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_resource_config::builders::PutResourceConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_resource_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_resource_config::builders::PutResourceConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
