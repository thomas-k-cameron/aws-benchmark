...
impl GetComplianceDetailsByConfigRuleFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_compliance_details_by_config_rule::builders::GetComplianceDetailsByConfigRuleInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_compliance_details_by_config_rule().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_compliance_details_by_config_rule::builders::GetComplianceDetailsByConfigRuleInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
