...
impl GetConformancePackComplianceSummaryFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_conformance_pack_compliance_summary::builders::GetConformancePackComplianceSummaryInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_conformance_pack_compliance_summary().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_conformance_pack_compliance_summary::builders::GetConformancePackComplianceSummaryInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
