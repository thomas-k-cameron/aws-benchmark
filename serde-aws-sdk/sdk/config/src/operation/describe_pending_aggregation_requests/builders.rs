...
impl DescribePendingAggregationRequestsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_pending_aggregation_requests::builders::DescribePendingAggregationRequestsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_pending_aggregation_requests().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_pending_aggregation_requests::builders::DescribePendingAggregationRequestsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
