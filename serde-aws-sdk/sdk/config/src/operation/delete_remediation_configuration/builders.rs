...
impl DeleteRemediationConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_remediation_configuration::builders::DeleteRemediationConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_remediation_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_remediation_configuration::builders::DeleteRemediationConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
