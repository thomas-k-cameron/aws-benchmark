...
impl ListDiscoveredResourcesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_discovered_resources::builders::ListDiscoveredResourcesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_discovered_resources().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_discovered_resources::builders::ListDiscoveredResourcesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
