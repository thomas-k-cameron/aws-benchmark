...
impl PutExternalEvaluationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_external_evaluation::builders::PutExternalEvaluationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_external_evaluation().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_external_evaluation::builders::PutExternalEvaluationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
