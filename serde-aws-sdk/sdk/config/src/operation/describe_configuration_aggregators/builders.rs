...
impl DescribeConfigurationAggregatorsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_configuration_aggregators::builders::DescribeConfigurationAggregatorsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_configuration_aggregators().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_configuration_aggregators::builders::DescribeConfigurationAggregatorsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
