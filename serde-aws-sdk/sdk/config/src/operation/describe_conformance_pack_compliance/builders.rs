...
impl DescribeConformancePackComplianceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_conformance_pack_compliance::builders::DescribeConformancePackComplianceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_conformance_pack_compliance().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_conformance_pack_compliance::builders::DescribeConformancePackComplianceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
