...
impl DeletePendingAggregationRequestFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_pending_aggregation_request::builders::DeletePendingAggregationRequestInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_pending_aggregation_request().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_pending_aggregation_request::builders::DeletePendingAggregationRequestInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
