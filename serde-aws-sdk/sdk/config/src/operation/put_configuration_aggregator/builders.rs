...
impl PutConfigurationAggregatorFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_configuration_aggregator::builders::PutConfigurationAggregatorInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_configuration_aggregator().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_configuration_aggregator::builders::PutConfigurationAggregatorInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
