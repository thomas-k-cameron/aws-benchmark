...
impl DescribeConfigurationAggregatorSourcesStatusFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_configuration_aggregator_sources_status::builders::DescribeConfigurationAggregatorSourcesStatusInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_configuration_aggregator_sources_status().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_configuration_aggregator_sources_status::builders::DescribeConfigurationAggregatorSourcesStatusInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
