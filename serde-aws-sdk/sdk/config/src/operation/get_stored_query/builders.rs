...
impl GetStoredQueryFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_stored_query::builders::GetStoredQueryInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_stored_query().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_stored_query::builders::GetStoredQueryInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
