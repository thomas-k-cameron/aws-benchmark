...
impl GetDiscoveredResourceCountsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_discovered_resource_counts::builders::GetDiscoveredResourceCountsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_discovered_resource_counts().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_discovered_resource_counts::builders::GetDiscoveredResourceCountsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
