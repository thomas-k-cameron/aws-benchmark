...
impl BatchGetAggregateResourceConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::batch_get_aggregate_resource_config::builders::BatchGetAggregateResourceConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.batch_get_aggregate_resource_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::batch_get_aggregate_resource_config::builders::BatchGetAggregateResourceConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
