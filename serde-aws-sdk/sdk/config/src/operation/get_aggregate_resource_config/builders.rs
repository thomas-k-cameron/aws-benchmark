...
impl GetAggregateResourceConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_aggregate_resource_config::builders::GetAggregateResourceConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_aggregate_resource_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_aggregate_resource_config::builders::GetAggregateResourceConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
