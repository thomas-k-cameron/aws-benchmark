...
impl SelectAggregateResourceConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::select_aggregate_resource_config::builders::SelectAggregateResourceConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.select_aggregate_resource_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::select_aggregate_resource_config::builders::SelectAggregateResourceConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
