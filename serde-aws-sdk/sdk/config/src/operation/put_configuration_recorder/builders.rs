...
impl PutConfigurationRecorderFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_configuration_recorder::builders::PutConfigurationRecorderInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_configuration_recorder().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_configuration_recorder::builders::PutConfigurationRecorderInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
