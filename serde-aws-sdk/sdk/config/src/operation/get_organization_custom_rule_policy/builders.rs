...
impl GetOrganizationCustomRulePolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_organization_custom_rule_policy::builders::GetOrganizationCustomRulePolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_organization_custom_rule_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_organization_custom_rule_policy::builders::GetOrganizationCustomRulePolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
