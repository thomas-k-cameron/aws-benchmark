...
impl ListStoredQueriesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_stored_queries::builders::ListStoredQueriesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_stored_queries().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_stored_queries::builders::ListStoredQueriesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
