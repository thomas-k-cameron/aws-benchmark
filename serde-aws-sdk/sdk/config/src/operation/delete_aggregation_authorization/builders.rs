...
impl DeleteAggregationAuthorizationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_aggregation_authorization::builders::DeleteAggregationAuthorizationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_aggregation_authorization().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_aggregation_authorization::builders::DeleteAggregationAuthorizationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
