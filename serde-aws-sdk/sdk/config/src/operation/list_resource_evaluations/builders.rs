...
impl ListResourceEvaluationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_resource_evaluations::builders::ListResourceEvaluationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_resource_evaluations().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_resource_evaluations::builders::ListResourceEvaluationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
