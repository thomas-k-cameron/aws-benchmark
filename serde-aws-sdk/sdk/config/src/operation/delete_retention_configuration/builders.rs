...
impl DeleteRetentionConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_retention_configuration::builders::DeleteRetentionConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_retention_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_retention_configuration::builders::DeleteRetentionConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
