...
impl GetResourceConfigHistoryFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_resource_config_history::builders::GetResourceConfigHistoryInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_resource_config_history().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_resource_config_history::builders::GetResourceConfigHistoryInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
