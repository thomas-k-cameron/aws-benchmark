...
impl SelectResourceConfigFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::select_resource_config::builders::SelectResourceConfigInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.select_resource_config().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::select_resource_config::builders::SelectResourceConfigInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
