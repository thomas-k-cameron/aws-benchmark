...
impl PutAggregationAuthorizationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_aggregation_authorization::builders::PutAggregationAuthorizationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_aggregation_authorization().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_aggregation_authorization::builders::PutAggregationAuthorizationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
