...
impl UnmonitorInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::unmonitor_instances::builders::UnmonitorInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.unmonitor_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::unmonitor_instances::builders::UnmonitorInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
