...
impl AllocateHostsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::allocate_hosts::builders::AllocateHostsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.allocate_hosts().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::allocate_hosts::builders::AllocateHostsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
