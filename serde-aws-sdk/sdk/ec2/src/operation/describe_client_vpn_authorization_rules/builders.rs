...
impl DescribeClientVpnAuthorizationRulesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_client_vpn_authorization_rules::builders::DescribeClientVpnAuthorizationRulesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_client_vpn_authorization_rules().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_client_vpn_authorization_rules::builders::DescribeClientVpnAuthorizationRulesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
