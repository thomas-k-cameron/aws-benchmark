...
impl GetAssociatedEnclaveCertificateIamRolesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_associated_enclave_certificate_iam_roles::builders::GetAssociatedEnclaveCertificateIamRolesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_associated_enclave_certificate_iam_roles().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_associated_enclave_certificate_iam_roles::builders::GetAssociatedEnclaveCertificateIamRolesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
