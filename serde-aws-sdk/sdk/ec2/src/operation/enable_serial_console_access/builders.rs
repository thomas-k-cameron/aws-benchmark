...
impl EnableSerialConsoleAccessFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::enable_serial_console_access::builders::EnableSerialConsoleAccessInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.enable_serial_console_access().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::enable_serial_console_access::builders::EnableSerialConsoleAccessInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
