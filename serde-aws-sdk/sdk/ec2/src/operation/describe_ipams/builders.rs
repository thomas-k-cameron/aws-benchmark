...
impl DescribeIpamsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_ipams::builders::DescribeIpamsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_ipams().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_ipams::builders::DescribeIpamsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
