...
impl CreateManagedPrefixListFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_managed_prefix_list::builders::CreateManagedPrefixListInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_managed_prefix_list().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_managed_prefix_list::builders::CreateManagedPrefixListInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
