...
impl DeleteIpamPoolFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_ipam_pool::builders::DeleteIpamPoolInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_ipam_pool().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_ipam_pool::builders::DeleteIpamPoolInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
