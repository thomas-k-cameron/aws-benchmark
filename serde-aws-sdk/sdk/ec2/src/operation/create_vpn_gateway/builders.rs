...
impl CreateVpnGatewayFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_vpn_gateway::builders::CreateVpnGatewayInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_vpn_gateway().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_vpn_gateway::builders::CreateVpnGatewayInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
