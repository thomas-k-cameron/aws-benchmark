...
impl EnableAwsNetworkPerformanceMetricSubscriptionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::enable_aws_network_performance_metric_subscription::builders::EnableAwsNetworkPerformanceMetricSubscriptionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.enable_aws_network_performance_metric_subscription().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::enable_aws_network_performance_metric_subscription::builders::EnableAwsNetworkPerformanceMetricSubscriptionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
