...
impl DeleteInstanceEventWindowFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_instance_event_window::builders::DeleteInstanceEventWindowInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_instance_event_window().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_instance_event_window::builders::DeleteInstanceEventWindowInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
