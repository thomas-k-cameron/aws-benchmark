...
impl CreateIpamPoolFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_ipam_pool::builders::CreateIpamPoolInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_ipam_pool().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_ipam_pool::builders::CreateIpamPoolInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
