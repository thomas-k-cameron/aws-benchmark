...
impl GetManagedPrefixListEntriesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_managed_prefix_list_entries::builders::GetManagedPrefixListEntriesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_managed_prefix_list_entries().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_managed_prefix_list_entries::builders::GetManagedPrefixListEntriesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
