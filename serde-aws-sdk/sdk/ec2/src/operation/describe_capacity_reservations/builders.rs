...
impl DescribeCapacityReservationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_capacity_reservations::builders::DescribeCapacityReservationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_capacity_reservations().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_capacity_reservations::builders::DescribeCapacityReservationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
