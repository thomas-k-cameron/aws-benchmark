...
impl CreateCapacityReservationFleetFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_capacity_reservation_fleet::builders::CreateCapacityReservationFleetInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_capacity_reservation_fleet().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_capacity_reservation_fleet::builders::CreateCapacityReservationFleetInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
