...
impl DeleteEgressOnlyInternetGatewayFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_egress_only_internet_gateway::builders::DeleteEgressOnlyInternetGatewayInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_egress_only_internet_gateway().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_egress_only_internet_gateway::builders::DeleteEgressOnlyInternetGatewayInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
