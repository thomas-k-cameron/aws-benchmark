...
impl SearchTransitGatewayMulticastGroupsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::search_transit_gateway_multicast_groups::builders::SearchTransitGatewayMulticastGroupsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.search_transit_gateway_multicast_groups().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::search_transit_gateway_multicast_groups::builders::SearchTransitGatewayMulticastGroupsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
