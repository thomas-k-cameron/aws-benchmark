...
impl ImportVolumeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::import_volume::builders::ImportVolumeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.import_volume().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::import_volume::builders::ImportVolumeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
