...
impl DeleteRouteTableFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_route_table::builders::DeleteRouteTableInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_route_table().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_route_table::builders::DeleteRouteTableInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
