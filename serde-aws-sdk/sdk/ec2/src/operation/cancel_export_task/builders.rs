...
impl CancelExportTaskFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::cancel_export_task::builders::CancelExportTaskInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.cancel_export_task().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::cancel_export_task::builders::CancelExportTaskInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
