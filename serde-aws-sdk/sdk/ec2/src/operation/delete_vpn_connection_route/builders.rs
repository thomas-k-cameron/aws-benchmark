...
impl DeleteVpnConnectionRouteFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_vpn_connection_route::builders::DeleteVpnConnectionRouteInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_vpn_connection_route().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_vpn_connection_route::builders::DeleteVpnConnectionRouteInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
