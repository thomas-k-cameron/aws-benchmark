...
impl PurchaseHostReservationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::purchase_host_reservation::builders::PurchaseHostReservationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.purchase_host_reservation().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::purchase_host_reservation::builders::PurchaseHostReservationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
