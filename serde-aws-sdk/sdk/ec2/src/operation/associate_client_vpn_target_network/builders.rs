...
impl AssociateClientVpnTargetNetworkFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::associate_client_vpn_target_network::builders::AssociateClientVpnTargetNetworkInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.associate_client_vpn_target_network().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::associate_client_vpn_target_network::builders::AssociateClientVpnTargetNetworkInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
