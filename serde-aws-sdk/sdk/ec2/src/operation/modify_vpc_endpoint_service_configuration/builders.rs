...
impl ModifyVpcEndpointServiceConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_vpc_endpoint_service_configuration::builders::ModifyVpcEndpointServiceConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_vpc_endpoint_service_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_vpc_endpoint_service_configuration::builders::ModifyVpcEndpointServiceConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
