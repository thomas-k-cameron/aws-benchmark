...
impl CreateNetworkInterfacePermissionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_network_interface_permission::builders::CreateNetworkInterfacePermissionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_network_interface_permission().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_network_interface_permission::builders::CreateNetworkInterfacePermissionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
