...
impl DescribeReservedInstancesListingsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_reserved_instances_listings::builders::DescribeReservedInstancesListingsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_reserved_instances_listings().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_reserved_instances_listings::builders::DescribeReservedInstancesListingsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
