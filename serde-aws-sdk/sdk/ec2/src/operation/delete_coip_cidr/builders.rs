...
impl DeleteCoipCidrFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_coip_cidr::builders::DeleteCoipCidrInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_coip_cidr().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_coip_cidr::builders::DeleteCoipCidrInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
