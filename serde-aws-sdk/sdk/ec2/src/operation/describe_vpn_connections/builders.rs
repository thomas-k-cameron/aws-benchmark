...
impl DescribeVpnConnectionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_vpn_connections::builders::DescribeVpnConnectionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_vpn_connections().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_vpn_connections::builders::DescribeVpnConnectionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
