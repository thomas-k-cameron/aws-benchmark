...
impl RevokeSecurityGroupEgressFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::revoke_security_group_egress::builders::RevokeSecurityGroupEgressInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.revoke_security_group_egress().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::revoke_security_group_egress::builders::RevokeSecurityGroupEgressInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
