...
impl ProvisionByoipCidrFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::provision_byoip_cidr::builders::ProvisionByoipCidrInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.provision_byoip_cidr().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::provision_byoip_cidr::builders::ProvisionByoipCidrInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
