...
impl DescribeSpotDatafeedSubscriptionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_spot_datafeed_subscription::builders::DescribeSpotDatafeedSubscriptionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_spot_datafeed_subscription().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_spot_datafeed_subscription::builders::DescribeSpotDatafeedSubscriptionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
