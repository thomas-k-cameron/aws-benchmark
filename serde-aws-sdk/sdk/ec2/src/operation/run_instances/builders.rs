...
impl RunInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::run_instances::builders::RunInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.run_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::run_instances::builders::RunInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
