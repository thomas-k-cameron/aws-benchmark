...
impl DeleteVerifiedAccessGroupFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_verified_access_group::builders::DeleteVerifiedAccessGroupInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_verified_access_group().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_verified_access_group::builders::DeleteVerifiedAccessGroupInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
