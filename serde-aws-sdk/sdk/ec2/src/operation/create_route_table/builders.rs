...
impl CreateRouteTableFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_route_table::builders::CreateRouteTableInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_route_table().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_route_table::builders::CreateRouteTableInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
