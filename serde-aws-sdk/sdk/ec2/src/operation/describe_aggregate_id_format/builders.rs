...
impl DescribeAggregateIdFormatFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_aggregate_id_format::builders::DescribeAggregateIdFormatInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_aggregate_id_format().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_aggregate_id_format::builders::DescribeAggregateIdFormatInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
