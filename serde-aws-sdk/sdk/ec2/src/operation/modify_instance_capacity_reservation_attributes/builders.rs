...
impl ModifyInstanceCapacityReservationAttributesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_instance_capacity_reservation_attributes::builders::ModifyInstanceCapacityReservationAttributesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_instance_capacity_reservation_attributes().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_instance_capacity_reservation_attributes::builders::ModifyInstanceCapacityReservationAttributesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
