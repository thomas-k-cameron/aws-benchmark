...
impl DescribeVolumeStatusFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_volume_status::builders::DescribeVolumeStatusInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_volume_status().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_volume_status::builders::DescribeVolumeStatusInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
