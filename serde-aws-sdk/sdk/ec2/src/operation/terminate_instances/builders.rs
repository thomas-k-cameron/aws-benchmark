...
impl TerminateInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::terminate_instances::builders::TerminateInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.terminate_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::terminate_instances::builders::TerminateInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
