...
impl AssociateDhcpOptionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::associate_dhcp_options::builders::AssociateDhcpOptionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.associate_dhcp_options().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::associate_dhcp_options::builders::AssociateDhcpOptionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
