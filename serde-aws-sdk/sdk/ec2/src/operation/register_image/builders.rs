...
impl RegisterImageFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::register_image::builders::RegisterImageInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.register_image().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::register_image::builders::RegisterImageInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
