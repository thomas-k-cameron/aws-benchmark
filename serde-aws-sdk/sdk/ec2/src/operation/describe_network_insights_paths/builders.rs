...
impl DescribeNetworkInsightsPathsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_network_insights_paths::builders::DescribeNetworkInsightsPathsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_network_insights_paths().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_network_insights_paths::builders::DescribeNetworkInsightsPathsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
