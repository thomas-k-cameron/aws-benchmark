...
impl CreateImageFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_image::builders::CreateImageInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_image().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_image::builders::CreateImageInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
