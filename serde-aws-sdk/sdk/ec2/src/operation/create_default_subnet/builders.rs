...
impl CreateDefaultSubnetFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_default_subnet::builders::CreateDefaultSubnetInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_default_subnet().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_default_subnet::builders::CreateDefaultSubnetInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
