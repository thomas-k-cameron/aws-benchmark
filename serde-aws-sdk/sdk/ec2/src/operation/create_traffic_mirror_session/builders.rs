...
impl CreateTrafficMirrorSessionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_traffic_mirror_session::builders::CreateTrafficMirrorSessionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_traffic_mirror_session().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_traffic_mirror_session::builders::CreateTrafficMirrorSessionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
