...
impl ExportClientVpnClientConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::export_client_vpn_client_configuration::builders::ExportClientVpnClientConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.export_client_vpn_client_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::export_client_vpn_client_configuration::builders::ExportClientVpnClientConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
