...
impl AssociateSubnetCidrBlockFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::associate_subnet_cidr_block::builders::AssociateSubnetCidrBlockInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.associate_subnet_cidr_block().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::associate_subnet_cidr_block::builders::AssociateSubnetCidrBlockInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
