...
impl EnableFastSnapshotRestoresFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::enable_fast_snapshot_restores::builders::EnableFastSnapshotRestoresInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.enable_fast_snapshot_restores().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::enable_fast_snapshot_restores::builders::EnableFastSnapshotRestoresInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
