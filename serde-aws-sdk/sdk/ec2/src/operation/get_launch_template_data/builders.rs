...
impl GetLaunchTemplateDataFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_launch_template_data::builders::GetLaunchTemplateDataInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_launch_template_data().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_launch_template_data::builders::GetLaunchTemplateDataInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
