...
impl DescribeVolumeAttributeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_volume_attribute::builders::DescribeVolumeAttributeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_volume_attribute().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_volume_attribute::builders::DescribeVolumeAttributeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
