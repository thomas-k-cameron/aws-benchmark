...
impl DeleteIpamResourceDiscoveryFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_ipam_resource_discovery::builders::DeleteIpamResourceDiscoveryInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_ipam_resource_discovery().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_ipam_resource_discovery::builders::DeleteIpamResourceDiscoveryInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
