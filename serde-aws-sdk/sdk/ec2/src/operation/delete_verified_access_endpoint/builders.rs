...
impl DeleteVerifiedAccessEndpointFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_verified_access_endpoint::builders::DeleteVerifiedAccessEndpointInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_verified_access_endpoint().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_verified_access_endpoint::builders::DeleteVerifiedAccessEndpointInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
