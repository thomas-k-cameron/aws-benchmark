...
impl DeleteSnapshotFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_snapshot::builders::DeleteSnapshotInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_snapshot().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_snapshot::builders::DeleteSnapshotInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
