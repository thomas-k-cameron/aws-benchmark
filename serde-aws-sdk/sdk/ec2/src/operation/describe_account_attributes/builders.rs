...
impl DescribeAccountAttributesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_account_attributes::builders::DescribeAccountAttributesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_account_attributes().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_account_attributes::builders::DescribeAccountAttributesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
