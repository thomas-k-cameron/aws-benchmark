...
impl GetFlowLogsIntegrationTemplateFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_flow_logs_integration_template::builders::GetFlowLogsIntegrationTemplateInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_flow_logs_integration_template().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_flow_logs_integration_template::builders::GetFlowLogsIntegrationTemplateInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
