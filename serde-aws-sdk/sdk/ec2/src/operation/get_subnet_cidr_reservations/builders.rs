...
impl GetSubnetCidrReservationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_subnet_cidr_reservations::builders::GetSubnetCidrReservationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_subnet_cidr_reservations().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_subnet_cidr_reservations::builders::GetSubnetCidrReservationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
