...
impl DeprovisionPublicIpv4PoolCidrFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::deprovision_public_ipv4_pool_cidr::builders::DeprovisionPublicIpv4PoolCidrInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.deprovision_public_ipv4_pool_cidr().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::deprovision_public_ipv4_pool_cidr::builders::DeprovisionPublicIpv4PoolCidrInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
