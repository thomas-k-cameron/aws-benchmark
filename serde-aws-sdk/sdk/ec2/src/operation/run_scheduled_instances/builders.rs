...
impl RunScheduledInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::run_scheduled_instances::builders::RunScheduledInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.run_scheduled_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::run_scheduled_instances::builders::RunScheduledInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
