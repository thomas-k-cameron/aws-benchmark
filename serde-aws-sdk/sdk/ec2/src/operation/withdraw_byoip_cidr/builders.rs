...
impl WithdrawByoipCidrFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::withdraw_byoip_cidr::builders::WithdrawByoipCidrInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.withdraw_byoip_cidr().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::withdraw_byoip_cidr::builders::WithdrawByoipCidrInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
