...
impl MonitorInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::monitor_instances::builders::MonitorInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.monitor_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::monitor_instances::builders::MonitorInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
