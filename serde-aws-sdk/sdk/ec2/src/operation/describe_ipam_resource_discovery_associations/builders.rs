...
impl DescribeIpamResourceDiscoveryAssociationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_ipam_resource_discovery_associations::builders::DescribeIpamResourceDiscoveryAssociationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_ipam_resource_discovery_associations().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_ipam_resource_discovery_associations::builders::DescribeIpamResourceDiscoveryAssociationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
