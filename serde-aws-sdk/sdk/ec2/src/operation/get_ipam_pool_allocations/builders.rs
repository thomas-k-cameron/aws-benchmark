...
impl GetIpamPoolAllocationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_ipam_pool_allocations::builders::GetIpamPoolAllocationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_ipam_pool_allocations().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_ipam_pool_allocations::builders::GetIpamPoolAllocationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
