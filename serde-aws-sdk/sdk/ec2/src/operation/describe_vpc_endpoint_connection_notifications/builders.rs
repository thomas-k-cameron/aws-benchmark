...
impl DescribeVpcEndpointConnectionNotificationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_vpc_endpoint_connection_notifications::builders::DescribeVpcEndpointConnectionNotificationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_vpc_endpoint_connection_notifications().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_vpc_endpoint_connection_notifications::builders::DescribeVpcEndpointConnectionNotificationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
