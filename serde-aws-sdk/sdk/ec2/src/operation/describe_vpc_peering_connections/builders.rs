...
impl DescribeVpcPeeringConnectionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_vpc_peering_connections::builders::DescribeVpcPeeringConnectionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_vpc_peering_connections().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_vpc_peering_connections::builders::DescribeVpcPeeringConnectionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
