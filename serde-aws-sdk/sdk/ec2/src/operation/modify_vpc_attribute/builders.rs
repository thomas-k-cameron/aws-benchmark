...
impl ModifyVpcAttributeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_vpc_attribute::builders::ModifyVpcAttributeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_vpc_attribute().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_vpc_attribute::builders::ModifyVpcAttributeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
