...
impl DescribeFastSnapshotRestoresFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_fast_snapshot_restores::builders::DescribeFastSnapshotRestoresInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_fast_snapshot_restores().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_fast_snapshot_restores::builders::DescribeFastSnapshotRestoresInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
