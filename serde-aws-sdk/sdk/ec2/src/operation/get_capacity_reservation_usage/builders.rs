...
impl GetCapacityReservationUsageFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_capacity_reservation_usage::builders::GetCapacityReservationUsageInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_capacity_reservation_usage().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_capacity_reservation_usage::builders::GetCapacityReservationUsageInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
