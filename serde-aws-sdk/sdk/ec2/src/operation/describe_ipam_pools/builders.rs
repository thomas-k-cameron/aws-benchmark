...
impl DescribeIpamPoolsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_ipam_pools::builders::DescribeIpamPoolsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_ipam_pools().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_ipam_pools::builders::DescribeIpamPoolsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
