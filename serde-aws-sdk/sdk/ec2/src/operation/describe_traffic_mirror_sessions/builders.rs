...
impl DescribeTrafficMirrorSessionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_traffic_mirror_sessions::builders::DescribeTrafficMirrorSessionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_traffic_mirror_sessions().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_traffic_mirror_sessions::builders::DescribeTrafficMirrorSessionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
