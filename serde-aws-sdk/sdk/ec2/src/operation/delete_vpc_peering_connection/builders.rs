...
impl DeleteVpcPeeringConnectionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_vpc_peering_connection::builders::DeleteVpcPeeringConnectionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_vpc_peering_connection().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_vpc_peering_connection::builders::DeleteVpcPeeringConnectionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
