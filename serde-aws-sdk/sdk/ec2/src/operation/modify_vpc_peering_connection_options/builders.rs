...
impl ModifyVpcPeeringConnectionOptionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_vpc_peering_connection_options::builders::ModifyVpcPeeringConnectionOptionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_vpc_peering_connection_options().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_vpc_peering_connection_options::builders::ModifyVpcPeeringConnectionOptionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
