...
impl DeleteLocalGatewayRouteTableFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_local_gateway_route_table::builders::DeleteLocalGatewayRouteTableInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_local_gateway_route_table().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_local_gateway_route_table::builders::DeleteLocalGatewayRouteTableInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
