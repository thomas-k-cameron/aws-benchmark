...
impl DescribeSpotInstanceRequestsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_spot_instance_requests::builders::DescribeSpotInstanceRequestsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_spot_instance_requests().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_spot_instance_requests::builders::DescribeSpotInstanceRequestsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
