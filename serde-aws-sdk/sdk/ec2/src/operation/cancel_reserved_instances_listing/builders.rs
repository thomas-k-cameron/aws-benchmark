...
impl CancelReservedInstancesListingFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::cancel_reserved_instances_listing::builders::CancelReservedInstancesListingInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.cancel_reserved_instances_listing().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::cancel_reserved_instances_listing::builders::CancelReservedInstancesListingInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
