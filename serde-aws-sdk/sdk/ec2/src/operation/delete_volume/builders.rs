...
impl DeleteVolumeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_volume::builders::DeleteVolumeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_volume().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_volume::builders::DeleteVolumeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
