...
impl GetInstanceUefiDataFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_instance_uefi_data::builders::GetInstanceUefiDataInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_instance_uefi_data().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_instance_uefi_data::builders::GetInstanceUefiDataInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
