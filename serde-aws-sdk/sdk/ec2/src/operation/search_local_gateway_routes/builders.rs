...
impl SearchLocalGatewayRoutesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::search_local_gateway_routes::builders::SearchLocalGatewayRoutesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.search_local_gateway_routes().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::search_local_gateway_routes::builders::SearchLocalGatewayRoutesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
