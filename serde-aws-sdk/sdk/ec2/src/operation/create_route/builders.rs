...
impl CreateRouteFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_route::builders::CreateRouteInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_route().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_route::builders::CreateRouteInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
