...
impl CancelCapacityReservationFleetsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::cancel_capacity_reservation_fleets::builders::CancelCapacityReservationFleetsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.cancel_capacity_reservation_fleets().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::cancel_capacity_reservation_fleets::builders::CancelCapacityReservationFleetsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
