...
impl DescribeCustomerGatewaysFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_customer_gateways::builders::DescribeCustomerGatewaysInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_customer_gateways().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_customer_gateways::builders::DescribeCustomerGatewaysInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
