...
impl DescribeImportImageTasksFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_import_image_tasks::builders::DescribeImportImageTasksInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_import_image_tasks().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_import_image_tasks::builders::DescribeImportImageTasksInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
