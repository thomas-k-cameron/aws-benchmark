...
impl GetIpamPoolCidrsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_ipam_pool_cidrs::builders::GetIpamPoolCidrsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_ipam_pool_cidrs().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_ipam_pool_cidrs::builders::GetIpamPoolCidrsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
