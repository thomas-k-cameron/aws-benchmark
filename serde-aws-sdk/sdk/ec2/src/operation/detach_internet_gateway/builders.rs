...
impl DetachInternetGatewayFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::detach_internet_gateway::builders::DetachInternetGatewayInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.detach_internet_gateway().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::detach_internet_gateway::builders::DetachInternetGatewayInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
