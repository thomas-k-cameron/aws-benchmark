...
impl ExportTransitGatewayRoutesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::export_transit_gateway_routes::builders::ExportTransitGatewayRoutesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.export_transit_gateway_routes().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::export_transit_gateway_routes::builders::ExportTransitGatewayRoutesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
