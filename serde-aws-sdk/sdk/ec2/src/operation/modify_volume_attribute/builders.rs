...
impl ModifyVolumeAttributeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_volume_attribute::builders::ModifyVolumeAttributeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_volume_attribute().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_volume_attribute::builders::ModifyVolumeAttributeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
