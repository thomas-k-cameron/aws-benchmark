...
impl GetNetworkInsightsAccessScopeAnalysisFindingsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_network_insights_access_scope_analysis_findings::builders::GetNetworkInsightsAccessScopeAnalysisFindingsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_network_insights_access_scope_analysis_findings().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_network_insights_access_scope_analysis_findings::builders::GetNetworkInsightsAccessScopeAnalysisFindingsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
