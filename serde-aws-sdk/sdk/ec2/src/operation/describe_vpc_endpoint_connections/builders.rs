...
impl DescribeVpcEndpointConnectionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_vpc_endpoint_connections::builders::DescribeVpcEndpointConnectionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_vpc_endpoint_connections().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_vpc_endpoint_connections::builders::DescribeVpcEndpointConnectionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
