...
impl DescribeSpotPriceHistoryFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_spot_price_history::builders::DescribeSpotPriceHistoryInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_spot_price_history().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_spot_price_history::builders::DescribeSpotPriceHistoryInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
