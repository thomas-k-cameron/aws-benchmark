...
impl CancelBundleTaskFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::cancel_bundle_task::builders::CancelBundleTaskInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.cancel_bundle_task().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::cancel_bundle_task::builders::CancelBundleTaskInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
