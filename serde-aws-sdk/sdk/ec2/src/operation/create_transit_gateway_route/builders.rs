...
impl CreateTransitGatewayRouteFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_transit_gateway_route::builders::CreateTransitGatewayRouteInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_transit_gateway_route().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_transit_gateway_route::builders::CreateTransitGatewayRouteInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
