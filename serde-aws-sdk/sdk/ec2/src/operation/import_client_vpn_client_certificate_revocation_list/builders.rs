...
impl ImportClientVpnClientCertificateRevocationListFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::import_client_vpn_client_certificate_revocation_list::builders::ImportClientVpnClientCertificateRevocationListInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.import_client_vpn_client_certificate_revocation_list().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::import_client_vpn_client_certificate_revocation_list::builders::ImportClientVpnClientCertificateRevocationListInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
