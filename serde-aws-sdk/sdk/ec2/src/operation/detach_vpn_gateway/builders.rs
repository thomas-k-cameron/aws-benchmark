...
impl DetachVpnGatewayFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::detach_vpn_gateway::builders::DetachVpnGatewayInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.detach_vpn_gateway().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::detach_vpn_gateway::builders::DetachVpnGatewayInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
