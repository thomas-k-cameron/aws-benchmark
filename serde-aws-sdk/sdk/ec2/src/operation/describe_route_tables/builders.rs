...
impl DescribeRouteTablesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_route_tables::builders::DescribeRouteTablesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_route_tables().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_route_tables::builders::DescribeRouteTablesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
