...
impl ConfirmProductInstanceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::confirm_product_instance::builders::ConfirmProductInstanceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.confirm_product_instance().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::confirm_product_instance::builders::ConfirmProductInstanceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
