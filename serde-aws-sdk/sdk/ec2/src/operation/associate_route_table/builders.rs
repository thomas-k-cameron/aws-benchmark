...
impl AssociateRouteTableFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::associate_route_table::builders::AssociateRouteTableInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.associate_route_table().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::associate_route_table::builders::AssociateRouteTableInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
