...
impl DescribeReservedInstancesOfferingsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_reserved_instances_offerings::builders::DescribeReservedInstancesOfferingsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_reserved_instances_offerings().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_reserved_instances_offerings::builders::DescribeReservedInstancesOfferingsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
