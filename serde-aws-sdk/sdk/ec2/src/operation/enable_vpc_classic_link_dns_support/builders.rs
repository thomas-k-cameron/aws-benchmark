...
impl EnableVpcClassicLinkDnsSupportFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::enable_vpc_classic_link_dns_support::builders::EnableVpcClassicLinkDnsSupportInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.enable_vpc_classic_link_dns_support().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::enable_vpc_classic_link_dns_support::builders::EnableVpcClassicLinkDnsSupportInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
