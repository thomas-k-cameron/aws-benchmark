...
impl ReportInstanceStatusFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::report_instance_status::builders::ReportInstanceStatusInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.report_instance_status().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::report_instance_status::builders::ReportInstanceStatusInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
