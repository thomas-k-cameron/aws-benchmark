...
impl ResetSnapshotAttributeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::reset_snapshot_attribute::builders::ResetSnapshotAttributeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.reset_snapshot_attribute().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::reset_snapshot_attribute::builders::ResetSnapshotAttributeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
