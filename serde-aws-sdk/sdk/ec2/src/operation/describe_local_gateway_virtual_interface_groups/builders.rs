...
impl DescribeLocalGatewayVirtualInterfaceGroupsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_local_gateway_virtual_interface_groups::builders::DescribeLocalGatewayVirtualInterfaceGroupsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_local_gateway_virtual_interface_groups().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_local_gateway_virtual_interface_groups::builders::DescribeLocalGatewayVirtualInterfaceGroupsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
