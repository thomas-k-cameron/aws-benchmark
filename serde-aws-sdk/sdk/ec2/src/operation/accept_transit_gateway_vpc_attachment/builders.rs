...
impl AcceptTransitGatewayVpcAttachmentFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::accept_transit_gateway_vpc_attachment::builders::AcceptTransitGatewayVpcAttachmentInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.accept_transit_gateway_vpc_attachment().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::accept_transit_gateway_vpc_attachment::builders::AcceptTransitGatewayVpcAttachmentInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
