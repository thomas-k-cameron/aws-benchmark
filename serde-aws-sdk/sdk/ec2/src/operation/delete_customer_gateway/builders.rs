...
impl DeleteCustomerGatewayFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_customer_gateway::builders::DeleteCustomerGatewayInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_customer_gateway().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_customer_gateway::builders::DeleteCustomerGatewayInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
