...
impl DescribeSpotFleetInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_spot_fleet_instances::builders::DescribeSpotFleetInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_spot_fleet_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_spot_fleet_instances::builders::DescribeSpotFleetInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
