...
impl DescribeRegionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_regions::builders::DescribeRegionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_regions().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_regions::builders::DescribeRegionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
