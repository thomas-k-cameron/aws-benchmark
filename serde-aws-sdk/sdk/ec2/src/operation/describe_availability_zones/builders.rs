...
impl DescribeAvailabilityZonesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_availability_zones::builders::DescribeAvailabilityZonesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_availability_zones().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_availability_zones::builders::DescribeAvailabilityZonesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
