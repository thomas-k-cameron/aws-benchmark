...
impl DeleteInternetGatewayFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_internet_gateway::builders::DeleteInternetGatewayInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_internet_gateway().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_internet_gateway::builders::DeleteInternetGatewayInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
