...
impl AssociateVpcCidrBlockFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::associate_vpc_cidr_block::builders::AssociateVpcCidrBlockInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.associate_vpc_cidr_block().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::associate_vpc_cidr_block::builders::AssociateVpcCidrBlockInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
