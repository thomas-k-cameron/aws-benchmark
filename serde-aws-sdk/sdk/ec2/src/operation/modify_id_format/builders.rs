...
impl ModifyIdFormatFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_id_format::builders::ModifyIdFormatInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_id_format().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_id_format::builders::ModifyIdFormatInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
