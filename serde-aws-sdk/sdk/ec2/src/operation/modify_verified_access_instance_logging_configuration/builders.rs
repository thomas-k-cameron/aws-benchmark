...
impl ModifyVerifiedAccessInstanceLoggingConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_verified_access_instance_logging_configuration::builders::ModifyVerifiedAccessInstanceLoggingConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_verified_access_instance_logging_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_verified_access_instance_logging_configuration::builders::ModifyVerifiedAccessInstanceLoggingConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
