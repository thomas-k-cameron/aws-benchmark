...
impl DescribeReservedInstancesModificationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_reserved_instances_modifications::builders::DescribeReservedInstancesModificationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_reserved_instances_modifications().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_reserved_instances_modifications::builders::DescribeReservedInstancesModificationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
