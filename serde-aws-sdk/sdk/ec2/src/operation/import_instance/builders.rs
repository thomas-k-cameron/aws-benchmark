...
impl ImportInstanceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::import_instance::builders::ImportInstanceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.import_instance().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::import_instance::builders::ImportInstanceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
