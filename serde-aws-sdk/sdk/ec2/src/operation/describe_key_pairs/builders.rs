...
impl DescribeKeyPairsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_key_pairs::builders::DescribeKeyPairsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_key_pairs().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_key_pairs::builders::DescribeKeyPairsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
