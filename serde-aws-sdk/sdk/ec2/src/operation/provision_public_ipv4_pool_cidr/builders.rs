...
impl ProvisionPublicIpv4PoolCidrFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::provision_public_ipv4_pool_cidr::builders::ProvisionPublicIpv4PoolCidrInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.provision_public_ipv4_pool_cidr().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::provision_public_ipv4_pool_cidr::builders::ProvisionPublicIpv4PoolCidrInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
