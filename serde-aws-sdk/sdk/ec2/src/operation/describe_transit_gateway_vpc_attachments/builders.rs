...
impl DescribeTransitGatewayVpcAttachmentsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_transit_gateway_vpc_attachments::builders::DescribeTransitGatewayVpcAttachmentsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_transit_gateway_vpc_attachments().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_transit_gateway_vpc_attachments::builders::DescribeTransitGatewayVpcAttachmentsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
