...
impl ReplaceIamInstanceProfileAssociationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::replace_iam_instance_profile_association::builders::ReplaceIamInstanceProfileAssociationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.replace_iam_instance_profile_association().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::replace_iam_instance_profile_association::builders::ReplaceIamInstanceProfileAssociationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
