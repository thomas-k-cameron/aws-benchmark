...
impl CreateIpamFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_ipam::builders::CreateIpamInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_ipam().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_ipam::builders::CreateIpamInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
