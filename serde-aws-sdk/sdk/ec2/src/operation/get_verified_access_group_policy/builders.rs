...
impl GetVerifiedAccessGroupPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_verified_access_group_policy::builders::GetVerifiedAccessGroupPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_verified_access_group_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_verified_access_group_policy::builders::GetVerifiedAccessGroupPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
