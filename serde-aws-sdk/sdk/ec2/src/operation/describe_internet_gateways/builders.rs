...
impl DescribeInternetGatewaysFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_internet_gateways::builders::DescribeInternetGatewaysInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_internet_gateways().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_internet_gateways::builders::DescribeInternetGatewaysInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
