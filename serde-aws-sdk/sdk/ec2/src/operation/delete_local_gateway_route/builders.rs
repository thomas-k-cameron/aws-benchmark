...
impl DeleteLocalGatewayRouteFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_local_gateway_route::builders::DeleteLocalGatewayRouteInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_local_gateway_route().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_local_gateway_route::builders::DeleteLocalGatewayRouteInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
