...
impl CreateEgressOnlyInternetGatewayFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_egress_only_internet_gateway::builders::CreateEgressOnlyInternetGatewayInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_egress_only_internet_gateway().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_egress_only_internet_gateway::builders::CreateEgressOnlyInternetGatewayInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
