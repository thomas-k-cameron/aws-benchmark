...
impl ModifyVpcEndpointFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_vpc_endpoint::builders::ModifyVpcEndpointInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_vpc_endpoint().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_vpc_endpoint::builders::ModifyVpcEndpointInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
