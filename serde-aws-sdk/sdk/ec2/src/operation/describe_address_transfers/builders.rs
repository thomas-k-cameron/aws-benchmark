...
impl DescribeAddressTransfersFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_address_transfers::builders::DescribeAddressTransfersInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_address_transfers().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_address_transfers::builders::DescribeAddressTransfersInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
