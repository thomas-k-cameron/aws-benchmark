...
impl CancelSpotInstanceRequestsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::cancel_spot_instance_requests::builders::CancelSpotInstanceRequestsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.cancel_spot_instance_requests().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::cancel_spot_instance_requests::builders::CancelSpotInstanceRequestsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
