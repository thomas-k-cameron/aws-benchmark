...
impl DeleteTrafficMirrorTargetFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_traffic_mirror_target::builders::DeleteTrafficMirrorTargetInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_traffic_mirror_target().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_traffic_mirror_target::builders::DeleteTrafficMirrorTargetInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
