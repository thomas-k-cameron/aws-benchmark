...
impl CreateVpnConnectionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_vpn_connection::builders::CreateVpnConnectionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_vpn_connection().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_vpn_connection::builders::CreateVpnConnectionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
