...
impl DescribeHostReservationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_host_reservations::builders::DescribeHostReservationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_host_reservations().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_host_reservations::builders::DescribeHostReservationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
