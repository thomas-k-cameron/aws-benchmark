...
impl CreateVpcEndpointFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_vpc_endpoint::builders::CreateVpcEndpointInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_vpc_endpoint().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_vpc_endpoint::builders::CreateVpcEndpointInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
