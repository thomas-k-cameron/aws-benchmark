...
impl DescribeHostReservationOfferingsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_host_reservation_offerings::builders::DescribeHostReservationOfferingsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_host_reservation_offerings().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_host_reservation_offerings::builders::DescribeHostReservationOfferingsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
