...
impl ModifyVpcEndpointConnectionNotificationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_vpc_endpoint_connection_notification::builders::ModifyVpcEndpointConnectionNotificationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_vpc_endpoint_connection_notification().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_vpc_endpoint_connection_notification::builders::ModifyVpcEndpointConnectionNotificationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
