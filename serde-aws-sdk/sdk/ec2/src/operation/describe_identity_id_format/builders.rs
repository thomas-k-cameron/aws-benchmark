...
impl DescribeIdentityIdFormatFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_identity_id_format::builders::DescribeIdentityIdFormatInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_identity_id_format().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_identity_id_format::builders::DescribeIdentityIdFormatInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
