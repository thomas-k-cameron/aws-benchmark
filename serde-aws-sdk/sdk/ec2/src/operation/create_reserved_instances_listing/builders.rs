...
impl CreateReservedInstancesListingFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_reserved_instances_listing::builders::CreateReservedInstancesListingInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_reserved_instances_listing().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_reserved_instances_listing::builders::CreateReservedInstancesListingInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
