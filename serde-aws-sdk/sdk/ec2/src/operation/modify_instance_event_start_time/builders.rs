...
impl ModifyInstanceEventStartTimeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_instance_event_start_time::builders::ModifyInstanceEventStartTimeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_instance_event_start_time().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_instance_event_start_time::builders::ModifyInstanceEventStartTimeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
