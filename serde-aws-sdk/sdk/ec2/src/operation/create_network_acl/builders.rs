...
impl CreateNetworkAclFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_network_acl::builders::CreateNetworkAclInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_network_acl().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_network_acl::builders::CreateNetworkAclInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
