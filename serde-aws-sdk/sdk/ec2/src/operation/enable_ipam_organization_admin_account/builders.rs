...
impl EnableIpamOrganizationAdminAccountFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::enable_ipam_organization_admin_account::builders::EnableIpamOrganizationAdminAccountInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.enable_ipam_organization_admin_account().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::enable_ipam_organization_admin_account::builders::EnableIpamOrganizationAdminAccountInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
