...
impl DeleteVpcFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_vpc::builders::DeleteVpcInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_vpc().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_vpc::builders::DeleteVpcInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
