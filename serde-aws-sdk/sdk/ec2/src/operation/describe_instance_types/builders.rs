...
impl DescribeInstanceTypesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_instance_types::builders::DescribeInstanceTypesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_instance_types().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_instance_types::builders::DescribeInstanceTypesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
