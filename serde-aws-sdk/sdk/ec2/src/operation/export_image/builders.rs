...
impl ExportImageFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::export_image::builders::ExportImageInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.export_image().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::export_image::builders::ExportImageInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
