...
impl AssignIpv6AddressesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::assign_ipv6_addresses::builders::AssignIpv6AddressesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.assign_ipv6_addresses().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::assign_ipv6_addresses::builders::AssignIpv6AddressesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
