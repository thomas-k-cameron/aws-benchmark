...
impl DescribeNetworkInterfacesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_network_interfaces::builders::DescribeNetworkInterfacesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_network_interfaces().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_network_interfaces::builders::DescribeNetworkInterfacesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
