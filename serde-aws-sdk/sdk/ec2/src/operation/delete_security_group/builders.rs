...
impl DeleteSecurityGroupFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_security_group::builders::DeleteSecurityGroupInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_security_group().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_security_group::builders::DeleteSecurityGroupInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
