...
impl CreateTrafficMirrorFilterRuleFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_traffic_mirror_filter_rule::builders::CreateTrafficMirrorFilterRuleInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_traffic_mirror_filter_rule().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_traffic_mirror_filter_rule::builders::CreateTrafficMirrorFilterRuleInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
