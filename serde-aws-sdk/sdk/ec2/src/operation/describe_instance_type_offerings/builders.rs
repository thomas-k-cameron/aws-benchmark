...
impl DescribeInstanceTypeOfferingsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_instance_type_offerings::builders::DescribeInstanceTypeOfferingsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_instance_type_offerings().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_instance_type_offerings::builders::DescribeInstanceTypeOfferingsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
