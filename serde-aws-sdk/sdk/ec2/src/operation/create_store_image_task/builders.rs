...
impl CreateStoreImageTaskFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_store_image_task::builders::CreateStoreImageTaskInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_store_image_task().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_store_image_task::builders::CreateStoreImageTaskInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
