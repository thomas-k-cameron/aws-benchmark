...
impl AttachVpnGatewayFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::attach_vpn_gateway::builders::AttachVpnGatewayInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.attach_vpn_gateway().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::attach_vpn_gateway::builders::AttachVpnGatewayInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
