...
impl DisassociateIpamResourceDiscoveryFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::disassociate_ipam_resource_discovery::builders::DisassociateIpamResourceDiscoveryInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.disassociate_ipam_resource_discovery().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::disassociate_ipam_resource_discovery::builders::DisassociateIpamResourceDiscoveryInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
    ...
    pub fn ipam_resource_discovery_association_id(
        ...
        self.inner = self
            .inner
            .ipam_resource_discovery_association_id(input.into());
        self
    }
    /// <p>A resource discovery association ID.</p>
