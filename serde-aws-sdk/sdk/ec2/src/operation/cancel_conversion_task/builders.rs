...
impl CancelConversionTaskFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::cancel_conversion_task::builders::CancelConversionTaskInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.cancel_conversion_task().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::cancel_conversion_task::builders::CancelConversionTaskInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
