...
impl DescribePrincipalIdFormatFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_principal_id_format::builders::DescribePrincipalIdFormatInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_principal_id_format().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_principal_id_format::builders::DescribePrincipalIdFormatInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
