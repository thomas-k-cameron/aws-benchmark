...
impl DescribeMovingAddressesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_moving_addresses::builders::DescribeMovingAddressesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_moving_addresses().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_moving_addresses::builders::DescribeMovingAddressesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
