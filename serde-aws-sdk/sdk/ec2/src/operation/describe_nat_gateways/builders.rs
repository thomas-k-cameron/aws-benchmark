...
impl DescribeNatGatewaysFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_nat_gateways::builders::DescribeNatGatewaysInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_nat_gateways().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_nat_gateways::builders::DescribeNatGatewaysInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
