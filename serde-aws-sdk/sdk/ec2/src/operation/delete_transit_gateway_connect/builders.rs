...
impl DeleteTransitGatewayConnectFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_transit_gateway_connect::builders::DeleteTransitGatewayConnectInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_transit_gateway_connect().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_transit_gateway_connect::builders::DeleteTransitGatewayConnectInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
