...
impl DeletePublicIpv4PoolFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_public_ipv4_pool::builders::DeletePublicIpv4PoolInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_public_ipv4_pool().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_public_ipv4_pool::builders::DeletePublicIpv4PoolInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
