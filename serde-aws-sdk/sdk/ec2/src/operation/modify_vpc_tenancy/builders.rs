...
impl ModifyVpcTenancyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_vpc_tenancy::builders::ModifyVpcTenancyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_vpc_tenancy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_vpc_tenancy::builders::ModifyVpcTenancyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
