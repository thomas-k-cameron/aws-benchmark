...
impl CreateLaunchTemplateFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_launch_template::builders::CreateLaunchTemplateInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_launch_template().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_launch_template::builders::CreateLaunchTemplateInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
