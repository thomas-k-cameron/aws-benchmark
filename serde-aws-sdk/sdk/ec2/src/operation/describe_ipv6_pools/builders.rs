...
impl DescribeIpv6PoolsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_ipv6_pools::builders::DescribeIpv6PoolsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_ipv6_pools().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_ipv6_pools::builders::DescribeIpv6PoolsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
