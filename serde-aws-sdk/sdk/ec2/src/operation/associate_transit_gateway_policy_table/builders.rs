...
impl AssociateTransitGatewayPolicyTableFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::associate_transit_gateway_policy_table::builders::AssociateTransitGatewayPolicyTableInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.associate_transit_gateway_policy_table().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::associate_transit_gateway_policy_table::builders::AssociateTransitGatewayPolicyTableInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
