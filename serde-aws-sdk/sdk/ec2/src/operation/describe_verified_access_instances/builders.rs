...
impl DescribeVerifiedAccessInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_verified_access_instances::builders::DescribeVerifiedAccessInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_verified_access_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_verified_access_instances::builders::DescribeVerifiedAccessInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
