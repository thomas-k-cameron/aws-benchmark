...
impl AuthorizeClientVpnIngressFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::authorize_client_vpn_ingress::builders::AuthorizeClientVpnIngressInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.authorize_client_vpn_ingress().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::authorize_client_vpn_ingress::builders::AuthorizeClientVpnIngressInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
