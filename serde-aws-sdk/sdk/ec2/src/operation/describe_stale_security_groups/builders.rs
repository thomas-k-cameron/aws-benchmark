...
impl DescribeStaleSecurityGroupsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_stale_security_groups::builders::DescribeStaleSecurityGroupsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_stale_security_groups().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_stale_security_groups::builders::DescribeStaleSecurityGroupsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
