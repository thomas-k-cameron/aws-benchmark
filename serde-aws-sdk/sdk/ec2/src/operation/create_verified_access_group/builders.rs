...
impl CreateVerifiedAccessGroupFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_verified_access_group::builders::CreateVerifiedAccessGroupInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_verified_access_group().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_verified_access_group::builders::CreateVerifiedAccessGroupInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
