...
impl DescribeNetworkAclsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_network_acls::builders::DescribeNetworkAclsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_network_acls().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_network_acls::builders::DescribeNetworkAclsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
