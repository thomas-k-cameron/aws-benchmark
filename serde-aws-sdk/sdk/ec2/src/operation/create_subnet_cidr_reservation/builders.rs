...
impl CreateSubnetCidrReservationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_subnet_cidr_reservation::builders::CreateSubnetCidrReservationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_subnet_cidr_reservation().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_subnet_cidr_reservation::builders::CreateSubnetCidrReservationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
