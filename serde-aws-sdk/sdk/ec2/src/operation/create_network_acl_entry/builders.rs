...
impl CreateNetworkAclEntryFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_network_acl_entry::builders::CreateNetworkAclEntryInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_network_acl_entry().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_network_acl_entry::builders::CreateNetworkAclEntryInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
