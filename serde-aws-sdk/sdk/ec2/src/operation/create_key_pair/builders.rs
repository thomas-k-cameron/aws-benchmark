...
impl CreateKeyPairFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_key_pair::builders::CreateKeyPairInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_key_pair().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_key_pair::builders::CreateKeyPairInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
