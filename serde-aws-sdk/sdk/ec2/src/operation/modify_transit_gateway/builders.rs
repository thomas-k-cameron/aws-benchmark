...
impl ModifyTransitGatewayFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_transit_gateway::builders::ModifyTransitGatewayInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_transit_gateway().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_transit_gateway::builders::ModifyTransitGatewayInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
