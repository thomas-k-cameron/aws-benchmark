...
impl ModifyInstanceEventWindowFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_instance_event_window::builders::ModifyInstanceEventWindowInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_instance_event_window().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_instance_event_window::builders::ModifyInstanceEventWindowInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
