...
impl DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_local_gateway_route_table_virtual_interface_group_association::builders::DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_local_gateway_route_table_virtual_interface_group_association().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_local_gateway_route_table_virtual_interface_group_association::builders::DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
