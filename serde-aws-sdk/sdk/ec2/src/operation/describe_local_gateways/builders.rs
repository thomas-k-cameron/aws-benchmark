...
impl DescribeLocalGatewaysFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_local_gateways::builders::DescribeLocalGatewaysInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_local_gateways().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_local_gateways::builders::DescribeLocalGatewaysInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
