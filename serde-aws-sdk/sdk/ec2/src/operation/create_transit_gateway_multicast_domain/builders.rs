...
impl CreateTransitGatewayMulticastDomainFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_transit_gateway_multicast_domain::builders::CreateTransitGatewayMulticastDomainInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_transit_gateway_multicast_domain().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_transit_gateway_multicast_domain::builders::CreateTransitGatewayMulticastDomainInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
