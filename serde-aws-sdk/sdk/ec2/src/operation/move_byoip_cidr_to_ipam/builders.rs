...
impl MoveByoipCidrToIpamFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::move_byoip_cidr_to_ipam::builders::MoveByoipCidrToIpamInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.move_byoip_cidr_to_ipam().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::move_byoip_cidr_to_ipam::builders::MoveByoipCidrToIpamInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
