...
impl AdvertiseByoipCidrFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::advertise_byoip_cidr::builders::AdvertiseByoipCidrInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.advertise_byoip_cidr().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::advertise_byoip_cidr::builders::AdvertiseByoipCidrInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
