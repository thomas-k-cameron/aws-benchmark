...
impl ResetAddressAttributeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::reset_address_attribute::builders::ResetAddressAttributeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.reset_address_attribute().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::reset_address_attribute::builders::ResetAddressAttributeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
