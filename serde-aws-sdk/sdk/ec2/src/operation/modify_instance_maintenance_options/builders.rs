...
impl ModifyInstanceMaintenanceOptionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_instance_maintenance_options::builders::ModifyInstanceMaintenanceOptionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_instance_maintenance_options().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_instance_maintenance_options::builders::ModifyInstanceMaintenanceOptionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
