...
impl DeleteClientVpnEndpointFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_client_vpn_endpoint::builders::DeleteClientVpnEndpointInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_client_vpn_endpoint().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_client_vpn_endpoint::builders::DeleteClientVpnEndpointInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
