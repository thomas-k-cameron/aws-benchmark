...
impl DescribeVpcEndpointServiceConfigurationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_vpc_endpoint_service_configurations::builders::DescribeVpcEndpointServiceConfigurationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_vpc_endpoint_service_configurations().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_vpc_endpoint_service_configurations::builders::DescribeVpcEndpointServiceConfigurationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
