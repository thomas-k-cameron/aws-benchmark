...
impl DescribeClientVpnRoutesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_client_vpn_routes::builders::DescribeClientVpnRoutesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_client_vpn_routes().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_client_vpn_routes::builders::DescribeClientVpnRoutesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
