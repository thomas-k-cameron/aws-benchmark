...
impl DescribeFleetsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_fleets::builders::DescribeFleetsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_fleets().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_fleets::builders::DescribeFleetsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
