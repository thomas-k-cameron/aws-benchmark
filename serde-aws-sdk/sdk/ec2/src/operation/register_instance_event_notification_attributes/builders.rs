...
impl RegisterInstanceEventNotificationAttributesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::register_instance_event_notification_attributes::builders::RegisterInstanceEventNotificationAttributesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.register_instance_event_notification_attributes().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::register_instance_event_notification_attributes::builders::RegisterInstanceEventNotificationAttributesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
