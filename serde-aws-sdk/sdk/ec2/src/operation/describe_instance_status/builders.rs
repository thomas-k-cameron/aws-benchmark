...
impl DescribeInstanceStatusFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_instance_status::builders::DescribeInstanceStatusInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_instance_status().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_instance_status::builders::DescribeInstanceStatusInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
