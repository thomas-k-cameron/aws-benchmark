...
impl RestoreSnapshotFromRecycleBinFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::restore_snapshot_from_recycle_bin::builders::RestoreSnapshotFromRecycleBinInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.restore_snapshot_from_recycle_bin().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::restore_snapshot_from_recycle_bin::builders::RestoreSnapshotFromRecycleBinInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
