...
impl CreateInternetGatewayFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_internet_gateway::builders::CreateInternetGatewayInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_internet_gateway().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_internet_gateway::builders::CreateInternetGatewayInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
