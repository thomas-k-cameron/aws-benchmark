...
impl DescribeManagedPrefixListsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_managed_prefix_lists::builders::DescribeManagedPrefixListsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_managed_prefix_lists().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_managed_prefix_lists::builders::DescribeManagedPrefixListsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
