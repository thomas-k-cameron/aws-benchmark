...
impl AttachVolumeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::attach_volume::builders::AttachVolumeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.attach_volume().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::attach_volume::builders::AttachVolumeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
