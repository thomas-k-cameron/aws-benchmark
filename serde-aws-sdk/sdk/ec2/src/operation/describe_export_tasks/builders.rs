...
impl DescribeExportTasksFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_export_tasks::builders::DescribeExportTasksInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_export_tasks().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_export_tasks::builders::DescribeExportTasksInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
