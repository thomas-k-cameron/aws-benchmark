...
impl ModifySnapshotAttributeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_snapshot_attribute::builders::ModifySnapshotAttributeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_snapshot_attribute().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_snapshot_attribute::builders::ModifySnapshotAttributeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
