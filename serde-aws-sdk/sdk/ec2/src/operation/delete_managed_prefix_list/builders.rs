...
impl DeleteManagedPrefixListFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_managed_prefix_list::builders::DeleteManagedPrefixListInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_managed_prefix_list().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_managed_prefix_list::builders::DeleteManagedPrefixListInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
