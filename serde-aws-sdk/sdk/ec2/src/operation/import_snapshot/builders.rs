...
impl ImportSnapshotFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::import_snapshot::builders::ImportSnapshotInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.import_snapshot().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::import_snapshot::builders::ImportSnapshotInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
