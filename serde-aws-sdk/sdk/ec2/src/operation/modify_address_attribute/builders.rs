...
impl ModifyAddressAttributeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_address_attribute::builders::ModifyAddressAttributeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_address_attribute().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_address_attribute::builders::ModifyAddressAttributeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
