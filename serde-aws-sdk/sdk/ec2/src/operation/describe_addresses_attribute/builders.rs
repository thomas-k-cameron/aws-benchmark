...
impl DescribeAddressesAttributeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_addresses_attribute::builders::DescribeAddressesAttributeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_addresses_attribute().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_addresses_attribute::builders::DescribeAddressesAttributeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
