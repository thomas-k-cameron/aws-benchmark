...
impl RestoreAddressToClassicFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::restore_address_to_classic::builders::RestoreAddressToClassicInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.restore_address_to_classic().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::restore_address_to_classic::builders::RestoreAddressToClassicInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
