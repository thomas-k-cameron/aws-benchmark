...
impl DeleteVpnGatewayFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_vpn_gateway::builders::DeleteVpnGatewayInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_vpn_gateway().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_vpn_gateway::builders::DeleteVpnGatewayInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
