...
impl RestoreSnapshotTierFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::restore_snapshot_tier::builders::RestoreSnapshotTierInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.restore_snapshot_tier().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::restore_snapshot_tier::builders::RestoreSnapshotTierInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
