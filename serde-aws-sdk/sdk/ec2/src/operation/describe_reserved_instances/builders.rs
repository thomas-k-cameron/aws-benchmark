...
impl DescribeReservedInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_reserved_instances::builders::DescribeReservedInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_reserved_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_reserved_instances::builders::DescribeReservedInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
