...
impl DisableAwsNetworkPerformanceMetricSubscriptionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::disable_aws_network_performance_metric_subscription::builders::DisableAwsNetworkPerformanceMetricSubscriptionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.disable_aws_network_performance_metric_subscription().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::disable_aws_network_performance_metric_subscription::builders::DisableAwsNetworkPerformanceMetricSubscriptionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
