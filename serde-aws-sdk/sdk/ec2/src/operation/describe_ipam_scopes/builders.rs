...
impl DescribeIpamScopesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_ipam_scopes::builders::DescribeIpamScopesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_ipam_scopes().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_ipam_scopes::builders::DescribeIpamScopesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
