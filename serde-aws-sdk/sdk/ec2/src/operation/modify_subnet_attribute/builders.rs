...
impl ModifySubnetAttributeFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::CustomizableOperation<
            crate::operation::modify_subnet_attribute::ModifySubnetAttribute,
    ...
    ///     let deserialized_parameters: crate::operation::modify_subnet_attribute::builders::ModifySubnetAttributeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_subnet_attribute().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_subnet_attribute::builders::ModifySubnetAttributeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
