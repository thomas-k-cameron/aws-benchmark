...
impl DisassociateAddressFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::disassociate_address::builders::DisassociateAddressInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.disassociate_address().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::disassociate_address::builders::DisassociateAddressInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
