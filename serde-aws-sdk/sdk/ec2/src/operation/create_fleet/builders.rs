...
impl CreateFleetFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_fleet::builders::CreateFleetInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_fleet().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_fleet::builders::CreateFleetInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
