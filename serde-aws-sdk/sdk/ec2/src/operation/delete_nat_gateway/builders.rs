...
impl DeleteNatGatewayFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_nat_gateway::builders::DeleteNatGatewayInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_nat_gateway().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_nat_gateway::builders::DeleteNatGatewayInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
