...
impl ModifyIpamFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_ipam::builders::ModifyIpamInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_ipam().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_ipam::builders::ModifyIpamInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
