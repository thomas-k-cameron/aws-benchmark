...
impl ModifyVerifiedAccessEndpointFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_verified_access_endpoint::builders::ModifyVerifiedAccessEndpointInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_verified_access_endpoint().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_verified_access_endpoint::builders::ModifyVerifiedAccessEndpointInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
