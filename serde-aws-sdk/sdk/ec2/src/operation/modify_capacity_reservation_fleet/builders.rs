...
impl ModifyCapacityReservationFleetFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_capacity_reservation_fleet::builders::ModifyCapacityReservationFleetInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_capacity_reservation_fleet().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_capacity_reservation_fleet::builders::ModifyCapacityReservationFleetInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
