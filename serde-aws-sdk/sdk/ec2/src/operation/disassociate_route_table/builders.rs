...
impl DisassociateRouteTableFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::disassociate_route_table::builders::DisassociateRouteTableInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.disassociate_route_table().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::disassociate_route_table::builders::DisassociateRouteTableInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
