...
impl DescribeSnapshotTierStatusFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_snapshot_tier_status::builders::DescribeSnapshotTierStatusInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_snapshot_tier_status().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_snapshot_tier_status::builders::DescribeSnapshotTierStatusInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
