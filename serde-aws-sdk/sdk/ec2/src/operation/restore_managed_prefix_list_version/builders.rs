...
impl RestoreManagedPrefixListVersionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::restore_managed_prefix_list_version::builders::RestoreManagedPrefixListVersionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.restore_managed_prefix_list_version().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::restore_managed_prefix_list_version::builders::RestoreManagedPrefixListVersionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
