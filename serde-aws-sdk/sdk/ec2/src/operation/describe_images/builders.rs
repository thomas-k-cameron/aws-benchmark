...
impl DescribeImagesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_images::builders::DescribeImagesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_images().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_images::builders::DescribeImagesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
