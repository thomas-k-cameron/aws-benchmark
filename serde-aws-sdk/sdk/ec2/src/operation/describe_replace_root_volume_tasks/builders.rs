...
impl DescribeReplaceRootVolumeTasksFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_replace_root_volume_tasks::builders::DescribeReplaceRootVolumeTasksInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_replace_root_volume_tasks().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_replace_root_volume_tasks::builders::DescribeReplaceRootVolumeTasksInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
