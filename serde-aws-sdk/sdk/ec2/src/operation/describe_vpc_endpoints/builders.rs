...
impl DescribeVpcEndpointsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_vpc_endpoints::builders::DescribeVpcEndpointsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_vpc_endpoints().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_vpc_endpoints::builders::DescribeVpcEndpointsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
