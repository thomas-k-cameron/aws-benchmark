...
impl UnassignPrivateIpAddressesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::unassign_private_ip_addresses::builders::UnassignPrivateIpAddressesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.unassign_private_ip_addresses().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::unassign_private_ip_addresses::builders::UnassignPrivateIpAddressesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
