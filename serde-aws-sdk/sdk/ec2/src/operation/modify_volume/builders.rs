...
impl ModifyVolumeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_volume::builders::ModifyVolumeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_volume().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_volume::builders::ModifyVolumeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
