...
impl DeleteTrafficMirrorFilterRuleFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_traffic_mirror_filter_rule::builders::DeleteTrafficMirrorFilterRuleInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_traffic_mirror_filter_rule().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_traffic_mirror_filter_rule::builders::DeleteTrafficMirrorFilterRuleInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
