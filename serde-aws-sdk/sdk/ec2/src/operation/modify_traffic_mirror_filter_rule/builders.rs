...
impl ModifyTrafficMirrorFilterRuleFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_traffic_mirror_filter_rule::builders::ModifyTrafficMirrorFilterRuleInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_traffic_mirror_filter_rule().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_traffic_mirror_filter_rule::builders::ModifyTrafficMirrorFilterRuleInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
