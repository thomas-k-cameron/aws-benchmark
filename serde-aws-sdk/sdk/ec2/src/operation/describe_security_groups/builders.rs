...
impl DescribeSecurityGroupsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_security_groups::builders::DescribeSecurityGroupsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_security_groups().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_security_groups::builders::DescribeSecurityGroupsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
