...
impl ModifyManagedPrefixListFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_managed_prefix_list::builders::ModifyManagedPrefixListInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_managed_prefix_list().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_managed_prefix_list::builders::ModifyManagedPrefixListInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
