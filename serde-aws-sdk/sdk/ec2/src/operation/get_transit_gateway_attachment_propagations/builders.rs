...
impl GetTransitGatewayAttachmentPropagationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_transit_gateway_attachment_propagations::builders::GetTransitGatewayAttachmentPropagationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_transit_gateway_attachment_propagations().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_transit_gateway_attachment_propagations::builders::GetTransitGatewayAttachmentPropagationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
