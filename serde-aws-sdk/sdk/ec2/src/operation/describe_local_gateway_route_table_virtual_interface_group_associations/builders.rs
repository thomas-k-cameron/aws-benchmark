...
impl DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_local_gateway_route_table_virtual_interface_group_associations::builders::DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_local_gateway_route_table_virtual_interface_group_associations().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_local_gateway_route_table_virtual_interface_group_associations::builders::DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
