...
impl ModifyIpamResourceCidrFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_ipam_resource_cidr::builders::ModifyIpamResourceCidrInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_ipam_resource_cidr().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_ipam_resource_cidr::builders::ModifyIpamResourceCidrInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
