...
impl DisassociateVpcCidrBlockFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::disassociate_vpc_cidr_block::builders::DisassociateVpcCidrBlockInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.disassociate_vpc_cidr_block().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::disassociate_vpc_cidr_block::builders::DisassociateVpcCidrBlockInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
