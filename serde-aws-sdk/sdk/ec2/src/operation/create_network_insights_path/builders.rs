...
impl CreateNetworkInsightsPathFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_network_insights_path::builders::CreateNetworkInsightsPathInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_network_insights_path().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_network_insights_path::builders::CreateNetworkInsightsPathInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
