...
impl DeleteKeyPairFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_key_pair::builders::DeleteKeyPairInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_key_pair().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_key_pair::builders::DeleteKeyPairInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
