...
impl CreateTransitGatewayPeeringAttachmentFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_transit_gateway_peering_attachment::builders::CreateTransitGatewayPeeringAttachmentInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_transit_gateway_peering_attachment().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_transit_gateway_peering_attachment::builders::CreateTransitGatewayPeeringAttachmentInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
