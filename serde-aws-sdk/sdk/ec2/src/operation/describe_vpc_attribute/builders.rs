...
impl DescribeVpcAttributeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_vpc_attribute::builders::DescribeVpcAttributeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_vpc_attribute().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_vpc_attribute::builders::DescribeVpcAttributeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
