...
impl DeleteIpamScopeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_ipam_scope::builders::DeleteIpamScopeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_ipam_scope().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_ipam_scope::builders::DeleteIpamScopeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
