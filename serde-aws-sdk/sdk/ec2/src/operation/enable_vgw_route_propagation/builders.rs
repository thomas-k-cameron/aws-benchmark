...
impl EnableVgwRoutePropagationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::enable_vgw_route_propagation::builders::EnableVgwRoutePropagationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.enable_vgw_route_propagation().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::enable_vgw_route_propagation::builders::EnableVgwRoutePropagationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
