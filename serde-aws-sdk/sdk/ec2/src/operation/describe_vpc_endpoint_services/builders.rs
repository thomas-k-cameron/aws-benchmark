...
impl DescribeVpcEndpointServicesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_vpc_endpoint_services::builders::DescribeVpcEndpointServicesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_vpc_endpoint_services().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_vpc_endpoint_services::builders::DescribeVpcEndpointServicesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
