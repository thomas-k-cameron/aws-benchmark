...
impl DescribeCoipPoolsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_coip_pools::builders::DescribeCoipPoolsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_coip_pools().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_coip_pools::builders::DescribeCoipPoolsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
