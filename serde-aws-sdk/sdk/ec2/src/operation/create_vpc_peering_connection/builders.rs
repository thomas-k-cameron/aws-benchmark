...
impl CreateVpcPeeringConnectionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_vpc_peering_connection::builders::CreateVpcPeeringConnectionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_vpc_peering_connection().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_vpc_peering_connection::builders::CreateVpcPeeringConnectionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
