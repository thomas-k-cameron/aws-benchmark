...
impl DeregisterTransitGatewayMulticastGroupSourcesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::deregister_transit_gateway_multicast_group_sources::builders::DeregisterTransitGatewayMulticastGroupSourcesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.deregister_transit_gateway_multicast_group_sources().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::deregister_transit_gateway_multicast_group_sources::builders::DeregisterTransitGatewayMulticastGroupSourcesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
