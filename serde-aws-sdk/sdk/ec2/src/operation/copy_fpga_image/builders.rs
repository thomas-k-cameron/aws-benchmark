...
impl CopyFpgaImageFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::copy_fpga_image::builders::CopyFpgaImageInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.copy_fpga_image().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::copy_fpga_image::builders::CopyFpgaImageInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
