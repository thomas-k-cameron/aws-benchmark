...
impl UpdateSecurityGroupRuleDescriptionsEgressFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_security_group_rule_descriptions_egress::builders::UpdateSecurityGroupRuleDescriptionsEgressInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_security_group_rule_descriptions_egress().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_security_group_rule_descriptions_egress::builders::UpdateSecurityGroupRuleDescriptionsEgressInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
