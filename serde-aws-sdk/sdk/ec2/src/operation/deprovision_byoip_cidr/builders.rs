...
impl DeprovisionByoipCidrFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::deprovision_byoip_cidr::builders::DeprovisionByoipCidrInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.deprovision_byoip_cidr().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::deprovision_byoip_cidr::builders::DeprovisionByoipCidrInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
