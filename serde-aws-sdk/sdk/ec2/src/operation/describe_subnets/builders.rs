...
impl DescribeSubnetsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_subnets::builders::DescribeSubnetsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_subnets().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_subnets::builders::DescribeSubnetsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
