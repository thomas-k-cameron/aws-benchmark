...
impl DescribeScheduledInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_scheduled_instances::builders::DescribeScheduledInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_scheduled_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_scheduled_instances::builders::DescribeScheduledInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
