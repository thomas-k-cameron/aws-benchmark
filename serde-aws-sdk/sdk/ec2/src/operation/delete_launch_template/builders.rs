...
impl DeleteLaunchTemplateFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_launch_template::builders::DeleteLaunchTemplateInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_launch_template().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_launch_template::builders::DeleteLaunchTemplateInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
