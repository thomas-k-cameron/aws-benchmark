...
impl ModifyIpamPoolFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_ipam_pool::builders::ModifyIpamPoolInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_ipam_pool().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_ipam_pool::builders::ModifyIpamPoolInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
