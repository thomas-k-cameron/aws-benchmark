...
impl DisableVgwRoutePropagationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::disable_vgw_route_propagation::builders::DisableVgwRoutePropagationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.disable_vgw_route_propagation().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::disable_vgw_route_propagation::builders::DisableVgwRoutePropagationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
