...
impl DescribeSnapshotsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_snapshots::builders::DescribeSnapshotsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_snapshots().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_snapshots::builders::DescribeSnapshotsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
