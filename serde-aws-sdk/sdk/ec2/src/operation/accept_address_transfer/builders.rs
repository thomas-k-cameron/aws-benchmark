...
impl AcceptAddressTransferFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::accept_address_transfer::builders::AcceptAddressTransferInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.accept_address_transfer().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::accept_address_transfer::builders::AcceptAddressTransferInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
