...
impl ModifyVpnConnectionOptionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_vpn_connection_options::builders::ModifyVpnConnectionOptionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_vpn_connection_options().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_vpn_connection_options::builders::ModifyVpnConnectionOptionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
