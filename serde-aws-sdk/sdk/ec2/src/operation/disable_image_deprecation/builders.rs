...
impl DisableImageDeprecationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::disable_image_deprecation::builders::DisableImageDeprecationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.disable_image_deprecation().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::disable_image_deprecation::builders::DisableImageDeprecationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
