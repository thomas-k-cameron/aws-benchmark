...
impl DescribeTransitGatewayRouteTableAnnouncementsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_transit_gateway_route_table_announcements::builders::DescribeTransitGatewayRouteTableAnnouncementsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_transit_gateway_route_table_announcements().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_transit_gateway_route_table_announcements::builders::DescribeTransitGatewayRouteTableAnnouncementsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
