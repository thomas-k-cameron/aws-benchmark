...
impl ReplaceNetworkAclEntryFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::replace_network_acl_entry::builders::ReplaceNetworkAclEntryInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.replace_network_acl_entry().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::replace_network_acl_entry::builders::ReplaceNetworkAclEntryInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
