...
impl GetSerialConsoleAccessStatusFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_serial_console_access_status::builders::GetSerialConsoleAccessStatusInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_serial_console_access_status().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_serial_console_access_status::builders::GetSerialConsoleAccessStatusInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
