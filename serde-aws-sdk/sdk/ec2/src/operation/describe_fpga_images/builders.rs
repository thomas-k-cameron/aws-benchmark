...
impl DescribeFpgaImagesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_fpga_images::builders::DescribeFpgaImagesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_fpga_images().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_fpga_images::builders::DescribeFpgaImagesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
