...
impl AcceptReservedInstancesExchangeQuoteFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::accept_reserved_instances_exchange_quote::builders::AcceptReservedInstancesExchangeQuoteInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.accept_reserved_instances_exchange_quote().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::accept_reserved_instances_exchange_quote::builders::AcceptReservedInstancesExchangeQuoteInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
