...
impl DescribeLaunchTemplateVersionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_launch_template_versions::builders::DescribeLaunchTemplateVersionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_launch_template_versions().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_launch_template_versions::builders::DescribeLaunchTemplateVersionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
