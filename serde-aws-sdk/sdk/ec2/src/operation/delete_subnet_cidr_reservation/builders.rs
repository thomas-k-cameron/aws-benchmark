...
impl DeleteSubnetCidrReservationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_subnet_cidr_reservation::builders::DeleteSubnetCidrReservationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_subnet_cidr_reservation().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_subnet_cidr_reservation::builders::DeleteSubnetCidrReservationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
