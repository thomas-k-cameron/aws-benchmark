...
impl CreateTagsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_tags::builders::CreateTagsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_tags().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_tags::builders::CreateTagsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
