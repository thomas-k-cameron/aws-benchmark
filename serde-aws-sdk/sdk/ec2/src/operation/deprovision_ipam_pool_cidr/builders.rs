...
impl DeprovisionIpamPoolCidrFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::deprovision_ipam_pool_cidr::builders::DeprovisionIpamPoolCidrInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.deprovision_ipam_pool_cidr().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::deprovision_ipam_pool_cidr::builders::DeprovisionIpamPoolCidrInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
