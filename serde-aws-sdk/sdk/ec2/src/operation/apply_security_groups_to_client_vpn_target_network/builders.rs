...
impl ApplySecurityGroupsToClientVpnTargetNetworkFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::apply_security_groups_to_client_vpn_target_network::builders::ApplySecurityGroupsToClientVpnTargetNetworkInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.apply_security_groups_to_client_vpn_target_network().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::apply_security_groups_to_client_vpn_target_network::builders::ApplySecurityGroupsToClientVpnTargetNetworkInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
