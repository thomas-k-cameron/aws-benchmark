...
impl UpdateSecurityGroupRuleDescriptionsIngressFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_security_group_rule_descriptions_ingress::builders::UpdateSecurityGroupRuleDescriptionsIngressInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_security_group_rule_descriptions_ingress().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_security_group_rule_descriptions_ingress::builders::UpdateSecurityGroupRuleDescriptionsIngressInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
