...
impl DescribeNetworkInsightsAccessScopesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_network_insights_access_scopes::builders::DescribeNetworkInsightsAccessScopesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_network_insights_access_scopes().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_network_insights_access_scopes::builders::DescribeNetworkInsightsAccessScopesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
