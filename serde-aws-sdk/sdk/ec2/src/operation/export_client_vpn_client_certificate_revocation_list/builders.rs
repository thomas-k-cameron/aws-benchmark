...
impl ExportClientVpnClientCertificateRevocationListFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::export_client_vpn_client_certificate_revocation_list::builders::ExportClientVpnClientCertificateRevocationListInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.export_client_vpn_client_certificate_revocation_list().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::export_client_vpn_client_certificate_revocation_list::builders::ExportClientVpnClientCertificateRevocationListInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
