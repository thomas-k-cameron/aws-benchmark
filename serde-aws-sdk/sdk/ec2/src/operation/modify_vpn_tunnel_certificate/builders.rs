...
impl ModifyVpnTunnelCertificateFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_vpn_tunnel_certificate::builders::ModifyVpnTunnelCertificateInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_vpn_tunnel_certificate().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_vpn_tunnel_certificate::builders::ModifyVpnTunnelCertificateInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
