...
impl StopInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::stop_instances::builders::StopInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.stop_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::stop_instances::builders::StopInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
