...
impl DescribeInstanceCreditSpecificationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_instance_credit_specifications::builders::DescribeInstanceCreditSpecificationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_instance_credit_specifications().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_instance_credit_specifications::builders::DescribeInstanceCreditSpecificationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
