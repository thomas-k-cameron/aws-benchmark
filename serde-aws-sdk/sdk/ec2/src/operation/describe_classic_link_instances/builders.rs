...
impl DescribeClassicLinkInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_classic_link_instances::builders::DescribeClassicLinkInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_classic_link_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_classic_link_instances::builders::DescribeClassicLinkInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
