...
impl DescribeBundleTasksFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_bundle_tasks::builders::DescribeBundleTasksInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_bundle_tasks().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_bundle_tasks::builders::DescribeBundleTasksInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
