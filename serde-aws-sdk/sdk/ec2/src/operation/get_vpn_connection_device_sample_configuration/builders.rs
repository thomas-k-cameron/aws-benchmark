...
impl GetVpnConnectionDeviceSampleConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_vpn_connection_device_sample_configuration::builders::GetVpnConnectionDeviceSampleConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_vpn_connection_device_sample_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_vpn_connection_device_sample_configuration::builders::GetVpnConnectionDeviceSampleConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
