...
impl DescribeTrafficMirrorTargetsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_traffic_mirror_targets::builders::DescribeTrafficMirrorTargetsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_traffic_mirror_targets().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_traffic_mirror_targets::builders::DescribeTrafficMirrorTargetsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
