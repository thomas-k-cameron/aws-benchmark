...
impl DescribeLocalGatewayVirtualInterfacesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_local_gateway_virtual_interfaces::builders::DescribeLocalGatewayVirtualInterfacesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_local_gateway_virtual_interfaces().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_local_gateway_virtual_interfaces::builders::DescribeLocalGatewayVirtualInterfacesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
