...
impl DescribeInstanceAttributeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_instance_attribute::builders::DescribeInstanceAttributeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_instance_attribute().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_instance_attribute::builders::DescribeInstanceAttributeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
