...
impl DescribeConversionTasksFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_conversion_tasks::builders::DescribeConversionTasksInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_conversion_tasks().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_conversion_tasks::builders::DescribeConversionTasksInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
