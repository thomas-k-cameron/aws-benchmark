...
impl DisassociateTransitGatewayPolicyTableFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::disassociate_transit_gateway_policy_table::builders::DisassociateTransitGatewayPolicyTableInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.disassociate_transit_gateway_policy_table().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::disassociate_transit_gateway_policy_table::builders::DisassociateTransitGatewayPolicyTableInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
