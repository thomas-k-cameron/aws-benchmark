...
impl StartNetworkInsightsAnalysisFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::start_network_insights_analysis::builders::StartNetworkInsightsAnalysisInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.start_network_insights_analysis().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::start_network_insights_analysis::builders::StartNetworkInsightsAnalysisInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
