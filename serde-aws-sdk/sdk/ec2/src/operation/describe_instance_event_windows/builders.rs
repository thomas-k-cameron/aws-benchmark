...
impl DescribeInstanceEventWindowsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_instance_event_windows::builders::DescribeInstanceEventWindowsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_instance_event_windows().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_instance_event_windows::builders::DescribeInstanceEventWindowsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
