...
impl CreateNetworkInsightsAccessScopeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_network_insights_access_scope::builders::CreateNetworkInsightsAccessScopeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_network_insights_access_scope().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_network_insights_access_scope::builders::CreateNetworkInsightsAccessScopeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
