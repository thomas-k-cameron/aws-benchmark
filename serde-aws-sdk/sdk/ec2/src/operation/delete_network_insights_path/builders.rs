...
impl DeleteNetworkInsightsPathFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_network_insights_path::builders::DeleteNetworkInsightsPathInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_network_insights_path().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_network_insights_path::builders::DeleteNetworkInsightsPathInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
