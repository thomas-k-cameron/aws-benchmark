...
impl ListSnapshotsInRecycleBinFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_snapshots_in_recycle_bin::builders::ListSnapshotsInRecycleBinInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_snapshots_in_recycle_bin().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_snapshots_in_recycle_bin::builders::ListSnapshotsInRecycleBinInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
