...
impl DescribeImportSnapshotTasksFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_import_snapshot_tasks::builders::DescribeImportSnapshotTasksInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_import_snapshot_tasks().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_import_snapshot_tasks::builders::DescribeImportSnapshotTasksInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
