...
impl ModifyVerifiedAccessGroupFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_verified_access_group::builders::ModifyVerifiedAccessGroupInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_verified_access_group().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_verified_access_group::builders::ModifyVerifiedAccessGroupInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
