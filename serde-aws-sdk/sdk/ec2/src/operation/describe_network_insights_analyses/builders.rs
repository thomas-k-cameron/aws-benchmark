...
impl DescribeNetworkInsightsAnalysesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_network_insights_analyses::builders::DescribeNetworkInsightsAnalysesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_network_insights_analyses().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_network_insights_analyses::builders::DescribeNetworkInsightsAnalysesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
