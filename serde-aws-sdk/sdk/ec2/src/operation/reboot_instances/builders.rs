...
impl RebootInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::reboot_instances::builders::RebootInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.reboot_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::reboot_instances::builders::RebootInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
