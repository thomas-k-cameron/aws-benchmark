...
impl CancelSpotFleetRequestsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::cancel_spot_fleet_requests::builders::CancelSpotFleetRequestsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.cancel_spot_fleet_requests().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::cancel_spot_fleet_requests::builders::CancelSpotFleetRequestsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
