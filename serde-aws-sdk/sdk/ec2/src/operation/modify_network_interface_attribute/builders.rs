...
impl ModifyNetworkInterfaceAttributeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_network_interface_attribute::builders::ModifyNetworkInterfaceAttributeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_network_interface_attribute().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_network_interface_attribute::builders::ModifyNetworkInterfaceAttributeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
