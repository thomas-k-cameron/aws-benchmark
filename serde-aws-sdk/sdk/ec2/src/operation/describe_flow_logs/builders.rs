...
impl DescribeFlowLogsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_flow_logs::builders::DescribeFlowLogsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_flow_logs().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_flow_logs::builders::DescribeFlowLogsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
