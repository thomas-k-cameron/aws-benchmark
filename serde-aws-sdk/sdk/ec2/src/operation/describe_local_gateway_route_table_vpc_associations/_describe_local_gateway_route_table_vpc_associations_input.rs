...
#[allow(dead_code)]
pub type OutputShape = crate::operation::describe_local_gateway_route_table_vpc_associations::DescribeLocalGatewayRouteTableVpcAssociationsInput;
...
impl DescribeLocalGatewayRouteTableVpcAssociationsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::describe_local_gateway_route_table_vpc_associations::DescribeLocalGatewayRouteTableVpcAssociationsInput, aws_smithy_http::operation::error::BuildError>{
        Ok(
