...
impl AcceptVpcPeeringConnectionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::accept_vpc_peering_connection::builders::AcceptVpcPeeringConnectionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.accept_vpc_peering_connection().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::accept_vpc_peering_connection::builders::AcceptVpcPeeringConnectionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
