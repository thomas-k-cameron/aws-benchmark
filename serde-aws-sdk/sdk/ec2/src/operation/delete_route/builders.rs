...
impl DeleteRouteFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_route::builders::DeleteRouteInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_route().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_route::builders::DeleteRouteInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
