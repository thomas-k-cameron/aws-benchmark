...
impl CreateVpcEndpointServiceConfigurationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_vpc_endpoint_service_configuration::builders::CreateVpcEndpointServiceConfigurationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_vpc_endpoint_service_configuration().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_vpc_endpoint_service_configuration::builders::CreateVpcEndpointServiceConfigurationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
