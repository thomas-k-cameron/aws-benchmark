...
impl StartInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::start_instances::builders::StartInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.start_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::start_instances::builders::StartInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
