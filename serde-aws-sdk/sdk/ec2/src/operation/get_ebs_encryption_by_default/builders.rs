...
impl GetEbsEncryptionByDefaultFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_ebs_encryption_by_default::builders::GetEbsEncryptionByDefaultInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_ebs_encryption_by_default().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_ebs_encryption_by_default::builders::GetEbsEncryptionByDefaultInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
