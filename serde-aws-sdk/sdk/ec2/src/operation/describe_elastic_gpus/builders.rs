...
impl DescribeElasticGpusFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_elastic_gpus::builders::DescribeElasticGpusInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_elastic_gpus().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_elastic_gpus::builders::DescribeElasticGpusInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
