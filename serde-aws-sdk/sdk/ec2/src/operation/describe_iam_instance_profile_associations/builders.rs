...
impl DescribeIamInstanceProfileAssociationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_iam_instance_profile_associations::builders::DescribeIamInstanceProfileAssociationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_iam_instance_profile_associations().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_iam_instance_profile_associations::builders::DescribeIamInstanceProfileAssociationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
