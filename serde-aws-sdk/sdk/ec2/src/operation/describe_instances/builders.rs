...
impl DescribeInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_instances::builders::DescribeInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_instances::builders::DescribeInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
