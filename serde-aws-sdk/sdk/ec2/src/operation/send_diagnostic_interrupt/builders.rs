...
impl SendDiagnosticInterruptFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::send_diagnostic_interrupt::builders::SendDiagnosticInterruptInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.send_diagnostic_interrupt().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::send_diagnostic_interrupt::builders::SendDiagnosticInterruptInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
