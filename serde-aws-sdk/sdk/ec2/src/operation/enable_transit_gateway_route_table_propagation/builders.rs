...
impl EnableTransitGatewayRouteTablePropagationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::enable_transit_gateway_route_table_propagation::builders::EnableTransitGatewayRouteTablePropagationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.enable_transit_gateway_route_table_propagation().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::enable_transit_gateway_route_table_propagation::builders::EnableTransitGatewayRouteTablePropagationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
