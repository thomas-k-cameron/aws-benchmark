...
impl DetachClassicLinkVpcFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::detach_classic_link_vpc::builders::DetachClassicLinkVpcInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.detach_classic_link_vpc().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::detach_classic_link_vpc::builders::DetachClassicLinkVpcInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
