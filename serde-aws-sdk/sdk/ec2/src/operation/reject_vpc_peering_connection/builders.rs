...
impl RejectVpcPeeringConnectionFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::CustomizableOperation<
            crate::operation::reject_vpc_peering_connection::RejectVpcPeeringConnection,
    ...
    ///     let deserialized_parameters: crate::operation::reject_vpc_peering_connection::builders::RejectVpcPeeringConnectionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.reject_vpc_peering_connection().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::reject_vpc_peering_connection::builders::RejectVpcPeeringConnectionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
