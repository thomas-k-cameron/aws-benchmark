...
impl CreateReplaceRootVolumeTaskFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_replace_root_volume_task::builders::CreateReplaceRootVolumeTaskInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_replace_root_volume_task().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_replace_root_volume_task::builders::CreateReplaceRootVolumeTaskInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
