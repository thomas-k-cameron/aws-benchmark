...
impl DeleteTagsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_tags::builders::DeleteTagsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_tags().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_tags::builders::DeleteTagsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
