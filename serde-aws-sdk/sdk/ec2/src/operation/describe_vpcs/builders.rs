...
impl DescribeVpcsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_vpcs::builders::DescribeVpcsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_vpcs().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_vpcs::builders::DescribeVpcsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
