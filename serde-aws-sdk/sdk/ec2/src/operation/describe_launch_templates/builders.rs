...
impl DescribeLaunchTemplatesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_launch_templates::builders::DescribeLaunchTemplatesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_launch_templates().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_launch_templates::builders::DescribeLaunchTemplatesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
