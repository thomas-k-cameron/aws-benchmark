...
impl AttachVerifiedAccessTrustProviderFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::attach_verified_access_trust_provider::builders::AttachVerifiedAccessTrustProviderInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.attach_verified_access_trust_provider().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::attach_verified_access_trust_provider::builders::AttachVerifiedAccessTrustProviderInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
