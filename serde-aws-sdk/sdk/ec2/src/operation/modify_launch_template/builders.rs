...
impl ModifyLaunchTemplateFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_launch_template::builders::ModifyLaunchTemplateInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_launch_template().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_launch_template::builders::ModifyLaunchTemplateInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
