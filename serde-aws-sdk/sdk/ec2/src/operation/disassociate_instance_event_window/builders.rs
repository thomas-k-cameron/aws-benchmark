...
impl DisassociateInstanceEventWindowFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::disassociate_instance_event_window::builders::DisassociateInstanceEventWindowInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.disassociate_instance_event_window().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::disassociate_instance_event_window::builders::DisassociateInstanceEventWindowInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
