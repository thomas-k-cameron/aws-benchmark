...
impl DescribeTagsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_tags::builders::DescribeTagsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_tags().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_tags::builders::DescribeTagsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
