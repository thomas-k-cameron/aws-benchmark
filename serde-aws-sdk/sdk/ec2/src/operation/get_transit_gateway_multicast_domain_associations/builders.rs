...
impl GetTransitGatewayMulticastDomainAssociationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_transit_gateway_multicast_domain_associations::builders::GetTransitGatewayMulticastDomainAssociationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_transit_gateway_multicast_domain_associations().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_transit_gateway_multicast_domain_associations::builders::GetTransitGatewayMulticastDomainAssociationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
