...
impl DescribeSpotFleetRequestHistoryFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_spot_fleet_request_history::builders::DescribeSpotFleetRequestHistoryInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_spot_fleet_request_history().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_spot_fleet_request_history::builders::DescribeSpotFleetRequestHistoryInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
