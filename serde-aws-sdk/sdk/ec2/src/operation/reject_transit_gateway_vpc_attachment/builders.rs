...
impl RejectTransitGatewayVpcAttachmentFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::reject_transit_gateway_vpc_attachment::builders::RejectTransitGatewayVpcAttachmentInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.reject_transit_gateway_vpc_attachment().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::reject_transit_gateway_vpc_attachment::builders::RejectTransitGatewayVpcAttachmentInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
