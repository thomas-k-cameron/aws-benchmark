...
impl AssociateTransitGatewayMulticastDomainFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::associate_transit_gateway_multicast_domain::builders::AssociateTransitGatewayMulticastDomainInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.associate_transit_gateway_multicast_domain().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::associate_transit_gateway_multicast_domain::builders::AssociateTransitGatewayMulticastDomainInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
