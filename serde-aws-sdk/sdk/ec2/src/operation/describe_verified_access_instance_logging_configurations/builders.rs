...
impl DescribeVerifiedAccessInstanceLoggingConfigurationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_verified_access_instance_logging_configurations::builders::DescribeVerifiedAccessInstanceLoggingConfigurationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_verified_access_instance_logging_configurations().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_verified_access_instance_logging_configurations::builders::DescribeVerifiedAccessInstanceLoggingConfigurationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
