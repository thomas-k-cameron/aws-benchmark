...
impl DescribeIdFormatFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_id_format::builders::DescribeIdFormatInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_id_format().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_id_format::builders::DescribeIdFormatInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
