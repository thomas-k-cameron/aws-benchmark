...
impl ResetEbsDefaultKmsKeyIdFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::reset_ebs_default_kms_key_id::builders::ResetEbsDefaultKmsKeyIdInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.reset_ebs_default_kms_key_id().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::reset_ebs_default_kms_key_id::builders::ResetEbsDefaultKmsKeyIdInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
