...
impl PurchaseReservedInstancesOfferingFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::purchase_reserved_instances_offering::builders::PurchaseReservedInstancesOfferingInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.purchase_reserved_instances_offering().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::purchase_reserved_instances_offering::builders::PurchaseReservedInstancesOfferingInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
