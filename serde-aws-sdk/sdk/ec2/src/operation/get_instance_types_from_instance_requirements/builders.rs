...
impl GetInstanceTypesFromInstanceRequirementsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_instance_types_from_instance_requirements::builders::GetInstanceTypesFromInstanceRequirementsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_instance_types_from_instance_requirements().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_instance_types_from_instance_requirements::builders::GetInstanceTypesFromInstanceRequirementsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
