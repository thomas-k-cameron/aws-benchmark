...
impl AuthorizeSecurityGroupIngressFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::authorize_security_group_ingress::builders::AuthorizeSecurityGroupIngressInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.authorize_security_group_ingress().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::authorize_security_group_ingress::builders::AuthorizeSecurityGroupIngressInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
