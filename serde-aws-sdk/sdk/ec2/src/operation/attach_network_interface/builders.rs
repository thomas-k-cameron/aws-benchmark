...
impl AttachNetworkInterfaceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::attach_network_interface::builders::AttachNetworkInterfaceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.attach_network_interface().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::attach_network_interface::builders::AttachNetworkInterfaceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
