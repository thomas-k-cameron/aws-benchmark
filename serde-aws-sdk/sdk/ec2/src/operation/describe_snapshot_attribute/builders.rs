...
impl DescribeSnapshotAttributeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_snapshot_attribute::builders::DescribeSnapshotAttributeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_snapshot_attribute().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_snapshot_attribute::builders::DescribeSnapshotAttributeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
