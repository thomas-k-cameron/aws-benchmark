...
impl DeleteNetworkInsightsAnalysisFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_network_insights_analysis::builders::DeleteNetworkInsightsAnalysisInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_network_insights_analysis().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_network_insights_analysis::builders::DeleteNetworkInsightsAnalysisInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
