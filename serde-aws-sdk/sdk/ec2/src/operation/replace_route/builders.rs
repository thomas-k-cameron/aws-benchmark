...
impl ReplaceRouteFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::replace_route::builders::ReplaceRouteInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.replace_route().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::replace_route::builders::ReplaceRouteInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
