...
impl DescribeAddressesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_addresses::builders::DescribeAddressesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_addresses().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_addresses::builders::DescribeAddressesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
