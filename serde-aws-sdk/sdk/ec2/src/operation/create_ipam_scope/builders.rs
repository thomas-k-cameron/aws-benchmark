...
impl CreateIpamScopeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_ipam_scope::builders::CreateIpamScopeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_ipam_scope().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_ipam_scope::builders::CreateIpamScopeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
