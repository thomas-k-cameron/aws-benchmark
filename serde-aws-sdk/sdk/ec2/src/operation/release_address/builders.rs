...
impl ReleaseAddressFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::release_address::builders::ReleaseAddressInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.release_address().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::release_address::builders::ReleaseAddressInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
