...
impl CreateSubnetFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_subnet::builders::CreateSubnetInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_subnet().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_subnet::builders::CreateSubnetInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
