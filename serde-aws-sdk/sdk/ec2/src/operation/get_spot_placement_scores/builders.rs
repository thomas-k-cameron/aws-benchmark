...
impl GetSpotPlacementScoresFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_spot_placement_scores::builders::GetSpotPlacementScoresInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_spot_placement_scores().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_spot_placement_scores::builders::GetSpotPlacementScoresInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
