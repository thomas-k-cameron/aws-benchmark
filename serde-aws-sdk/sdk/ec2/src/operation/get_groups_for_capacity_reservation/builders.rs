...
impl GetGroupsForCapacityReservationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_groups_for_capacity_reservation::builders::GetGroupsForCapacityReservationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_groups_for_capacity_reservation().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_groups_for_capacity_reservation::builders::GetGroupsForCapacityReservationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
