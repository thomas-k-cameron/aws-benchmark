...
impl DescribePublicIpv4PoolsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_public_ipv4_pools::builders::DescribePublicIpv4PoolsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_public_ipv4_pools().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_public_ipv4_pools::builders::DescribePublicIpv4PoolsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
