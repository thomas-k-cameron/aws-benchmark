...
impl DeleteQueuedReservedInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_queued_reserved_instances::builders::DeleteQueuedReservedInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_queued_reserved_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_queued_reserved_instances::builders::DeleteQueuedReservedInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
