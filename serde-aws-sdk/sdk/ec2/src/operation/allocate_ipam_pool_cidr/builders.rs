...
impl AllocateIpamPoolCidrFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::allocate_ipam_pool_cidr::builders::AllocateIpamPoolCidrInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.allocate_ipam_pool_cidr().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::allocate_ipam_pool_cidr::builders::AllocateIpamPoolCidrInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
