...
impl EnableVolumeIOFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::enable_volume_io::builders::EnableVolumeIoInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.enable_volume_io().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::enable_volume_io::builders::EnableVolumeIoInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
