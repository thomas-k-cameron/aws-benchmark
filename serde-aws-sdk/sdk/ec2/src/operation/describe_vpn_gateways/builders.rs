...
impl DescribeVpnGatewaysFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_vpn_gateways::builders::DescribeVpnGatewaysInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_vpn_gateways().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_vpn_gateways::builders::DescribeVpnGatewaysInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
