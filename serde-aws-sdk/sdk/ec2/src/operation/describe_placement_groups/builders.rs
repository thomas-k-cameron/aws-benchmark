...
impl DescribePlacementGroupsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_placement_groups::builders::DescribePlacementGroupsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_placement_groups().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_placement_groups::builders::DescribePlacementGroupsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
