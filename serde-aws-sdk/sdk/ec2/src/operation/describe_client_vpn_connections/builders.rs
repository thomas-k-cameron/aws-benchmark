...
impl DescribeClientVpnConnectionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_client_vpn_connections::builders::DescribeClientVpnConnectionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_client_vpn_connections().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_client_vpn_connections::builders::DescribeClientVpnConnectionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
