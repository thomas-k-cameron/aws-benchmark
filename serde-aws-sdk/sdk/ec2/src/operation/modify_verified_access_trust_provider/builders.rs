...
impl ModifyVerifiedAccessTrustProviderFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_verified_access_trust_provider::builders::ModifyVerifiedAccessTrustProviderInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_verified_access_trust_provider().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_verified_access_trust_provider::builders::ModifyVerifiedAccessTrustProviderInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
