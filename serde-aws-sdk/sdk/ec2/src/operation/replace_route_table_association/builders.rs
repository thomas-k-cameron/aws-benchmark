...
impl ReplaceRouteTableAssociationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::replace_route_table_association::builders::ReplaceRouteTableAssociationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.replace_route_table_association().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::replace_route_table_association::builders::ReplaceRouteTableAssociationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
