...
impl CreateLocalGatewayRouteFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_local_gateway_route::builders::CreateLocalGatewayRouteInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_local_gateway_route().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_local_gateway_route::builders::CreateLocalGatewayRouteInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
