...
impl CreateVerifiedAccessTrustProviderFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_verified_access_trust_provider::builders::CreateVerifiedAccessTrustProviderInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_verified_access_trust_provider().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_verified_access_trust_provider::builders::CreateVerifiedAccessTrustProviderInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
