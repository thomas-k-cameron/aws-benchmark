...
impl DescribeFleetHistoryFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_fleet_history::builders::DescribeFleetHistoryInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_fleet_history().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_fleet_history::builders::DescribeFleetHistoryInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
