...
impl DeleteCoipPoolFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_coip_pool::builders::DeleteCoipPoolInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_coip_pool().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_coip_pool::builders::DeleteCoipPoolInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
