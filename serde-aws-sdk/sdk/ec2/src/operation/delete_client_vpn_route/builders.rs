...
impl DeleteClientVpnRouteFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_client_vpn_route::builders::DeleteClientVpnRouteInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_client_vpn_route().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_client_vpn_route::builders::DeleteClientVpnRouteInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
