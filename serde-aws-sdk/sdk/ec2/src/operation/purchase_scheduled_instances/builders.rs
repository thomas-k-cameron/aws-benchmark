...
impl PurchaseScheduledInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::purchase_scheduled_instances::builders::PurchaseScheduledInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.purchase_scheduled_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::purchase_scheduled_instances::builders::PurchaseScheduledInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
