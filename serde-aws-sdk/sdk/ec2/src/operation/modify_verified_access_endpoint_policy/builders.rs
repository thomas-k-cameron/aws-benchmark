...
impl ModifyVerifiedAccessEndpointPolicyFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_verified_access_endpoint_policy::builders::ModifyVerifiedAccessEndpointPolicyInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_verified_access_endpoint_policy().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_verified_access_endpoint_policy::builders::ModifyVerifiedAccessEndpointPolicyInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
