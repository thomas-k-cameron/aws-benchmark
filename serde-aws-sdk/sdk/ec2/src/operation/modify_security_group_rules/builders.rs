...
impl ModifySecurityGroupRulesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_security_group_rules::builders::ModifySecurityGroupRulesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_security_group_rules().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_security_group_rules::builders::ModifySecurityGroupRulesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
