...
impl GetIpamAddressHistoryFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_ipam_address_history::builders::GetIpamAddressHistoryInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_ipam_address_history().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_ipam_address_history::builders::GetIpamAddressHistoryInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
