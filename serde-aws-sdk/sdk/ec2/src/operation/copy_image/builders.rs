...
impl CopyImageFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::copy_image::builders::CopyImageInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.copy_image().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::copy_image::builders::CopyImageInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
