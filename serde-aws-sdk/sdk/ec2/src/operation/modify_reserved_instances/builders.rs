...
impl ModifyReservedInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_reserved_instances::builders::ModifyReservedInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_reserved_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_reserved_instances::builders::ModifyReservedInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
