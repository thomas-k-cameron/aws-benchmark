...
impl CreateSnapshotFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_snapshot::builders::CreateSnapshotInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_snapshot().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_snapshot::builders::CreateSnapshotInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
