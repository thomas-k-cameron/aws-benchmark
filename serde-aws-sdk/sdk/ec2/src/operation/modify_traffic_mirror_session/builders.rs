...
impl ModifyTrafficMirrorSessionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_traffic_mirror_session::builders::ModifyTrafficMirrorSessionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_traffic_mirror_session().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_traffic_mirror_session::builders::ModifyTrafficMirrorSessionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
