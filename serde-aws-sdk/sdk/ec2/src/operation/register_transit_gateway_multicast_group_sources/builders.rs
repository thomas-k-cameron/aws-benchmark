...
impl RegisterTransitGatewayMulticastGroupSourcesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::register_transit_gateway_multicast_group_sources::builders::RegisterTransitGatewayMulticastGroupSourcesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.register_transit_gateway_multicast_group_sources().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::register_transit_gateway_multicast_group_sources::builders::RegisterTransitGatewayMulticastGroupSourcesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
