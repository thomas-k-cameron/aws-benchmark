...
impl SearchTransitGatewayRoutesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::search_transit_gateway_routes::builders::SearchTransitGatewayRoutesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.search_transit_gateway_routes().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::search_transit_gateway_routes::builders::SearchTransitGatewayRoutesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
