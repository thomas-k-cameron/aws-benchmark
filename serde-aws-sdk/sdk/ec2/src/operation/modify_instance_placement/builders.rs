...
impl ModifyInstancePlacementFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_instance_placement::builders::ModifyInstancePlacementInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_instance_placement().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_instance_placement::builders::ModifyInstancePlacementInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
