...
impl CreatePlacementGroupFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_placement_group::builders::CreatePlacementGroupInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_placement_group().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_placement_group::builders::CreatePlacementGroupInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
