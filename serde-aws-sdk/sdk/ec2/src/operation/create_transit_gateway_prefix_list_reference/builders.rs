...
impl CreateTransitGatewayPrefixListReferenceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_transit_gateway_prefix_list_reference::builders::CreateTransitGatewayPrefixListReferenceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_transit_gateway_prefix_list_reference().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_transit_gateway_prefix_list_reference::builders::CreateTransitGatewayPrefixListReferenceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
