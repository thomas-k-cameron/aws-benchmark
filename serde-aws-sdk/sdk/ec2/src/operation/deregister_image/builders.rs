...
impl DeregisterImageFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::deregister_image::builders::DeregisterImageInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.deregister_image().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::deregister_image::builders::DeregisterImageInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
