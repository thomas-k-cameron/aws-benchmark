...
impl DeletePlacementGroupFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_placement_group::builders::DeletePlacementGroupInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_placement_group().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_placement_group::builders::DeletePlacementGroupInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
