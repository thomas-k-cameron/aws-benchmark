...
impl ModifyEbsDefaultKmsKeyIdFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_ebs_default_kms_key_id::builders::ModifyEbsDefaultKmsKeyIdInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_ebs_default_kms_key_id().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_ebs_default_kms_key_id::builders::ModifyEbsDefaultKmsKeyIdInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
