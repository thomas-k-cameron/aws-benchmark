...
impl DescribeStoreImageTasksFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_store_image_tasks::builders::DescribeStoreImageTasksInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_store_image_tasks().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_store_image_tasks::builders::DescribeStoreImageTasksInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
