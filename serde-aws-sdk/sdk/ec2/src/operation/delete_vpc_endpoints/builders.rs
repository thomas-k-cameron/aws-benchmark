...
impl DeleteVpcEndpointsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_vpc_endpoints::builders::DeleteVpcEndpointsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_vpc_endpoints().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_vpc_endpoints::builders::DeleteVpcEndpointsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
