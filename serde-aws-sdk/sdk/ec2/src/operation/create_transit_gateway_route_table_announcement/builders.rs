...
impl CreateTransitGatewayRouteTableAnnouncementFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_transit_gateway_route_table_announcement::builders::CreateTransitGatewayRouteTableAnnouncementInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_transit_gateway_route_table_announcement().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_transit_gateway_route_table_announcement::builders::CreateTransitGatewayRouteTableAnnouncementInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
