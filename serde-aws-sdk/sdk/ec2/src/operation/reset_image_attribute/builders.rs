...
impl ResetImageAttributeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::reset_image_attribute::builders::ResetImageAttributeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.reset_image_attribute().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::reset_image_attribute::builders::ResetImageAttributeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
