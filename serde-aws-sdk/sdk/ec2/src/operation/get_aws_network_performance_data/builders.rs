...
impl GetAwsNetworkPerformanceDataFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_aws_network_performance_data::builders::GetAwsNetworkPerformanceDataInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_aws_network_performance_data().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_aws_network_performance_data::builders::GetAwsNetworkPerformanceDataInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
