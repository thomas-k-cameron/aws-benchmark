...
impl DeleteSubnetFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_subnet::builders::DeleteSubnetInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_subnet().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_subnet::builders::DeleteSubnetInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
