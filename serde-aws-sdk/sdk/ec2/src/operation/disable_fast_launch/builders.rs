...
impl DisableFastLaunchFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::disable_fast_launch::builders::DisableFastLaunchInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.disable_fast_launch().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::disable_fast_launch::builders::DisableFastLaunchInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
