...
impl CreateRestoreImageTaskFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_restore_image_task::builders::CreateRestoreImageTaskInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_restore_image_task().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_restore_image_task::builders::CreateRestoreImageTaskInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
