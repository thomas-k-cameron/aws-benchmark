...
impl ModifySnapshotTierFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_snapshot_tier::builders::ModifySnapshotTierInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_snapshot_tier().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_snapshot_tier::builders::ModifySnapshotTierInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
