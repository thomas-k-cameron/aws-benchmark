...
impl DisassociateClientVpnTargetNetworkFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::disassociate_client_vpn_target_network::builders::DisassociateClientVpnTargetNetworkInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.disassociate_client_vpn_target_network().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::disassociate_client_vpn_target_network::builders::DisassociateClientVpnTargetNetworkInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
