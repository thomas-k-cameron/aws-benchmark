...
impl BundleInstanceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::bundle_instance::builders::BundleInstanceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.bundle_instance().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::bundle_instance::builders::BundleInstanceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
