...
impl TerminateClientVpnConnectionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::terminate_client_vpn_connections::builders::TerminateClientVpnConnectionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.terminate_client_vpn_connections().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::terminate_client_vpn_connections::builders::TerminateClientVpnConnectionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
