...
impl DescribeScheduledInstanceAvailabilityFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_scheduled_instance_availability::builders::DescribeScheduledInstanceAvailabilityInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_scheduled_instance_availability().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_scheduled_instance_availability::builders::DescribeScheduledInstanceAvailabilityInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
