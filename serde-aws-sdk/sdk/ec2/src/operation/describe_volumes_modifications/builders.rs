...
impl DescribeVolumesModificationsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_volumes_modifications::builders::DescribeVolumesModificationsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_volumes_modifications().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_volumes_modifications::builders::DescribeVolumesModificationsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
