...
impl DeleteSpotDatafeedSubscriptionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_spot_datafeed_subscription::builders::DeleteSpotDatafeedSubscriptionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_spot_datafeed_subscription().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_spot_datafeed_subscription::builders::DeleteSpotDatafeedSubscriptionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
