...
impl DeleteNetworkInsightsAccessScopeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_network_insights_access_scope::builders::DeleteNetworkInsightsAccessScopeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_network_insights_access_scope().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_network_insights_access_scope::builders::DeleteNetworkInsightsAccessScopeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
