...
impl ResetNetworkInterfaceAttributeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::reset_network_interface_attribute::builders::ResetNetworkInterfaceAttributeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.reset_network_interface_attribute().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::reset_network_interface_attribute::builders::ResetNetworkInterfaceAttributeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
