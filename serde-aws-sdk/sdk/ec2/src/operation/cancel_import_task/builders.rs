...
impl CancelImportTaskFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::cancel_import_task::builders::CancelImportTaskInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.cancel_import_task().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::cancel_import_task::builders::CancelImportTaskInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
