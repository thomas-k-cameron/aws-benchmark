...
impl ReleaseIpamPoolAllocationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::release_ipam_pool_allocation::builders::ReleaseIpamPoolAllocationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.release_ipam_pool_allocation().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::release_ipam_pool_allocation::builders::ReleaseIpamPoolAllocationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
