...
impl AssociateEnclaveCertificateIamRoleFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::associate_enclave_certificate_iam_role::builders::AssociateEnclaveCertificateIamRoleInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.associate_enclave_certificate_iam_role().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::associate_enclave_certificate_iam_role::builders::AssociateEnclaveCertificateIamRoleInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
