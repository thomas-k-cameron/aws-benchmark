...
impl DeleteTransitGatewayPrefixListReferenceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_transit_gateway_prefix_list_reference::builders::DeleteTransitGatewayPrefixListReferenceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_transit_gateway_prefix_list_reference().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_transit_gateway_prefix_list_reference::builders::DeleteTransitGatewayPrefixListReferenceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
