...
impl CreateTransitGatewayPolicyTableFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_transit_gateway_policy_table::builders::CreateTransitGatewayPolicyTableInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_transit_gateway_policy_table().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_transit_gateway_policy_table::builders::CreateTransitGatewayPolicyTableInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
