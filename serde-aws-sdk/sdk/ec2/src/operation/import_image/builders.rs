...
impl ImportImageFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::import_image::builders::ImportImageInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.import_image().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::import_image::builders::ImportImageInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
