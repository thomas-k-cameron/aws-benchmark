...
impl ModifyPrivateDnsNameOptionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_private_dns_name_options::builders::ModifyPrivateDnsNameOptionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_private_dns_name_options().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_private_dns_name_options::builders::ModifyPrivateDnsNameOptionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
