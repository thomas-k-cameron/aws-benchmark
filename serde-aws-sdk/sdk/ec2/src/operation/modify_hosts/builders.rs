...
impl ModifyHostsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_hosts::builders::ModifyHostsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_hosts().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_hosts::builders::ModifyHostsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
