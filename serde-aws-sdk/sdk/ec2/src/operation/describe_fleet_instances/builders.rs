...
impl DescribeFleetInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_fleet_instances::builders::DescribeFleetInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_fleet_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_fleet_instances::builders::DescribeFleetInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
