...
impl GetIpamResourceCidrsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_ipam_resource_cidrs().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
