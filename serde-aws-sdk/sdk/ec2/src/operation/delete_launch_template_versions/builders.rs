...
impl DeleteLaunchTemplateVersionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_launch_template_versions::builders::DeleteLaunchTemplateVersionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_launch_template_versions().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_launch_template_versions::builders::DeleteLaunchTemplateVersionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
