...
impl DeleteFleetsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_fleets::builders::DeleteFleetsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_fleets().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_fleets::builders::DeleteFleetsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
