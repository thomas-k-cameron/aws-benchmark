...
impl DescribeNetworkInterfacePermissionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_network_interface_permissions::builders::DescribeNetworkInterfacePermissionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_network_interface_permissions().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_network_interface_permissions::builders::DescribeNetworkInterfacePermissionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
