...
impl RestoreImageFromRecycleBinFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::restore_image_from_recycle_bin::builders::RestoreImageFromRecycleBinInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.restore_image_from_recycle_bin().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::restore_image_from_recycle_bin::builders::RestoreImageFromRecycleBinInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
