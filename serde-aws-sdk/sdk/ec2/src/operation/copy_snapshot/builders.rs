...
impl CopySnapshotFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::copy_snapshot::builders::CopySnapshotInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.copy_snapshot().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::copy_snapshot::builders::CopySnapshotInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
