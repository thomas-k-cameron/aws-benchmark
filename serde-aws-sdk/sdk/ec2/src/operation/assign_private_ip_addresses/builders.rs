...
impl AssignPrivateIpAddressesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::assign_private_ip_addresses::builders::AssignPrivateIpAddressesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.assign_private_ip_addresses().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::assign_private_ip_addresses::builders::AssignPrivateIpAddressesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
