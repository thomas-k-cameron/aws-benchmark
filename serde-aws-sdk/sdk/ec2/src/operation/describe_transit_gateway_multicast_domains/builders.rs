...
impl DescribeTransitGatewayMulticastDomainsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_transit_gateway_multicast_domains::builders::DescribeTransitGatewayMulticastDomainsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_transit_gateway_multicast_domains().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_transit_gateway_multicast_domains::builders::DescribeTransitGatewayMulticastDomainsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
