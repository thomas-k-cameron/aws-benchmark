...
#[allow(dead_code)]
pub type OutputShape = crate::operation::describe_transit_gateway_multicast_domains::DescribeTransitGatewayMulticastDomainsInput;
...
impl DescribeTransitGatewayMulticastDomainsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::describe_transit_gateway_multicast_domains::DescribeTransitGatewayMulticastDomainsInput, aws_smithy_http::operation::error::BuildError>{
        Ok(
