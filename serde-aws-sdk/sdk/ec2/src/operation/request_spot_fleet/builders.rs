...
impl RequestSpotFleetFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::request_spot_fleet::builders::RequestSpotFleetInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.request_spot_fleet().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::request_spot_fleet::builders::RequestSpotFleetInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
