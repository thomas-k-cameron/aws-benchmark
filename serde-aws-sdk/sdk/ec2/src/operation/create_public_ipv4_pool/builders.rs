...
impl CreatePublicIpv4PoolFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_public_ipv4_pool::builders::CreatePublicIpv4PoolInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_public_ipv4_pool().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_public_ipv4_pool::builders::CreatePublicIpv4PoolInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
