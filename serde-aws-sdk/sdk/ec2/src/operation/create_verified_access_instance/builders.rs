...
impl CreateVerifiedAccessInstanceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_verified_access_instance::builders::CreateVerifiedAccessInstanceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_verified_access_instance().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_verified_access_instance::builders::CreateVerifiedAccessInstanceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
