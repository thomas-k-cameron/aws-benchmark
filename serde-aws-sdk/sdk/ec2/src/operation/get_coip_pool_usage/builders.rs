...
impl GetCoipPoolUsageFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_coip_pool_usage::builders::GetCoipPoolUsageInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_coip_pool_usage().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_coip_pool_usage::builders::GetCoipPoolUsageInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
