...
impl CreateDhcpOptionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_dhcp_options::builders::CreateDhcpOptionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_dhcp_options().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_dhcp_options::builders::CreateDhcpOptionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
