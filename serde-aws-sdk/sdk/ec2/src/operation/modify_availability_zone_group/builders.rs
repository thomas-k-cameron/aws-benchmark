...
impl ModifyAvailabilityZoneGroupFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_availability_zone_group::builders::ModifyAvailabilityZoneGroupInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_availability_zone_group().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_availability_zone_group::builders::ModifyAvailabilityZoneGroupInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
