...
impl DescribeSecurityGroupRulesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_security_group_rules::builders::DescribeSecurityGroupRulesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_security_group_rules().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_security_group_rules::builders::DescribeSecurityGroupRulesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
