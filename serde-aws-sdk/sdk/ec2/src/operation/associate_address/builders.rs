...
impl AssociateAddressFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::associate_address::builders::AssociateAddressInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.associate_address().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::associate_address::builders::AssociateAddressInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
