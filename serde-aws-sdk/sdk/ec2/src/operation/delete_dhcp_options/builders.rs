...
impl DeleteDhcpOptionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_dhcp_options::builders::DeleteDhcpOptionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_dhcp_options().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_dhcp_options::builders::DeleteDhcpOptionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
