...
impl ModifyClientVpnEndpointFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::modify_client_vpn_endpoint::builders::ModifyClientVpnEndpointInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.modify_client_vpn_endpoint().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::modify_client_vpn_endpoint::builders::ModifyClientVpnEndpointInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
