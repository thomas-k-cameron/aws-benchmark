...
#[allow(dead_code)]
pub type OutputShape = crate::operation::describe_transit_gateway_route_tables::DescribeTransitGatewayRouteTablesOutput;
...
impl DescribeTransitGatewayRouteTablesOutputBuilder {
    ...
    pub fn set_transit_gateway_route_tables(
        mut self,
        input: std::option::Option<std::vec::Vec<crate::types::TransitGatewayRouteTable>>,
    ) -> Self {
