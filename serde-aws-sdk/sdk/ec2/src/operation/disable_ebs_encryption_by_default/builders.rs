...
impl DisableEbsEncryptionByDefaultFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::disable_ebs_encryption_by_default::builders::DisableEbsEncryptionByDefaultInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.disable_ebs_encryption_by_default().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::disable_ebs_encryption_by_default::builders::DisableEbsEncryptionByDefaultInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
