...
impl GetPasswordDataFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_password_data::builders::GetPasswordDataInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_password_data().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_password_data::builders::GetPasswordDataInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
