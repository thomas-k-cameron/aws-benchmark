...
impl GetIpamDiscoveredAccountsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_ipam_discovered_accounts::builders::GetIpamDiscoveredAccountsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_ipam_discovered_accounts().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_ipam_discovered_accounts::builders::GetIpamDiscoveredAccountsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
