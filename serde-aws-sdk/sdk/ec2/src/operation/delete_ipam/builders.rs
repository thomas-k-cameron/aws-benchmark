...
impl DeleteIpamFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_ipam::builders::DeleteIpamInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_ipam().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_ipam::builders::DeleteIpamInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
