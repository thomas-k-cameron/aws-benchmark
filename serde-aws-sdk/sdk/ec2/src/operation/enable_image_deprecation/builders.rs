...
impl EnableImageDeprecationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::enable_image_deprecation::builders::EnableImageDeprecationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.enable_image_deprecation().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::enable_image_deprecation::builders::EnableImageDeprecationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
