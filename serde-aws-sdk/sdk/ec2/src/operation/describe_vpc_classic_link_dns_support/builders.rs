...
impl DescribeVpcClassicLinkDnsSupportFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_vpc_classic_link_dns_support::builders::DescribeVpcClassicLinkDnsSupportInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_vpc_classic_link_dns_support().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_vpc_classic_link_dns_support::builders::DescribeVpcClassicLinkDnsSupportInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
