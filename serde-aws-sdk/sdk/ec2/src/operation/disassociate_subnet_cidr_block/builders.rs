...
impl DisassociateSubnetCidrBlockFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::disassociate_subnet_cidr_block::builders::DisassociateSubnetCidrBlockInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.disassociate_subnet_cidr_block().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::disassociate_subnet_cidr_block::builders::DisassociateSubnetCidrBlockInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
