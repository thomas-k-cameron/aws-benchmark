...
impl DeleteTransitGatewayRouteTableAnnouncementFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_transit_gateway_route_table_announcement::builders::DeleteTransitGatewayRouteTableAnnouncementInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_transit_gateway_route_table_announcement().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_transit_gateway_route_table_announcement::builders::DeleteTransitGatewayRouteTableAnnouncementInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
