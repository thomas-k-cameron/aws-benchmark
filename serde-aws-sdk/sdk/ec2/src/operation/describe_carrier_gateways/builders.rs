...
impl DescribeCarrierGatewaysFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_carrier_gateways::builders::DescribeCarrierGatewaysInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_carrier_gateways().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_carrier_gateways::builders::DescribeCarrierGatewaysInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
