...
impl AssociateIamInstanceProfileFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::associate_iam_instance_profile::builders::AssociateIamInstanceProfileInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.associate_iam_instance_profile().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::associate_iam_instance_profile::builders::AssociateIamInstanceProfileInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
