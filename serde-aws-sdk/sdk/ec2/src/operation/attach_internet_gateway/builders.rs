...
impl AttachInternetGatewayFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::attach_internet_gateway::builders::AttachInternetGatewayInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.attach_internet_gateway().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::attach_internet_gateway::builders::AttachInternetGatewayInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
