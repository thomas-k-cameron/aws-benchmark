...
impl EnableAddressTransferFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::enable_address_transfer::builders::EnableAddressTransferInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.enable_address_transfer().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::enable_address_transfer::builders::EnableAddressTransferInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
