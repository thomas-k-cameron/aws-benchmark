...
impl DisableTransitGatewayRouteTablePropagationFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::disable_transit_gateway_route_table_propagation::builders::DisableTransitGatewayRouteTablePropagationInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.disable_transit_gateway_route_table_propagation().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::disable_transit_gateway_route_table_propagation::builders::DisableTransitGatewayRouteTablePropagationInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
