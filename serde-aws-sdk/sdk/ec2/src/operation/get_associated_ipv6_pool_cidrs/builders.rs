...
impl GetAssociatedIpv6PoolCidrsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_associated_ipv6_pool_cidrs::builders::GetAssociatedIpv6PoolCidrsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_associated_ipv6_pool_cidrs().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_associated_ipv6_pool_cidrs::builders::GetAssociatedIpv6PoolCidrsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
