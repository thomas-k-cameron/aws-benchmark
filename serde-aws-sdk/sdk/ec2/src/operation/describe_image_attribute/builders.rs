...
impl DescribeImageAttributeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_image_attribute::builders::DescribeImageAttributeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_image_attribute().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_image_attribute::builders::DescribeImageAttributeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
