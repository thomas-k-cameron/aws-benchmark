...
impl CreateDefaultVpcFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_default_vpc::builders::CreateDefaultVpcInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_default_vpc().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_default_vpc::builders::CreateDefaultVpcInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
