...
impl EnableVpcClassicLinkFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::enable_vpc_classic_link::builders::EnableVpcClassicLinkInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.enable_vpc_classic_link().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::enable_vpc_classic_link::builders::EnableVpcClassicLinkInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
