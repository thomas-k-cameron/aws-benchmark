...
impl DescribeVolumesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_volumes::builders::DescribeVolumesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_volumes().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_volumes::builders::DescribeVolumesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
