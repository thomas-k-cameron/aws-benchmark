...
impl ResetInstanceAttributeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::reset_instance_attribute::builders::ResetInstanceAttributeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.reset_instance_attribute().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::reset_instance_attribute::builders::ResetInstanceAttributeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
