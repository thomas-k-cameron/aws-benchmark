...
impl CreateSecurityGroupFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_security_group::builders::CreateSecurityGroupInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_security_group().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_security_group::builders::CreateSecurityGroupInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
