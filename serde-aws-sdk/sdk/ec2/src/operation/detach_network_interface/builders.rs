...
impl DetachNetworkInterfaceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::detach_network_interface::builders::DetachNetworkInterfaceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.detach_network_interface().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::detach_network_interface::builders::DetachNetworkInterfaceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
