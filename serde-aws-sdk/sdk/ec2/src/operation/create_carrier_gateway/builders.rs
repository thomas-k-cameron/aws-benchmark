...
impl CreateCarrierGatewayFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_carrier_gateway::builders::CreateCarrierGatewayInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_carrier_gateway().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_carrier_gateway::builders::CreateCarrierGatewayInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
