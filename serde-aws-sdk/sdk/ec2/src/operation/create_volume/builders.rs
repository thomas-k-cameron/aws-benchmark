...
impl CreateVolumeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_volume::builders::CreateVolumeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_volume().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_volume::builders::CreateVolumeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
