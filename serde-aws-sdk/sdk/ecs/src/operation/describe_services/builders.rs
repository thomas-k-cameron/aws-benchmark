...
impl DescribeServicesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_services::builders::DescribeServicesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_services().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_services::builders::DescribeServicesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
