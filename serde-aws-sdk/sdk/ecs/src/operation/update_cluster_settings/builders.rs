...
impl UpdateClusterSettingsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_cluster_settings::builders::UpdateClusterSettingsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_cluster_settings().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_cluster_settings::builders::UpdateClusterSettingsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
