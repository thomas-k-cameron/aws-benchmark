...
impl DescribeTasksFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_tasks::builders::DescribeTasksInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_tasks().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_tasks::builders::DescribeTasksInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
