...
impl CreateTaskSetFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_task_set::builders::CreateTaskSetInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_task_set().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_task_set::builders::CreateTaskSetInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
