...
impl ExecuteCommandFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::execute_command::builders::ExecuteCommandInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.execute_command().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::execute_command::builders::ExecuteCommandInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
