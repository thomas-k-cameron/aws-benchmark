...
impl DeleteAccountSettingFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_account_setting::builders::DeleteAccountSettingInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_account_setting().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_account_setting::builders::DeleteAccountSettingInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
