...
impl DeregisterTaskDefinitionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::deregister_task_definition::builders::DeregisterTaskDefinitionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.deregister_task_definition().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::deregister_task_definition::builders::DeregisterTaskDefinitionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
