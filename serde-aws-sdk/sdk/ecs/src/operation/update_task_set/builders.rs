...
impl UpdateTaskSetFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_task_set::builders::UpdateTaskSetInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_task_set().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_task_set::builders::UpdateTaskSetInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
