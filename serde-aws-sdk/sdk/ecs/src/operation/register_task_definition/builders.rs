...
impl RegisterTaskDefinitionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::register_task_definition::builders::RegisterTaskDefinitionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.register_task_definition().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::register_task_definition::builders::RegisterTaskDefinitionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
