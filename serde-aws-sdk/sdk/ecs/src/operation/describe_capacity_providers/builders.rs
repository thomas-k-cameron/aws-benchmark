...
impl DescribeCapacityProvidersFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_capacity_providers::builders::DescribeCapacityProvidersInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_capacity_providers().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_capacity_providers::builders::DescribeCapacityProvidersInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
