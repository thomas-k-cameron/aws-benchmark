...
impl DeleteClusterFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_cluster::builders::DeleteClusterInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_cluster().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_cluster::builders::DeleteClusterInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
