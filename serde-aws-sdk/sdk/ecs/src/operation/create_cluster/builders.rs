...
impl CreateClusterFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_cluster::builders::CreateClusterInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_cluster().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_cluster::builders::CreateClusterInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
