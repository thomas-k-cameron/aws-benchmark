...
impl DescribeContainerInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_container_instances::builders::DescribeContainerInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_container_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_container_instances::builders::DescribeContainerInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
