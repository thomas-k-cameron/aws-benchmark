...
impl DeleteCapacityProviderFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_capacity_provider::builders::DeleteCapacityProviderInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_capacity_provider().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_capacity_provider::builders::DeleteCapacityProviderInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
