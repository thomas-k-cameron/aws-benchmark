...
impl PutClusterCapacityProvidersFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_cluster_capacity_providers::builders::PutClusterCapacityProvidersInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_cluster_capacity_providers().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_cluster_capacity_providers::builders::PutClusterCapacityProvidersInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
