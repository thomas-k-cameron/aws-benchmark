...
impl ListTaskDefinitionFamiliesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_task_definition_families::builders::ListTaskDefinitionFamiliesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_task_definition_families().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_task_definition_families::builders::ListTaskDefinitionFamiliesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
