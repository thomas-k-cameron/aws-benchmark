...
impl PutAccountSettingDefaultFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::put_account_setting_default::builders::PutAccountSettingDefaultInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.put_account_setting_default().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::put_account_setting_default::builders::PutAccountSettingDefaultInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
