...
impl SubmitAttachmentStateChangesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::submit_attachment_state_changes::builders::SubmitAttachmentStateChangesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.submit_attachment_state_changes().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::submit_attachment_state_changes::builders::SubmitAttachmentStateChangesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
