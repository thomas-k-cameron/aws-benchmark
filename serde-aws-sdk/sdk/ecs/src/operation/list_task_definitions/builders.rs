...
impl ListTaskDefinitionsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_task_definitions::builders::ListTaskDefinitionsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_task_definitions().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_task_definitions::builders::ListTaskDefinitionsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
