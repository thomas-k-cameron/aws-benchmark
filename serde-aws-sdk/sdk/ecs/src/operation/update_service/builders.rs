...
impl UpdateServiceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_service::builders::UpdateServiceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_service().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_service::builders::UpdateServiceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
