...
impl CreateCapacityProviderFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_capacity_provider::builders::CreateCapacityProviderInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_capacity_provider().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_capacity_provider::builders::CreateCapacityProviderInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
