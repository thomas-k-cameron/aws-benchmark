...
impl DeleteTaskSetFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::delete_task_set::builders::DeleteTaskSetInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.delete_task_set().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::delete_task_set::builders::DeleteTaskSetInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
