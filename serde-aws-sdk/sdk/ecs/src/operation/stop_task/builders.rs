...
impl StopTaskFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::stop_task::builders::StopTaskInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.stop_task().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::stop_task::builders::StopTaskInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
