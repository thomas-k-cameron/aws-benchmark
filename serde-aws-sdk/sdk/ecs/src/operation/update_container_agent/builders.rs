...
impl UpdateContainerAgentFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_container_agent::builders::UpdateContainerAgentInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_container_agent().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_container_agent::builders::UpdateContainerAgentInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
