...
impl UpdateCapacityProviderFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_capacity_provider::builders::UpdateCapacityProviderInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_capacity_provider().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_capacity_provider::builders::UpdateCapacityProviderInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
