...
impl DiscoverPollEndpointFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::discover_poll_endpoint::builders::DiscoverPollEndpointInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.discover_poll_endpoint().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::discover_poll_endpoint::builders::DiscoverPollEndpointInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
