...
impl RunTaskFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::run_task::builders::RunTaskInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.run_task().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::run_task::builders::RunTaskInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
