...
impl RegisterContainerInstanceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::register_container_instance::builders::RegisterContainerInstanceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.register_container_instance().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::register_container_instance::builders::RegisterContainerInstanceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
