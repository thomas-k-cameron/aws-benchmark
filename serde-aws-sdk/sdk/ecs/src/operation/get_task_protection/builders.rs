...
impl GetTaskProtectionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_task_protection::builders::GetTaskProtectionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_task_protection().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_task_protection::builders::GetTaskProtectionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
