...
impl UpdateTaskProtectionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_task_protection::builders::UpdateTaskProtectionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_task_protection().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_task_protection::builders::UpdateTaskProtectionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
