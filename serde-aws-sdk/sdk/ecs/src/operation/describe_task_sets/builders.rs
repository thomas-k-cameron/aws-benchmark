...
impl DescribeTaskSetsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_task_sets::builders::DescribeTaskSetsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_task_sets().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_task_sets::builders::DescribeTaskSetsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
