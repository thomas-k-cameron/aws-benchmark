...
impl ListAccountSettingsFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_account_settings::builders::ListAccountSettingsInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_account_settings().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_account_settings::builders::ListAccountSettingsInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
