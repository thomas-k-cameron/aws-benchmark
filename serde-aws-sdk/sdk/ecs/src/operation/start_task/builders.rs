...
impl StartTaskFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::start_task::builders::StartTaskInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.start_task().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::start_task::builders::StartTaskInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
