...
impl DeregisterContainerInstanceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::deregister_container_instance::builders::DeregisterContainerInstanceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.deregister_container_instance().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::deregister_container_instance::builders::DeregisterContainerInstanceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
