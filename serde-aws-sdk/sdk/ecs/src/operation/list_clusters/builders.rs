...
impl ListClustersFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_clusters::builders::ListClustersInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_clusters().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_clusters::builders::ListClustersInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
