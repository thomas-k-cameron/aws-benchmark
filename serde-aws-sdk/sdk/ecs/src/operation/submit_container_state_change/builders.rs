...
impl SubmitContainerStateChangeFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::submit_container_state_change::builders::SubmitContainerStateChangeInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.submit_container_state_change().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::submit_container_state_change::builders::SubmitContainerStateChangeInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
