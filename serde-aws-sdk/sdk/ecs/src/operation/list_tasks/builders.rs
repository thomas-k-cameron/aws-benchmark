...
impl ListTasksFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_tasks::builders::ListTasksInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_tasks().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_tasks::builders::ListTasksInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
