...
impl ListAttributesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_attributes::builders::ListAttributesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_attributes().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_attributes::builders::ListAttributesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
