...
impl ListContainerInstancesFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_container_instances::builders::ListContainerInstancesInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_container_instances().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_container_instances::builders::ListContainerInstancesInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
