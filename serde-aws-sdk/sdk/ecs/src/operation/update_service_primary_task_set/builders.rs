...
impl UpdateServicePrimaryTaskSetFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_service_primary_task_set::builders::UpdateServicePrimaryTaskSetInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_service_primary_task_set().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_service_primary_task_set::builders::UpdateServicePrimaryTaskSetInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
