...
impl CreateServiceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::create_service::builders::CreateServiceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.create_service().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::create_service::builders::CreateServiceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
