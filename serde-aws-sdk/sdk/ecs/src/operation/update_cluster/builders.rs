...
impl UpdateClusterFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_cluster::builders::UpdateClusterInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_cluster().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_cluster::builders::UpdateClusterInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
