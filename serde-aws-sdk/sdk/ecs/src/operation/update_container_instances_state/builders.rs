...
impl UpdateContainerInstancesStateFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::update_container_instances_state::builders::UpdateContainerInstancesStateInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.update_container_instances_state().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::update_container_instances_state::builders::UpdateContainerInstancesStateInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
