...
impl DescribeTaskDefinitionFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::describe_task_definition::builders::DescribeTaskDefinitionInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.describe_task_definition().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::describe_task_definition::builders::DescribeTaskDefinitionInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
