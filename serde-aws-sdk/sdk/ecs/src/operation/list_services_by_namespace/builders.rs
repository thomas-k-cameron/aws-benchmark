...
impl ListServicesByNamespaceFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::list_services_by_namespace::builders::ListServicesByNamespaceInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.list_services_by_namespace().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::list_services_by_namespace::builders::ListServicesByNamespaceInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
