...
impl AssumeRoleFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::assume_role::builders::AssumeRoleInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.assume_role().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::assume_role::builders::AssumeRoleInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
