...
impl GetSessionTokenFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_session_token::builders::GetSessionTokenInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_session_token().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_session_token::builders::GetSessionTokenInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
