...
impl DecodeAuthorizationMessageFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::decode_authorization_message::builders::DecodeAuthorizationMessageInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.decode_authorization_message().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::decode_authorization_message::builders::DecodeAuthorizationMessageInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
