...
impl GetAccessKeyInfoFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_access_key_info::builders::GetAccessKeyInfoInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_access_key_info().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_access_key_info::builders::GetAccessKeyInfoInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
