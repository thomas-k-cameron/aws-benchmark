...
impl GetCallerIdentityFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_caller_identity::builders::GetCallerIdentityInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_caller_identity().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_caller_identity::builders::GetCallerIdentityInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
