...
impl GetFederationTokenFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::get_federation_token::builders::GetFederationTokenInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.get_federation_token().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::get_federation_token::builders::GetFederationTokenInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
