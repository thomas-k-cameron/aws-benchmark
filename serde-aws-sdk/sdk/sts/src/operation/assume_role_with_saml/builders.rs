...
impl AssumeRoleWithSAMLFluentBuilder {
    ...
    ///     let deserialized_parameters: crate::operation::assume_role_with_saml::builders::AssumeRoleWithSamlInputBuilder  = serde_json::from_str(&json_string).unwrap();
    ///     client.assume_role_with_saml().set_fields(&deserialized_parameters).send().await
    /// };
    /// ```
    pub fn set_fields(
        mut self,
        data: crate::operation::assume_role_with_saml::builders::AssumeRoleWithSamlInputBuilder,
    ) -> Self {
        self.inner = data;
        self
    }
